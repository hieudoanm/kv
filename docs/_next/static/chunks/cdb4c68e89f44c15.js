(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
          ...
          if (!te || te !== e) {
            if (
              ...
              (e$ = b(e, 'ADD_URI_SAFE_ATTR')
                ? v(C(eV), e.ADD_URI_SAFE_ATTR, e7)
                : eV),
              (eq = b(e, 'ADD_DATA_URI_TAGS')
                ? v(C(eK), e.ADD_DATA_URI_TAGS, e7)
                : eK),
              (eY = b(e, 'FORBID_CONTENTS')
                ? v({}, e.FORBID_CONTENTS, e7)
                : eX),
              (ew = b(e, 'FORBID_TAGS') ? v({}, e.FORBID_TAGS, e7) : C({})),
              (ev = b(e, 'FORBID_ATTR') ? v({}, e.FORBID_ATTR, e7) : C({})),
              ...
              (e5 = e.HTML_INTEGRATION_POINTS || e5),
              ...
              e.ADD_TAGS &&
                ('function' == typeof e.ADD_TAGS
                  ...
                  : (eE === eA && (eE = C(eE)), v(eE, e.ADD_TAGS, e7))),
              e.ADD_ATTR &&
                ('function' == typeof e.ADD_ATTR
                  ? (eC.attributeCheck = e.ADD_ATTR)
                  : (eb === eN && (eb = C(eb)), v(eb, e.ADD_ATTR, e7))),
              e.ADD_URI_SAFE_ATTR && v(e$, e.ADD_URI_SAFE_ATTR, e7),
              e.FORBID_CONTENTS &&
                (eY === eX && (eY = C(eY)), v(eY, e.FORBID_CONTENTS, e7)),
              e.ADD_FORBID_CONTENTS &&
                (eY === eX && (eY = C(eY)), v(eY, e.ADD_FORBID_CONTENTS, e7)),
              eB && (eE['#text'] = !0),
  ...
  (e) => {
    e.v((t) =>
      Promise.all(
        ['static/chunks/aa43610abbf6342c.js'].map((t) => e.l(t))
      ).then(() => t(64356))
    );
  },
  49246,
  (e) => {
    e.v((t) =>
      Promise.all(
        ['static/chunks/28124e50d99e8857.js'].map((t) => e.l(t))
      ).then(() => t(31422))
    );
  },
]);
