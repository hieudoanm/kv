(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, n) => {
    ...
    function X(e) {
      ($.current === e && (U(H), U($)),
        q.current === e && (U(q), (s7._currentValue = j)));
    }
    function K(e) {
      if (void 0 === tI)
        try {
    ...
    var t2 = tM(
      ...
      t6 = tM(h({}, tU, { newState: 0, oldState: 0 })),
      t9 = [9, 13, 27, 32],
    ...
    function ib(e, t) {
      ...
      switch (e.tag) {
        ...
        case 5:
          ...
          (4 & r &&
            null != e.stateNode &&
            ((a = e.memoizedProps), o5(e, a, null !== n ? n.memoizedProps : a)),
            1024 & r && (ia = !0));
          break;
        case 6:
          if ((ig(t, e), iv(e), 4 & r)) {
    ...
    function uT() {
      if (4 === i8 || 3 === i8) {
        ...
        0 != (10256 & t.subtreeFlags) || 0 != (10256 & t.flags)
          ? (i8 = 5)
          : ((i8 = 0), (i6 = i5 = null), uC(e, e.pendingLanes));
    ...
    function uO() {
      ...
      try {
        ...
        var l = i5,
          o = i9;
        if (((i8 = 0), (i6 = i5 = null), (i9 = 0), 0 != (6 & iI)))
          throw Error(u(331));
        var i = iI;
        if (
          ((iI |= 4),
...
${e.stack}`
  ...
  (e, t, n) => {
    ...
    async function q(t = {}) {
      ...
      if (
        ...
        let { initScriptLoader: t } = e.r(89046);
        t(a.scriptLoader);
      }
          ...
          .then(({ page: r, styleSheets: a }) =>
            s?.Component === r
              ? e
                  .A(28806)
                  .then((r) =>
                    e.A(27403).then((e) => ((t.App = n = e.default), r))
                  )
  ...
  (e, t, n) => {
    'use strict';
    (Object.defineProperty(n, '__esModule', { value: !0 }), e.r(41011));
    let r = e.r(97154),
      a = e.r(40322);
    ((window.next = {
      version: r.version,
