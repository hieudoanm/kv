(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    e.s([
      ...
      ({
        ...
        let [p, u] = (0, a.useState)(''),
          [x, h] = (0, a.useState)(!0);
        return (
          (0, a.useEffect)(() => {
            u((0, i.default)(window).sanitize(c));
          }, [c]),
          (0, s.jsxs)('div', {
            id: e,
            ...
            children: [
              ...
              (0, s.jsx)('div', {
                ...
                children: n
                  ? (0, s.jsx)(r.Shiki, { code: c, lang: 'tsx' })
                  : (0, s.jsx)(s.Fragment, {
                      children: x
                        ? (0, s.jsx)('div', {
                        ...
                        : (0, s.jsx)(r.Shiki, { code: c, lang: 'html' }),
                    }),
              }),
            ],
          })
  ...
  (e) => {
    ...
    let o = (0, t.fileURLToPath)(
      {
        get url() {
          return `file://${e.P('src/pages/react/hooks/index.tsx')}`;
        },
      }.url
    );
  ...
  (e, s, l) => {
    let i = '/react/hooks';
    ((window.__NEXT_P = window.__NEXT_P || []).push([i, () => e.r(40818)]),
      s.hot &&
