      ...
      !(function () {
        var t = {
            ...
            72: function (e, t, n) {
              ...
              function c(e) {
                for (
                  var t = e.length < 0 ? 0 : 0 | d(e.length), n = o(t), r = 0;
                  r < t;
                  r += 1
                )
                  n[r] = 255 & e[r];
    ...
    6259: (e, t, n) => {
      ...
      var m = class {
              ...
              (function (e) {
                ...
                for (let e = 0, i = t.length; e < i; e++) {
                  ...
                  'string' == typeof a.settings.foreground &&
                    d(a.settings.foreground) &&
                    (s = a.settings.foreground);
                  let l = null;
                  'string' == typeof a.settings.background &&
                    d(a.settings.background) &&
                    (l = a.settings.background);
                  for (let t = 0, a = i.length; t < a; t++) {
                    let a = i[t].trim().split(' '),
                      u = a[a.length - 1],
                      h = null;
                    (a.length > 1 && (h = a.slice(0, a.length - 1)).reverse(),
                      (n[r++] = new b(u, h, e, o, s, l)));
                  }
                }
                return n;
              })(e),
          ...
          static createFromParsedTheme(e, t) {
            return (function (e, t) {
              e.sort((e, t) => {
                ...
                return 0 !== i || 0 !== (i = c(e.parentScopes, t.parentScopes))
                  ? i
                  : e.index - t.index;
              });
              let n = 0,
        ...
        S = class e {
          ...
          insert(t, n, r, i, a, o) {
            ...
            (-1 === h
              ? ((s = n), (l = ''))
              : ((s = n.substring(0, h)), (l = n.substring(h + 1))),
          ...
          switch (a.kind) {
            ...
            case 4:
              ...
              if (o) {
                ...
                4 === a.kind
                  ? n.add(new T(a.scopeName, a.ruleName))
                  : n.add(new L(a.scopeName));
          }
        }
      }
      var B = class {
      ...
      function $(e) {
        ...
        return -1 === t
          ...
          : 0 === t
            ? new U(e.substring(1))
            : new j(e.substring(0, t), e.substring(t + 1));
      }
      var F = /\\(\d+)/,
        H = /\\(\d+)/g;
      Symbol('RuleId');
      var W = class {
          ...
          constructor(e, t, n, r) {
            ((this.$location = e),
              ...
              (this._contentNameIsCapturing = h.hasCaptures(
                this._contentName
              )));
          }
          get debugName() {
        ...
        K = class extends W {
          ...
          _getCachedCompiledPatterns(e, t) {
            if (!this._cachedCompiledPatterns) {
              for (let t of ((this._cachedCompiledPatterns = new Q()),
              this.patterns))
        ...
        J = class e {
          ...
          resolveBackReferences(e, t) {
            ...
            return (
              (H.lastIndex = 0),
              this.source.replace(H, (e, t) => p(n[parseInt(t, 10)] || ''))
            );
          }
          _buildAnchorCache() {
            let e, t, n, r;
        ...
        et = class e {
          ...
          constructor(e, t) {
            ((this._defaultAttributes = new ee(e, 8)),
              (this._embeddedLanguagesMatcher = new en(
                Object.entries(t || {})
              )));
          }
          ...
          _getBasicScopeAttributes = new m(
            (e) =>
              new ee(this._scopeToLanguage(e), this._toStandardTokenType(e))
          );
          _scopeToLanguage(e) {
      ...
      function ei(e, t, n, r, i, a, o, s) {
          ...
          let o = (function (e, t, n, r, i, a) {
            ...
            for (let p = s.pop(); p; p = s.pop()) {
              ...
              let { ruleScanner: s, findOptions: m } =
                  ...
                  (d = r === o),
                  {
                    ruleScanner: l.compileWhileAG(u, h, c, d),
                    findOptions: 0,
                  }),
        ...
        for (; !u; ) {
          ...
          !(function () {
            let o = (function (e, t, n, r, i, a) {
              let o = (function (e, t, n, r, i, a) {
                  let { ruleScanner: o, findOptions: s } = ea(
                      i.getRule(e),
                      e,
                      i.endRule,
                      n,
              ...
              let l = (function (e, t, n, r, i, a, o) {
                ...
                for (let a = 0, d = e.length; a < d; a++) {
                  ...
                  let { ruleScanner: p, findOptions: m } = ea(
                      t.getRule(d.ruleId),
                      t,
                      null,
                      r,
            ...
            if (-1 === c) {
              ...
              if (
                ((i = i.push(c, r, h, s[0].end === l, null, f, f)),
                o instanceof K)
              ) {
                (eo(e, t, n, i, a, o.beginCaptures, s),
                  a.produce(i, s[0].end),
                  (h = s[0].end));
      ...
      function eo(e, t, n, r, i, a, o) {
        ...
        for (let t = 0; t < l; t++) {
          ...
          if (
            (u.length > 0
              ? i.produceFromScopes(u[u.length - 1].scopes, c.start)
              : i.produce(r, c.start),
      ...
      var eh = class {
        ...
        getExternalGrammar(e, t) {
          ...
          if (this._grammarRepository) {
            ...
            if (n)
              return (
                (this._includedGrammars[e] = ec(n, t && t.$base)),
        ...
        _tokenize(e, t, n, r) {
          ...
          if (
            (-1 === this._rootId &&
              ((this._rootId = Y.getCompiledRuleId(
            ...
            ((e = o
              ? ed.createRootAndLookUpScopeName(o, a, this)
              : ed.createRoot('unknown', a)),
      ...
      var ed = class e {
          ...
          static _equals(e, t) {
            return (
              ...
              (!!this._structuralEquals(e, t) &&
                ed.equals(e.contentNameScopesList, t.contentNameScopesList))
            );
          }
            ...
            if (this._emitBinaryTokens) {
              ...
              if (
                ...
                for (let e of this._tokenTypeOverrides)
                  e.matcher(t) && (n = C.set(n, 0, e.type, null, -1, 0, 0));
                this.balancedBracketSelectors &&
        ...
        eg = class {
          ...
          grammarForScopeName(e, t, n, r, i) {
            if (!this._grammars.has(e)) {
              ...
              this._grammars.set(
                e,
                new eh(e, a, t, n, r, i, this, this._onigLib)
              );
            }
        ...
        ey = class {
          ...
          constructor(e) {
            ((this._options = e),
              (this._syncRegistry = new eg(
                f.createFromRawTheme(e.theme, e.colorMap),
                e.onigLib
              )),
      ...
      ((ev.prototype.normal = {}),
        (ev.prototype.property = {}),
        (ev.prototype.space = void 0));
      class eS {
        constructor(e, t) {
      ...
      let eG = eM({
        ...
        e3 = {}.hasOwnProperty,
        e8 = {};
      for (r in e1) e3.call(e1, r) && (e8[e1[r]] = r);
      let e6 = /[^\dA-Za-z]/;
      function e5(e, t, n) {
        let r,
          i = (function (e, t, n) {
      ...
      function ty(e, t, n) {
        ...
        return (
          !r ||
          ('comment' !== r.type &&
            !('text' === r.type && tl(r.value.charAt(0))))
        );
      }
      function tb(e, t, n) {
        let r = th(n, t);
                            ...
                            : (e.settings.preferUnquoted &&
                                (r = e7(
                                  ...
                                  Object.assign(
                                    ...
                                    { attribute: !0, subset: tk.unquoted[a][o] }
                                  )
                                )),
                              r !== n &&
                                (e.settings.quoteSmart &&
                                  tt(n, s) > tt(n, e.alternative) &&
                                  (s = e.alternative),
                                (r =
                                  s +
                                  e7(
      ...
      function tj(e) {
        ...
        if (
          ...
          (e.fontStyle & _.Italic && (t['font-style'] = 'italic'),
            e.fontStyle & _.Bold && (t['font-weight'] = 'bold'));
          let n = [];
      ...
      class tq {
        ...
        static initial(e, t) {
          return new tq(
            Object.fromEntries(
              (Array.isArray(t) ? t : [t]).map((e) => [e, eb])
            ),
            e
          );
        }
      ...
      function tV(e) {
        ...
        return [...t.pre, ...t.normal, ...t.post, ...tz];
      }
      var tK = [
          'black',
          'red',
      ...
      function tQ(e, t, n = {}) {
        ...
        if (tO(r) || tM(i))
          return tD(t).map((e) => [{ content: e[0], offset: e[1] }]);
      ...
      function tZ(e, t, n, r, i) {
        ...
        for (let e = 0, o = u.length; e < o; e++) {
          ...
          if (s > 0 && m.length >= s) {
            ((c = []),
              d.push([{ content: m, offset: f, color: '', fontStyle: 0 }]));
            continue;
          }
          i.includeExplanation &&
            ((o = t.tokenizeLine(m, h, l).tokens), (p = 0));
      ...
      function t2(e, t, n) {
        ...
        if ('themes' in n) {
          ...
          if (((u = tW(m)), h && tU !== h && !p.find((e) => e.color === h)))
            throw new o(
              `\`themes\` option must contain the defaultColor key \`${h}\``
            );
      ...
      function t8(
        ...
        r = {
          meta: {},
          options: n,
          codeToHast: (t, n) => t8(e, t, n),
          codeToTokens: (t, n) => t2(e, t, n),
        }
      ) {
        let i = t;
          ...
          ? (a = a.map((e) => {
              ...
              return (
                e.forEach((i, a) => {
                  let o = !(
                    i.fontStyle &&
                    (i.fontStyle & _.Underline || i.fontStyle & _.Strikethrough)
                  );
            ...
            (a = a.map((e) => {
              ...
              for (let n of e) {
                ...
                let e = t[t.length - 1],
                  ...
                  a =
                    e.fontStyle &&
                    (e.fontStyle & _.Underline ||
                      e.fontStyle & _.Strikethrough),
                  o =
                    n.fontStyle &&
                    (n.fontStyle & _.Underline ||
                      n.fontStyle & _.Strikethrough);
            ...
            (
              await Promise.all(
                e
                  ...
                  .map(
                    async (e) =>
                      await tR(e).then((e) => (Array.isArray(e) ? e : [e]))
                  )
              )
            ).flat()
          )
      ...
      async function nt(e) {
        return (
          await Promise.all(
            e.map(async (e) => (tM(e) ? null : t4(await tR(e))))
          )
        ).filter((e) => !!e);
      }
      ...
      class nr extends ey {
        ...
        setTheme(e) {
          ...
          (t ||
            ((t = f.createFromRawTheme(e)), this._textmateThemeCache.set(e, t)),
      ...
      async function no(e) {
        ...
        return (function (e) {
          ...
          let n = !1;
          if (!e.engine)
            throw new nn('`engine` option is required for synchronous mode');
        ...
        return {
          getLastGrammarState: (...e) =>
            (function (...e) {
              ...
              if (tO(i) || tM(a))
                throw new o('Plain language does not have grammar state');
              if ('ansi' === i)
                throw new o('ANSI language does not have grammar state');
      ...
      let nl = [
          {
            id: 'abap',
            name: 'ABAP',
            import: () => n.e(7328).then(n.bind(n, 7328)),
          },
          {
            id: 'actionscript-3',
            name: 'ActionScript',
            import: () => n.e(2257).then(n.bind(n, 2257)),
          },
          {
            id: 'ada',
            name: 'Ada',
            import: () => n.e(9376).then(n.bind(n, 9376)),
          },
          {
            id: 'angular-html',
            name: 'Angular HTML',
            import: () =>
              Promise.all([n.e(7791), n.e(8049), n.e(5633), n.e(7890)]).then(
                n.bind(n, 7890)
              ),
          },
          {
          ...
          },
          {
            id: 'apache',
            name: 'Apache Conf',
            import: () => n.e(7280).then(n.bind(n, 7280)),
          },
          {
            id: 'apex',
            name: 'Apex',
            import: () => n.e(2526).then(n.bind(n, 145)),
          },
          {
            id: 'apl',
            name: 'APL',
          ...
          },
          {
            id: 'applescript',
            name: 'AppleScript',
            import: () => n.e(1345).then(n.bind(n, 1345)),
          },
          {
            id: 'ara',
            name: 'Ara',
            import: () => n.e(2574).then(n.bind(n, 2574)),
          },
          {
            id: 'asciidoc',
            name: 'AsciiDoc',
            aliases: ['adoc'],
            import: () => n.e(8155).then(n.bind(n, 8155)),
          },
          {
            id: 'asm',
            name: 'Assembly',
            import: () => n.e(9641).then(n.bind(n, 9641)),
          },
          {
            id: 'astro',
            name: 'Astro',
          ...
          },
          {
            id: 'awk',
            name: 'AWK',
            import: () => n.e(3951).then(n.bind(n, 3951)),
          },
          {
            id: 'ballerina',
            name: 'Ballerina',
            import: () => n.e(2212).then(n.bind(n, 2212)),
          },
          {
            id: 'bat',
            name: 'Batch File',
          ...
          },
          {
            id: 'beancount',
            name: 'Beancount',
            import: () => n.e(6939).then(n.bind(n, 6939)),
          },
          {
            id: 'berry',
            name: 'Berry',
            aliases: ['be'],
            import: () => n.e(1352).then(n.bind(n, 1352)),
          },
          {
            id: 'bibtex',
            name: 'BibTeX',
            import: () => n.e(144).then(n.bind(n, 144)),
          },
          {
            id: 'bicep',
            name: 'Bicep',
            import: () => n.e(3141).then(n.bind(n, 3141)),
          },
          {
            id: 'blade',
            name: 'Blade',
          ...
          },
          {
            ...
            name: '1C (Enterprise)',
            aliases: ['1c'],
            import: () => n.e(9355).then(n.bind(n, 9355)),
          },
          { id: 'c', name: 'C', import: () => n.e(7735).then(n.bind(n, 7735)) },
          {
            id: 'cadence',
            name: 'Cadence',
            aliases: ['cdc'],
            import: () => n.e(717).then(n.bind(n, 717)),
          },
          {
            id: 'cairo',
            name: 'Cairo',
            import: () =>
              Promise.all([n.e(240), n.e(7420)]).then(n.bind(n, 7420)),
          },
          {
            id: 'clarity',
            name: 'Clarity',
            import: () => n.e(3172).then(n.bind(n, 3172)),
          },
          {
            id: 'clojure',
            name: 'Clojure',
            aliases: ['clj'],
            import: () => n.e(1544).then(n.bind(n, 1544)),
          },
          {
            id: 'cmake',
            name: 'CMake',
            import: () => n.e(5725).then(n.bind(n, 5725)),
          },
          {
            id: 'cobol',
            name: 'COBOL',
          ...
          },
          {
            ...
            name: 'CodeQL',
            aliases: ['ql'],
            import: () => n.e(1150).then(n.bind(n, 1150)),
          },
          {
            id: 'coffee',
            name: 'CoffeeScript',
            ...
            import: () =>
              Promise.all([n.e(7791), n.e(2534)]).then(n.bind(n, 2534)),
          },
          {
            id: 'common-lisp',
            name: 'Common Lisp',
            aliases: ['lisp'],
            import: () => n.e(4336).then(n.bind(n, 4336)),
          },
          {
            id: 'coq',
            name: 'Coq',
            import: () => n.e(9995).then(n.bind(n, 9995)),
          },
          {
            id: 'cpp',
            name: 'C++',
          ...
          },
          {
            ...
            name: 'C#',
            aliases: ['c#', 'cs'],
            import: () => n.e(3547).then(n.bind(n, 3547)),
          },
          {
            id: 'css',
            name: 'CSS',
            import: () => n.e(8049).then(n.bind(n, 8049)),
          },
          {
            id: 'csv',
            name: 'CSV',
            import: () => n.e(3928).then(n.bind(n, 3928)),
          },
          {
            id: 'cue',
            name: 'CUE',
            import: () => n.e(7889).then(n.bind(n, 7889)),
          },
          {
            id: 'cypher',
            name: 'Cypher',
            aliases: ['cql'],
            import: () => n.e(4959).then(n.bind(n, 4959)),
          },
          { id: 'd', name: 'D', import: () => n.e(9792).then(n.bind(n, 9792)) },
          {
            id: 'dart',
            name: 'Dart',
          ...
          },
          {
            id: 'dax',
            name: 'DAX',
            import: () => n.e(8963).then(n.bind(n, 8963)),
          },
          {
            id: 'desktop',
            name: 'Desktop',
            import: () => n.e(7228).then(n.bind(n, 7228)),
          },
          {
            id: 'diff',
            name: 'Diff',
            import: () => n.e(1031).then(n.bind(n, 1031)),
          },
          {
            id: 'docker',
            name: 'Dockerfile',
            aliases: ['dockerfile'],
            import: () => n.e(874).then(n.bind(n, 874)),
          },
          {
            id: 'dotenv',
            name: 'dotEnv',
            import: () => n.e(7788).then(n.bind(n, 7788)),
          },
          {
            id: 'dream-maker',
            name: 'Dream Maker',
            import: () => n.e(3694).then(n.bind(n, 3694)),
          },
          {
            id: 'edge',
            name: 'Edge',
          ...
          },
          {
            ...
            name: 'Elixir',
            import: () =>
              Promise.all([n.e(7791), n.e(8049), n.e(5633), n.e(8299)]).then(
                n.bind(n, 8299)
              ),
          },
          {
            ...
            name: 'Elm',
            import: () =>
              Promise.all([n.e(7735), n.e(2528)]).then(n.bind(n, 2528)),
          },
          {
            id: 'emacs-lisp',
            name: 'Emacs Lisp',
            aliases: ['elisp'],
            import: () => n.e(5100).then(n.bind(n, 1632)),
          },
          {
            id: 'erb',
            name: 'ERB',
          ...
          },
          {
            ...
            aliases: ['erl'],
            import: () =>
              Promise.all([n.e(6193), n.e(5571)]).then(n.bind(n, 5571)),
          },
          {
            id: 'fennel',
            name: 'Fennel',
            import: () => n.e(5738).then(n.bind(n, 5738)),
          },
          {
            id: 'fish',
            name: 'Fish',
            import: () => n.e(3868).then(n.bind(n, 3868)),
          },
          {
            id: 'fluent',
            name: 'Fluent',
            aliases: ['ftl'],
            import: () => n.e(7364).then(n.bind(n, 7364)),
          },
          {
            ...
            aliases: ['f', 'for', 'f77'],
            import: () =>
              Promise.all([n.e(1360), n.e(140)]).then(n.bind(n, 140)),
          },
          {
            id: 'fortran-free-form',
            name: 'Fortran (Free Form)',
            aliases: ['f90', 'f95', 'f03', 'f08', 'f18'],
            import: () => n.e(1360).then(n.bind(n, 1360)),
          },
          {
            id: 'fsharp',
            name: 'F#',
            aliases: ['f#', 'fs'],
            import: () =>
              Promise.all([n.e(6193), n.e(8592)]).then(n.bind(n, 8592)),
          },
          {
            id: 'gdresource',
            name: 'GDResource',
            import: () => n.e(3283).then(n.bind(n, 3283)),
          },
          {
            id: 'gdscript',
            name: 'GDScript',
            import: () => n.e(6309).then(n.bind(n, 8690)),
          },
          {
            id: 'gdshader',
            name: 'GDShader',
            import: () => n.e(2804).then(n.bind(n, 2804)),
          },
          {
            id: 'genie',
            name: 'Genie',
            import: () => n.e(2208).then(n.bind(n, 2208)),
          },
          {
            id: 'gherkin',
            name: 'Gherkin',
            import: () => n.e(6870).then(n.bind(n, 6870)),
          },
          {
            id: 'git-commit',
            name: 'Git Commit Message',
            import: () => n.e(5836).then(n.bind(n, 5836)),
          },
          {
            id: 'git-rebase',
            name: 'Git Rebase Message',
            import: () =>
              Promise.all([n.e(3383), n.e(8911)]).then(n.bind(n, 8911)),
          },
          {
            id: 'gleam',
            name: 'Gleam',
            import: () => n.e(5264).then(n.bind(n, 5264)),
          },
          {
            id: 'glimmer-js',
            name: 'Glimmer JS',
          ...
          },
          {
            ...
            name: 'GLSL',
            import: () =>
              Promise.all([n.e(7735), n.e(9574)]).then(n.bind(n, 9574)),
          },
          {
            id: 'gnuplot',
            name: 'Gnuplot',
            import: () => n.e(5857).then(n.bind(n, 5857)),
          },
          {
            id: 'go',
            name: 'Go',
            import: () => n.e(6980).then(n.bind(n, 6980)),
          },
          {
            id: 'graphql',
            name: 'GraphQL',
          ...
          },
          {
            id: 'groovy',
            name: 'Groovy',
            import: () => n.e(7100).then(n.bind(n, 7100)),
          },
          {
            id: 'hack',
            name: 'Hack',
          ...
          },
          {
            ...
            name: 'Ruby Haml',
            import: () =>
              Promise.all([n.e(7791), n.e(8049), n.e(2012)]).then(
                n.bind(n, 2012)
              ),
          },
          {
            ...
            aliases: ['hbs'],
            import: () =>
              Promise.all([n.e(7791), n.e(8049), n.e(5633), n.e(1202)]).then(
                n.bind(n, 1202)
              ),
          },
          {
            ...
            name: 'Haskell',
            aliases: ['hs'],
            import: () => n.e(804).then(n.bind(n, 804)),
          },
          {
            id: 'haxe',
            name: 'Haxe',
            import: () => n.e(8222).then(n.bind(n, 8222)),
          },
          {
            id: 'hcl',
            name: 'HashiCorp HCL',
            import: () => n.e(7777).then(n.bind(n, 7777)),
          },
          {
            id: 'hjson',
            name: 'Hjson',
            import: () => n.e(4566).then(n.bind(n, 4566)),
          },
          {
            id: 'hlsl',
            name: 'HLSL',
            import: () => n.e(407).then(n.bind(n, 407)),
          },
          {
            id: 'html',
            name: 'HTML',
            import: () =>
              Promise.all([n.e(7791), n.e(8049), n.e(5633)]).then(
                n.bind(n, 5633)
              ),
          },
          {
            ...
            import: () =>
              Promise.all([n.e(7791), n.e(8049), n.e(5633), n.e(5595)]).then(
                n.bind(n, 5595)
              ),
          },
          {
          ...
          },
          {
            id: 'hxml',
            name: 'HXML',
            import: () => n.e(6637).then(n.bind(n, 6637)),
          },
          { id: 'hy', name: 'Hy', import: () => n.e(895).then(n.bind(n, 895)) },
          {
            id: 'imba',
            name: 'Imba',
            import: () => n.e(8087).then(n.bind(n, 8087)),
          },
          {
            id: 'ini',
            name: 'INI',
            aliases: ['properties'],
            import: () => n.e(9058).then(n.bind(n, 9058)),
          },
          {
            id: 'java',
            name: 'Java',
            import: () => n.e(1426).then(n.bind(n, 1426)),
          },
          {
            id: 'javascript',
            name: 'JavaScript',
            aliases: ['js'],
            import: () => n.e(7791).then(n.bind(n, 2851)),
          },
          {
            id: 'jinja',
            name: 'Jinja',
            import: () =>
              Promise.all([n.e(7791), n.e(8049), n.e(5633), n.e(2592)]).then(
                n.bind(n, 2592)
              ),
          },
          {
            ...
            name: 'Jison',
            import: () =>
              Promise.all([n.e(7791), n.e(4381)]).then(n.bind(n, 4381)),
          },
          {
            id: 'json',
            name: 'JSON',
            import: () => n.e(5276).then(n.bind(n, 5276)),
          },
          {
            id: 'json5',
            name: 'JSON5',
            import: () => n.e(7603).then(n.bind(n, 7603)),
          },
          {
            id: 'jsonc',
            name: 'JSON with Comments',
            import: () => n.e(5241).then(n.bind(n, 5241)),
          },
          {
            id: 'jsonl',
            name: 'JSON Lines',
            import: () => n.e(8142).then(n.bind(n, 8142)),
          },
          {
            id: 'jsonnet',
            name: 'Jsonnet',
            import: () => n.e(4379).then(n.bind(n, 4379)),
          },
          {
            id: 'jssm',
            name: 'JSSM',
            aliases: ['fsl'],
            import: () => n.e(3115).then(n.bind(n, 3115)),
          },
          {
            id: 'jsx',
            name: 'JSX',
            import: () => n.e(7661).then(n.bind(n, 3127)),
          },
          {
            id: 'julia',
            name: 'Julia',
          ...
          },
          {
            ...
            name: 'Kotlin',
            aliases: ['kt', 'kts'],
            import: () => n.e(7465).then(n.bind(n, 7465)),
          },
          {
            id: 'kusto',
            name: 'Kusto',
            aliases: ['kql'],
            import: () => n.e(1312).then(n.bind(n, 1312)),
          },
          {
            id: 'latex',
            name: 'LaTeX',
            import: () =>
              Promise.all([n.e(3674), n.e(2688)]).then(n.bind(n, 2688)),
          },
          {
            id: 'lean',
            name: 'Lean 4',
            aliases: ['lean4'],
            import: () => n.e(966).then(n.bind(n, 966)),
          },
          {
            id: 'less',
            name: 'Less',
            import: () => n.e(793).then(n.bind(n, 793)),
          },
          {
            id: 'liquid',
            name: 'Liquid',
            import: () =>
              Promise.all([n.e(7791), n.e(8049), n.e(5633), n.e(3282)]).then(
                n.bind(n, 3282)
              ),
          },
          {
            id: 'llvm',
            name: 'LLVM IR',
            import: () => n.e(57).then(n.bind(n, 57)),
          },
          {
            id: 'log',
            name: 'Log file',
            import: () => n.e(7069).then(n.bind(n, 9450)),
          },
          {
            id: 'logo',
            name: 'Logo',
            import: () => n.e(3611).then(n.bind(n, 3611)),
          },
          {
            id: 'lua',
            name: 'Lua',
            import: () =>
              Promise.all([n.e(7735), n.e(5970)]).then(n.bind(n, 5970)),
          },
          {
            id: 'luau',
            name: 'Luau',
            import: () => n.e(8109).then(n.bind(n, 8109)),
          },
          {
            id: 'make',
            name: 'Makefile',
            aliases: ['makefile'],
            import: () => n.e(2300).then(n.bind(n, 2300)),
          },
          {
            id: 'markdown',
            name: 'Markdown',
            aliases: ['md'],
            import: () => n.e(6193).then(n.bind(n, 6193)),
          },
          {
            id: 'marko',
            name: 'Marko',
          ...
          },
          {
            id: 'matlab',
            name: 'MATLAB',
            import: () => n.e(3969).then(n.bind(n, 3969)),
          },
          {
            id: 'mdc',
            name: 'MDC',
          ...
          },
          {
            id: 'mdx',
            name: 'MDX',
            import: () => n.e(3017).then(n.bind(n, 3017)),
          },
          {
            id: 'mermaid',
            name: 'Mermaid',
            aliases: ['mmd'],
            import: () => n.e(3726).then(n.bind(n, 3726)),
          },
          {
            id: 'mipsasm',
            name: 'MIPS Assembly',
            aliases: ['mips'],
            import: () => n.e(7110).then(n.bind(n, 7110)),
          },
          {
            id: 'mojo',
            name: 'Mojo',
            import: () => n.e(471).then(n.bind(n, 471)),
          },
          {
            id: 'move',
            name: 'Move',
            import: () => n.e(762).then(n.bind(n, 8381)),
          },
          {
            id: 'narrat',
            name: 'Narrat Language',
            aliases: ['nar'],
            import: () => n.e(4954).then(n.bind(n, 4954)),
          },
          {
            id: 'nextflow',
            name: 'Nextflow',
            aliases: ['nf'],
            import: () => n.e(5529).then(n.bind(n, 5529)),
          },
          {
            id: 'nginx',
            name: 'Nginx',
            import: () =>
              Promise.all([n.e(7735), n.e(3520)]).then(n.bind(n, 3520)),
          },
          {
            id: 'nim',
            name: 'Nim',
          ...
          },
          {
            id: 'nix',
            name: 'Nix',
            import: () => n.e(8121).then(n.bind(n, 8121)),
          },
          {
            id: 'nushell',
            name: 'nushell',
            aliases: ['nu'],
            import: () => n.e(6111).then(n.bind(n, 6111)),
          },
          {
            id: 'objective-c',
            name: 'Objective-C',
            aliases: ['objc'],
            import: () => n.e(7169).then(n.bind(n, 7169)),
          },
          {
            id: 'objective-cpp',
            name: 'Objective-C++',
            import: () => n.e(5887).then(n.bind(n, 9233)),
          },
          {
            id: 'ocaml',
            name: 'OCaml',
            import: () => n.e(9832).then(n.bind(n, 9832)),
          },
          {
            id: 'pascal',
            name: 'Pascal',
            import: () => n.e(5506).then(n.bind(n, 5506)),
          },
          {
            id: 'perl',
            name: 'Perl',
          ...
          },
          {
            id: 'plsql',
            name: 'PL/SQL',
            import: () => n.e(9316).then(n.bind(n, 9316)),
          },
          {
            id: 'po',
            name: 'Gettext PO',
            aliases: ['pot', 'potx'],
            import: () => n.e(4405).then(n.bind(n, 4405)),
          },
          {
            id: 'polar',
            name: 'Polar',
            import: () => n.e(7092).then(n.bind(n, 7092)),
          },
          {
            id: 'postcss',
            name: 'PostCSS',
            import: () => n.e(7207).then(n.bind(n, 7207)),
          },
          {
            id: 'powerquery',
            name: 'PowerQuery',
            import: () => n.e(3639).then(n.bind(n, 3639)),
          },
          {
            id: 'powershell',
            name: 'PowerShell',
            aliases: ['ps', 'ps1'],
            import: () => n.e(2697).then(n.bind(n, 2697)),
          },
          {
            id: 'prisma',
            name: 'Prisma',
            import: () => n.e(6774).then(n.bind(n, 6774)),
          },
          {
            id: 'prolog',
            name: 'Prolog',
            import: () => n.e(8695).then(n.bind(n, 8695)),
          },
          {
            id: 'proto',
            name: 'Protocol Buffer 3',
            aliases: ['protobuf'],
            import: () => n.e(2214).then(n.bind(n, 2214)),
          },
          {
            id: 'pug',
            name: 'Pug',
            aliases: ['jade'],
            import: () =>
              Promise.all([n.e(7791), n.e(8049), n.e(5633), n.e(7940)]).then(
                n.bind(n, 7940)
              ),
          },
          {
            id: 'puppet',
            name: 'Puppet',
            import: () => n.e(5088).then(n.bind(n, 5088)),
          },
          {
            id: 'purescript',
            name: 'PureScript',
            import: () => n.e(9213).then(n.bind(n, 9213)),
          },
          {
            id: 'python',
            name: 'Python',
          ...
          },
          {
            ...
            name: 'QML',
            import: () =>
              Promise.all([n.e(7791), n.e(1886)]).then(n.bind(n, 1886)),
          },
          {
            id: 'qmldir',
            name: 'QML Directory',
            import: () => n.e(2729).then(n.bind(n, 2729)),
          },
          {
            id: 'qss',
            name: 'Qt Style Sheets',
            import: () => n.e(6539).then(n.bind(n, 6539)),
          },
          { id: 'r', name: 'R', import: () => n.e(3674).then(n.bind(n, 3674)) },
          {
            id: 'racket',
            name: 'Racket',
            import: () => n.e(7736).then(n.bind(n, 7736)),
          },
          {
            id: 'raku',
            name: 'Raku',
            aliases: ['perl6'],
            import: () => n.e(7001).then(n.bind(n, 7001)),
          },
          {
            id: 'razor',
            name: 'ASP.NET Razor',
          ...
          },
          {
            ...
            import: () => n.e(3558).then(n.bind(n, 3558)),
          },
          {
            id: 'regexp',
            name: 'RegExp',
            aliases: ['regex'],
            import: () => n.e(4025).then(n.bind(n, 4025)),
          },
          {
            id: 'rel',
            name: 'Rel',
            import: () => n.e(7981).then(n.bind(n, 7981)),
          },
          {
            id: 'riscv',
            name: 'RISC-V',
            import: () => n.e(2977).then(n.bind(n, 2977)),
          },
          {
            id: 'rst',
          ...
          },
          {
            ...
            name: 'Rust',
            aliases: ['rs'],
            import: () => n.e(9088).then(n.bind(n, 9088)),
          },
          {
            id: 'sas',
            name: 'SAS',
            import: () =>
              Promise.all([n.e(120), n.e(1639)]).then(n.bind(n, 1639)),
          },
          {
            id: 'sass',
            name: 'Sass',
            import: () => n.e(3076).then(n.bind(n, 3076)),
          },
          {
            id: 'scala',
            name: 'Scala',
            import: () => n.e(7134).then(n.bind(n, 7134)),
          },
          {
            id: 'scheme',
            name: 'Scheme',
            import: () => n.e(4799).then(n.bind(n, 4799)),
          },
          {
            id: 'scss',
            name: 'SCSS',
            import: () =>
              Promise.all([n.e(8049), n.e(8270)]).then(n.bind(n, 8270)),
          },
          {
            id: 'sdbl',
            name: '1C (Query)',
            aliases: ['1c-query'],
            import: () => n.e(2437).then(n.bind(n, 2437)),
          },
          {
            id: 'shaderlab',
            name: 'ShaderLab',
            aliases: ['shader'],
            import: () => n.e(6608).then(n.bind(n, 6608)),
          },
          {
            id: 'shellscript',
            name: 'Shell',
          ...
          },
          {
            ...
            aliases: ['console'],
            import: () =>
              Promise.all([n.e(3383), n.e(1916)]).then(n.bind(n, 1916)),
          },
          {
            id: 'smalltalk',
            name: 'Smalltalk',
            import: () => n.e(2931).then(n.bind(n, 2931)),
          },
          {
            id: 'solidity',
            name: 'Solidity',
            import: () => n.e(9329).then(n.bind(n, 9329)),
          },
          {
            id: 'soy',
            ...
            import: () =>
              Promise.all([n.e(7791), n.e(8049), n.e(5633), n.e(6003)]).then(
                n.bind(n, 6003)
              ),
          },
          {
            id: 'sparql',
            name: 'SPARQL',
            import: () => n.e(4529).then(n.bind(n, 4529)),
          },
          {
            id: 'splunk',
            name: 'Splunk Query Language',
            aliases: ['spl'],
            import: () => n.e(8779).then(n.bind(n, 8779)),
          },
          {
            id: 'sql',
            name: 'SQL',
          ...
          },
          {
            id: 'ssh-config',
            name: 'SSH Config',
            import: () => n.e(3035).then(n.bind(n, 3035)),
          },
          {
            id: 'stata',
            name: 'Stata',
            import: () =>
              Promise.all([n.e(120), n.e(3551)]).then(n.bind(n, 3551)),
          },
          {
            id: 'stylus',
            name: 'Stylus',
            aliases: ['styl'],
            import: () => n.e(7936).then(n.bind(n, 7936)),
          },
          {
            id: 'svelte',
            name: 'Svelte',
            import: () =>
              Promise.all([n.e(7791), n.e(1483), n.e(8049), n.e(1887)]).then(
                n.bind(n, 1887)
              ),
          },
          {
            id: 'swift',
            name: 'Swift',
            import: () => n.e(5369).then(n.bind(n, 5369)),
          },
          {
            id: 'system-verilog',
            name: 'SystemVerilog',
          ...
          },
          {
            ...
            name: 'TalonScript',
            aliases: ['talon'],
            import: () => n.e(5961).then(n.bind(n, 5961)),
          },
          {
            id: 'tasl',
            name: 'Tasl',
            import: () => n.e(5434).then(n.bind(n, 5434)),
          },
          {
            id: 'tcl',
            name: 'Tcl',
            import: () => n.e(8381).then(n.bind(n, 762)),
          },
          {
            id: 'templ',
            name: 'Templ',
            import: () =>
              Promise.all([n.e(7791), n.e(8049), n.e(6980), n.e(5346)]).then(
                n.bind(n, 5346)
              ),
          },
          {
            ...
            name: 'Terraform',
            aliases: ['tf', 'tfvars'],
            import: () => n.e(8040).then(n.bind(n, 8040)),
          },
          {
            id: 'tex',
            name: 'TeX',
            import: () =>
              Promise.all([n.e(3674), n.e(5791)]).then(n.bind(n, 5791)),
          },
          {
            id: 'toml',
            name: 'TOML',
            import: () => n.e(7782).then(n.bind(n, 7782)),
          },
          {
            id: 'ts-tags',
          ...
          },
          {
            id: 'tsv',
            name: 'TSV',
            import: () => n.e(1587).then(n.bind(n, 1587)),
          },
          {
            id: 'tsx',
            name: 'TSX',
            import: () => n.e(325).then(n.bind(n, 9825)),
          },
          {
            id: 'turtle',
            name: 'Turtle',
            import: () => n.e(1356).then(n.bind(n, 1356)),
          },
          {
            id: 'twig',
            name: 'Twig',
          ...
          },
          {
            ...
            name: 'TypeScript',
            aliases: ['ts'],
            import: () => n.e(1483).then(n.bind(n, 3635)),
          },
          {
            id: 'typespec',
            name: 'TypeSpec',
            aliases: ['tsp'],
            import: () => n.e(2659).then(n.bind(n, 2659)),
          },
          {
            id: 'typst',
            name: 'Typst',
            aliases: ['typ'],
            import: () => n.e(8706).then(n.bind(n, 8706)),
          },
          { id: 'v', name: 'V', import: () => n.e(6582).then(n.bind(n, 6582)) },
          {
            id: 'vala',
            name: 'Vala',
            import: () => n.e(8644).then(n.bind(n, 6263)),
          },
          {
            id: 'vb',
            name: 'Visual Basic',
            aliases: ['cmd'],
            import: () => n.e(5646).then(n.bind(n, 5646)),
          },
          {
            id: 'verilog',
            name: 'Verilog',
            import: () => n.e(7598).then(n.bind(n, 7598)),
          },
          {
            id: 'vhdl',
            name: 'VHDL',
            import: () => n.e(6088).then(n.bind(n, 6088)),
          },
          {
            id: 'viml',
            name: 'Vim Script',
            aliases: ['vim', 'vimscript'],
            import: () => n.e(8794).then(n.bind(n, 8794)),
          },
          {
            id: 'vue',
            name: 'Vue',
          ...
          },
          {
            ...
            name: 'Vyper',
            aliases: ['vy'],
            import: () => n.e(7900).then(n.bind(n, 7900)),
          },
          {
            id: 'wasm',
            name: 'WebAssembly',
            import: () => n.e(1850).then(n.bind(n, 1850)),
          },
          {
            id: 'wenyan',
            name: 'Wenyan',
            aliases: ['文言'],
            import: () => n.e(7168).then(n.bind(n, 7168)),
          },
          {
            id: 'wgsl',
            name: 'WGSL',
            import: () => n.e(2641).then(n.bind(n, 2641)),
          },
          {
            id: 'wikitext',
            name: 'Wikitext',
            aliases: ['mediawiki', 'wiki'],
            import: () => n.e(3919).then(n.bind(n, 3919)),
          },
          {
            id: 'wit',
            name: 'WebAssembly Interface Types',
            import: () => n.e(2220).then(n.bind(n, 2220)),
          },
          {
            id: 'wolfram',
            name: 'Wolfram',
            aliases: ['wl'],
            import: () => n.e(8512).then(n.bind(n, 9444)),
          },
          {
            id: 'xml',
            name: 'XML',
            import: () =>
              Promise.all([n.e(1426), n.e(8412)]).then(n.bind(n, 6031)),
          },
          {
            id: 'xsl',
            name: 'XSL',
            import: () =>
              Promise.all([n.e(1426), n.e(5105)]).then(n.bind(n, 5105)),
          },
          {
            id: 'yaml',
            name: 'YAML',
            aliases: ['yml'],
            import: () => n.e(7483).then(n.bind(n, 7483)),
          },
          {
            id: 'zenscript',
            name: 'ZenScript',
            import: () => n.e(2142).then(n.bind(n, 2142)),
          },
          {
            id: 'zig',
            name: 'Zig',
            import: () => n.e(1898).then(n.bind(n, 1898)),
          },
        ],
        nu = Object.fromEntries(nl.map((e) => [e.id, e.import])),
        nh = Object.fromEntries(
          nl.flatMap((e) => e.aliases?.map((t) => [t, e.import]) || [])
        ),
        nc = { ...nu, ...nh },
          ...
          [
            {
              ...
              type: 'dark',
              import: () => n.e(3686).then(n.bind(n, 3686)),
            },
            {
              id: 'aurora-x',
              displayName: 'Aurora X',
              type: 'dark',
              import: () => n.e(5237).then(n.bind(n, 5237)),
            },
            {
              id: 'ayu-dark',
              displayName: 'Ayu Dark',
              type: 'dark',
              import: () => n.e(6066).then(n.bind(n, 6066)),
            },
            {
              id: 'catppuccin-frappe',
              displayName: 'Catppuccin Frapp\xe9',
              type: 'dark',
              import: () => n.e(637).then(n.bind(n, 637)),
            },
            {
              id: 'catppuccin-latte',
              displayName: 'Catppuccin Latte',
              type: 'light',
              import: () => n.e(1745).then(n.bind(n, 4126)),
            },
            {
              id: 'catppuccin-macchiato',
              displayName: 'Catppuccin Macchiato',
              type: 'dark',
              import: () => n.e(8482).then(n.bind(n, 8482)),
            },
            {
              id: 'catppuccin-mocha',
              displayName: 'Catppuccin Mocha',
              type: 'dark',
              import: () => n.e(3953).then(n.bind(n, 3953)),
            },
            {
              id: 'dark-plus',
              displayName: 'Dark Plus',
              type: 'dark',
              import: () => n.e(7733).then(n.bind(n, 7733)),
            },
            {
              id: 'dracula',
              displayName: 'Dracula Theme',
              type: 'dark',
              import: () => n.e(4394).then(n.bind(n, 4394)),
            },
            {
              id: 'dracula-soft',
              displayName: 'Dracula Theme Soft',
              type: 'dark',
              import: () => n.e(8753).then(n.bind(n, 8753)),
            },
            {
              id: 'everforest-dark',
              displayName: 'Everforest Dark',
              type: 'dark',
              import: () => n.e(5696).then(n.bind(n, 5696)),
            },
            {
              id: 'everforest-light',
              displayName: 'Everforest Light',
              type: 'light',
              import: () => n.e(8166).then(n.bind(n, 8166)),
            },
            {
              id: 'github-dark',
              displayName: 'GitHub Dark',
              type: 'dark',
              import: () => n.e(9450).then(n.bind(n, 7069)),
            },
            {
              id: 'github-dark-default',
              displayName: 'GitHub Dark Default',
              type: 'dark',
              import: () => n.e(7886).then(n.bind(n, 7886)),
            },
            {
              id: 'github-dark-dimmed',
              displayName: 'GitHub Dark Dimmed',
              type: 'dark',
              import: () => n.e(8309).then(n.bind(n, 8309)),
            },
            {
              id: 'github-dark-high-contrast',
              displayName: 'GitHub Dark High Contrast',
              type: 'dark',
              import: () => n.e(9378).then(n.bind(n, 9378)),
            },
            {
              id: 'github-light',
            ...
            },
            {
              ...
              type: 'light',
              import: () => n.e(1496).then(n.bind(n, 1496)),
            },
            {
              id: 'github-light-high-contrast',
              displayName: 'GitHub Light High Contrast',
              type: 'light',
              import: () => n.e(2584).then(n.bind(n, 2584)),
            },
            {
              id: 'gruvbox-dark-hard',
              displayName: 'Gruvbox Dark Hard',
              type: 'dark',
              import: () => n.e(1336).then(n.bind(n, 1336)),
            },
            {
              id: 'gruvbox-dark-medium',
              displayName: 'Gruvbox Dark Medium',
              type: 'dark',
              import: () => n.e(694).then(n.bind(n, 694)),
            },
            {
              id: 'gruvbox-dark-soft',
              displayName: 'Gruvbox Dark Soft',
              type: 'dark',
              import: () => n.e(2495).then(n.bind(n, 2495)),
            },
            {
            ...
            },
            {
              ...
              type: 'light',
              import: () => n.e(9152).then(n.bind(n, 9152)),
            },
            {
              id: 'gruvbox-light-soft',
              displayName: 'Gruvbox Light Soft',
              type: 'light',
              import: () => n.e(2669).then(n.bind(n, 2669)),
            },
            {
              id: 'houston',
              displayName: 'Houston',
              type: 'dark',
              import: () => n.e(1334).then(n.bind(n, 1334)),
            },
            {
              id: 'kanagawa-dragon',
              displayName: 'Kanagawa Dragon',
              type: 'dark',
              import: () => n.e(2357).then(n.bind(n, 2357)),
            },
            {
              id: 'kanagawa-lotus',
              displayName: 'Kanagawa Lotus',
              type: 'light',
              import: () => n.e(2063).then(n.bind(n, 2063)),
            },
            {
              id: 'kanagawa-wave',
              displayName: 'Kanagawa Wave',
              type: 'dark',
              import: () => n.e(5927).then(n.bind(n, 5927)),
            },
            {
              id: 'laserwave',
              displayName: 'LaserWave',
              type: 'dark',
              import: () => n.e(6178).then(n.bind(n, 6178)),
            },
            {
              id: 'light-plus',
              displayName: 'Light Plus',
              type: 'light',
              import: () => n.e(4771).then(n.bind(n, 4771)),
            },
            {
              id: 'material-theme',
              displayName: 'Material Theme',
              type: 'dark',
              import: () => n.e(6921).then(n.bind(n, 6921)),
            },
            {
              id: 'material-theme-darker',
              displayName: 'Material Theme Darker',
              type: 'dark',
              import: () => n.e(6869).then(n.bind(n, 6869)),
            },
            {
              id: 'material-theme-lighter',
              displayName: 'Material Theme Lighter',
              type: 'light',
              import: () => n.e(1007).then(n.bind(n, 1007)),
            },
            {
              id: 'material-theme-ocean',
              displayName: 'Material Theme Ocean',
              type: 'dark',
              import: () => n.e(8408).then(n.bind(n, 8408)),
            },
            {
              id: 'material-theme-palenight',
              displayName: 'Material Theme Palenight',
              type: 'dark',
              import: () => n.e(4792).then(n.bind(n, 4792)),
            },
            {
              id: 'min-dark',
              displayName: 'Min Dark',
              type: 'dark',
              import: () => n.e(7863).then(n.bind(n, 7863)),
            },
            {
              id: 'min-light',
              displayName: 'Min Light',
              type: 'light',
              import: () => n.e(2295).then(n.bind(n, 2295)),
            },
            {
              id: 'monokai',
              displayName: 'Monokai',
              type: 'dark',
              import: () => n.e(1666).then(n.bind(n, 1666)),
            },
            {
              id: 'night-owl',
              displayName: 'Night Owl',
              type: 'dark',
              import: () => n.e(2775).then(n.bind(n, 2775)),
            },
            {
              id: 'nord',
              displayName: 'Nord',
              type: 'dark',
              import: () => n.e(7589).then(n.bind(n, 7589)),
            },
            {
              id: 'one-dark-pro',
              displayName: 'One Dark Pro',
              type: 'dark',
              import: () => n.e(1181).then(n.bind(n, 1181)),
            },
            {
              id: 'one-light',
              displayName: 'One Light',
              type: 'light',
              import: () => n.e(8683).then(n.bind(n, 8683)),
            },
            {
              id: 'plastic',
              displayName: 'Plastic',
              type: 'dark',
              import: () => n.e(3500).then(n.bind(n, 3500)),
            },
            {
              id: 'poimandres',
              displayName: 'Poimandres',
              type: 'dark',
              import: () => n.e(6120).then(n.bind(n, 6120)),
            },
            {
              id: 'red',
              displayName: 'Red',
              type: 'dark',
              import: () => n.e(8841).then(n.bind(n, 8841)),
            },
            {
              id: 'rose-pine',
              displayName: 'Ros\xe9 Pine',
              type: 'dark',
              import: () => n.e(3800).then(n.bind(n, 3800)),
            },
            {
              id: 'rose-pine-dawn',
              displayName: 'Ros\xe9 Pine Dawn',
              type: 'light',
              import: () => n.e(7789).then(n.bind(n, 7789)),
            },
            {
              id: 'rose-pine-moon',
              displayName: 'Ros\xe9 Pine Moon',
              type: 'dark',
              import: () => n.e(6124).then(n.bind(n, 3743)),
            },
            {
              id: 'slack-dark',
              displayName: 'Slack Dark',
              type: 'dark',
              import: () => n.e(2231).then(n.bind(n, 2231)),
            },
            {
              id: 'slack-ochin',
              displayName: 'Slack Ochin',
              type: 'light',
              import: () => n.e(5368).then(n.bind(n, 5368)),
            },
            {
              id: 'snazzy-light',
              displayName: 'Snazzy Light',
              type: 'light',
              import: () => n.e(5736).then(n.bind(n, 5736)),
            },
            {
              id: 'solarized-dark',
              displayName: 'Solarized Dark',
              type: 'dark',
              import: () => n.e(7320).then(n.bind(n, 7320)),
            },
            {
              id: 'solarized-light',
              displayName: 'Solarized Light',
              type: 'light',
              import: () => n.e(9998).then(n.bind(n, 9998)),
            },
            {
              id: 'synthwave-84',
              displayName: "Synthwave '84",
              type: 'dark',
              import: () => n.e(6408).then(n.bind(n, 6408)),
            },
            {
              id: 'tokyo-night',
              displayName: 'Tokyo Night',
              type: 'dark',
              import: () => n.e(7107).then(n.bind(n, 7107)),
            },
            {
              id: 'vesper',
              displayName: 'Vesper',
              type: 'dark',
              import: () => n.e(1069).then(n.bind(n, 1069)),
            },
            {
              id: 'vitesse-black',
              displayName: 'Vitesse Black',
              type: 'dark',
              import: () => n.e(6055).then(n.bind(n, 6055)),
            },
            {
              id: 'vitesse-dark',
              displayName: 'Vitesse Dark',
              type: 'dark',
              import: () => n.e(7460).then(n.bind(n, 7460)),
            },
            {
              id: 'vitesse-light',
              displayName: 'Vitesse Light',
              type: 'light',
              import: () => n.e(1554).then(n.bind(n, 1554)),
            },
          ].map((e) => [e.id, e.import])
        );
      var np = n(1792).Buffer;
      ...
      (n_(nw, 'LAST_ID', 0),
        n_(nw, '_sharedPtr', 0),
        n_(nw, '_sharedPtrInUse', !1));
      class nS {
        constructor(e) {
          if ((n_(this, '_onigBinding'), n_(this, '_ptr'), !nv))
            throw new nm('Must invoke loadWasm first.');
          let t = [],
            n = [];
      ...
      async function nA(e) {
        return (
          ...
          {
            createScanner: (e) =>
              new nS(e.map((e) => ('string' == typeof e ? e : e.source))),
      ...
      let { codeToHtml: nP } = (function (e, t) {
        ...
        (function (e) {
          ...
          themes: nd,
          engine: () =>
            nA(Promise.all([n.e(1609), n.e(9130)]).then(n.bind(n, 9130))),
        }),
        {
