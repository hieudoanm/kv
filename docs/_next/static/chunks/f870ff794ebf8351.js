(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
            ...
            var e = {
              ...
              relative: function (a, t) {
                ...
                for (
                  ...
                  var d = a.charCodeAt(c + m);
                  if (d !== t.charCodeAt(i + m)) break;
                  47 === d && (o = m);
                }
                var u = '';
                for (m = c + o + 1; m <= l; ++m)
  ...
  (a, s, t) => {
    ...
    (!(function () {
      ...
      function o(a, s) {
        ...
        var m = new URL(a, i + '/'),
          d = new URL(s, m).toString().replace(i, ''),
          u = l.protocol || t.protocol;
        return (
          (u += t.slashes || l.slashes ? '//' : ''),
          !n && u ? (d = d.replace(c, u)) : n && (d = d.replace(c, '')),
          r.test(d) ||
            ~s.indexOf('.') ||
            '/' === a.slice(-1) ||
            '/' === s.slice(-1) ||
      ...
      function j(a, t, c) {
        ...
        var n = !/(^javascript)/.test(a) && a.match(f),
          h = b.test(a),
          r = '';
        n &&
          (d.test(n[1]) || ((r = n[1].toLowerCase()), (a = '' + n[2] + n[3])),
          n[2] ||
            ((h = !1),
            d.test(n[1]) ? ((r = n[1]), (a = '' + n[3])) : (a = '//' + n[3])),
          ...
          children: [
            ...
            (0, s.jsx)('div', {
              ...
              children: r
                ...
                : (0, s.jsx)(e.Shiki, { code: i, lang: 'html' }),
            }),
          ],
        });
      },
  ...
  (a) => {
    ...
    let c = ({
        ...
        let i = (0, e.useRef)(null),
          [h, r] = (0, e.useState)(0),
          [o, m] = (0, e.useState)(new Set()),
          [d, u] = (0, e.useState)(null),
          f = t.length * c,
          b = Math.ceil(l / c),
          p = Math.floor(h / c),
          j = Math.min(p + b + 1, t.length),
          k = t.slice(p, j),
          v = (0, e.useCallback)(() => {
          ...
          P = (a) => {
            ...
            let s = i.current,
              ...
              e = a * c,
              n = e + c;
            e < t ? (s.scrollTop = e) : n > t + l && (s.scrollTop = n - l);
          },
          g = (a, s) => {
            let t = Math.min(a, s),
              e = Math.max(a, s),
              c = new Set(o);
            for (let a = t; a <= e; a++) c.add(a);
            return c;
          };
        return (
          (0, e.useEffect)(() => {
          ...
          (0, s.jsxs)('div', {
            ...
            onKeyDown: (a) => {
              ...
              let s = null !== d ? d : o.size > 0 ? Math.min(...o) : 0;
              if ('ArrowDown' === a.key) {
                a.preventDefault();
                let e = Math.min(s + 1, t.length - 1);
                (a.shiftKey ? m(g(d ?? e, e)) : (m(new Set([e])), u(e)),
                  P(e),
                  u(e));
              }
              if ('ArrowUp' === a.key) {
                a.preventDefault();
                let t = Math.max(s - 1, 0);
                (a.shiftKey ? m(g(d ?? t, t)) : (m(new Set([t])), u(t)),
                  P(t),
                  u(t));
              }
            },
    ...
    var n = a.i(60373),
      i = a.i(23402);
    let h = (0, a.i(38414).fileURLToPath)(
      {
        get url() {
            ...
            (0, s.jsx)(n.PageTemplate, {
              ...
              children: (0, s.jsx)('section', {
                ...
                children: (0, s.jsx)('div', {
                  ...
                  children: (0, s.jsx)('div', {
                    className: 'flex flex-col gap-y-4 md:gap-y-8',
                    children: (0, s.jsx)(t.ReactPreview, {
                      id: 'virtual-table',
                      emoji: '📋',
                      group: 'React',
                      name: 'Virtual Table',
  ...
  63414,
  (a, s, t) => {
    let e = '/react/virtual-table';
    ((window.__NEXT_P = window.__NEXT_P || []).push([e, () => a.r(18104)]),
      s.hot &&
  ...
  (a) => {
    a.v((s) =>
      Promise.all(
        ['static/chunks/77de16e9cf8b9ce2.js'].map((s) => a.l(s))
      ).then(() => s(43113))
    );
  },
  24706,
  (a) => {
    a.v((s) =>
      Promise.all(
        ['static/chunks/510412e70dc4a40c.js'].map((s) => a.l(s))
      ).then(() => s(8757))
    );
  },
  41402,
