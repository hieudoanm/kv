  ...
  [8372],
  {
    8372: (e, t, n) => {
      ...
      let f = R(Array.prototype.forEach),
        ...
        E = R(String.prototype.toString),
        _ = R(String.prototype.match),
      ...
      var en = (function e() {
        ...
        let {
          ...
          e8 = x({}, ['annotation-xml']),
          e7 = x({}, ['title', 'style', 'font', 'a', 'script']),
          e4 = null,
              ...
              if (
                ...
                (e6 =
                  ...
                  (e4 =
                    ...
                    ? E
                    : y),
                (eA = S(e, 'ALLOWED_TAGS') ? x({}, e.ALLOWED_TAGS, e6) : eb),
                (eN = S(e, 'ALLOWED_ATTR') ? x({}, e.ALLOWED_ATTR, e6) : eS),
                (e2 = S(e, 'ALLOWED_NAMESPACES')
                  ? x({}, e.ALLOWED_NAMESPACES, E)
                  : e3),
                (eK = S(e, 'ADD_URI_SAFE_ATTR')
                  ? x(C(eV), e.ADD_URI_SAFE_ATTR, e6)
                  : eV),
                (eX = S(e, 'ADD_DATA_URI_TAGS')
                  ? x(C(e$), e.ADD_DATA_URI_TAGS, e6)
                  : e$),
                (ej = S(e, 'FORBID_CONTENTS')
                  ? x({}, e.FORBID_CONTENTS, e6)
                  : eq),
                (ev = S(e, 'FORBID_TAGS') ? x({}, e.FORBID_TAGS, e6) : C({})),
                (eR = S(e, 'FORBID_ATTR') ? x({}, e.FORBID_ATTR, e6) : C({})),
                ...
                eY &&
                  ((eA = x({}, z)),
                  (eN = []),
                  !0 === eY.html && (x(eA, k), x(eN, P)),
                  !0 === eY.svg && (x(eA, O), x(eN, H), x(eN, W)),
                  !0 === eY.svgFilters && (x(eA, D), x(eN, H), x(eN, W)),
                  !0 === eY.mathMl && (x(eA, M), x(eN, F), x(eN, W))),
                e.ADD_TAGS &&
                  (eA === eb && (eA = C(eA)), x(eA, e.ADD_TAGS, e6)),
                e.ADD_ATTR &&
                  (eN === eS && (eN = C(eN)), x(eN, e.ADD_ATTR, e6)),
                e.ADD_URI_SAFE_ATTR && x(eK, e.ADD_URI_SAFE_ATTR, e6),
                e.FORBID_CONTENTS &&
                  (ej === eq && (ej = C(ej)), x(ej, e.FORBID_CONTENTS, e6)),
                eG && (eA['#text'] = !0),
                eI && x(eA, ['html', 'head', 'body']),
                eA.table && (x(eA, ['tbody']), delete ev.tbody),
