...
${e.stack}`
  ...
  (e, t, n) => {
    ...
    async function q(t = {}) {
      ...
      if (
        ...
        let { initScriptLoader: t } = e.r(42189);
        t(a.scriptLoader);
      }
          ...
          .then(({ page: r, styleSheets: a }) =>
            s?.Component === r
              ? e
                  .A(92165)
                  .then((r) =>
                    e.A(1664).then((e) => ((t.App = n = e.default), r))
                  )
  ...
  (e, t, n) => {
    'use strict';
    (Object.defineProperty(n, '__esModule', { value: !0 }), e.r(93543));
    let r = e.r(44025),
      a = e.r(95099);
    ((window.next = {
      version: r.version,
