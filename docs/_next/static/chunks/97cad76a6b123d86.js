(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, n) => {
              ...
              switch (r) {
                ...
                case 'utf-8':
                  return (
                    (i = t),
                    (a = n),
                    T(C(e, this.length - i), this, i, a)
                  );
                case 'ascii':
                  return ((o = t), (s = n), T(N(e), this, o, s));
                case 'latin1':
                case 'binary':
                  return (function (e, t, n, r) {
                    return T(N(t), e, n, r);
    ...
    ((a.ab =
      '/ROOT/node_modules/.pnpm/next@16.0.5_@babel+core@7.28.5_react-dom@19.2.0_react@19.2.0__react@19.2.0/node_modules/next/dist/compiled/buffer/'),
      (t.exports = a(72)));
  },
  54035,
  (e) => {
    ...
    var ey = class e {
        ...
        static mergeAttributes(e, t, n) {
          ...
          return (
            ...
            L.set(e, t.languageId, t.tokenType, null, r, i, a)
          );
        }
        pushAttributed(t, n) {
          ...
          if (this._emitBinaryTokens) {
            ...
            if (
              ...
              for (let e of this._tokenTypeOverrides)
                e.matcher(t) && (n = L.set(n, 0, e.type, null, -1, 0, 0));
              this.balancedBracketSelectors &&
                (r = this.balancedBracketSelectors.match(t));
            }
            if (
              (r && (n = L.set(n, 0, 8, r, -1, 0, 0)),
    ...
    let eq = e$({
      ...
      e9 = {}.hasOwnProperty,
      te = {};
    for (t in e4) e9.call(e4, t) && (te[e4[t]] = t);
    let tt = /[^\dA-Za-z]/;
    function tn(e, t, n) {
      var r, i;
      let a,
    ...
    function tL(e, t, n, r) {
      return n &&
        ...
        : tr(
            e.value,
            Object.assign({}, r.settings.characterReferences, { subset: tT })
          );
    }
    let tP = (function (e, t) {
        let n = t || {};
        ...
        handlers: {
          ...
          raw: function (e, t, n, r) {
            return r.settings.allowDangerousHtml ? e.value : tL(e, t, n, r);
          },
    ...
    function t6(e, t, n = {}) {
      ...
      let l,
        u,
        { lang: c = 'text', theme: p = e.getLoadedThemes()[0] } = n;
      if (tG(c) || t$(p))
        return tH(t).map((e) => [{ content: e[0], offset: e[1] }]);
      let { theme: d, colorMap: m } = e.setTheme(p);
      if ('ansi' === c) {
        let e, r, i, a, o, s, l;
        return (
          (e = tM(d, n)),
    ...
    function nt(
      ...
      return (function (e, t, n, r = tY(e)) {
        ...
        return (r && tX(d, r), d);
      })(a, { ...n, fg: o, bg: s, themeName: l, rootStyle: u }, d, c);
    }
    let nn = function (e, t) {
        let n = t || tE,
          r = n.quote || '"';
      ...
      loadLanguages(e) {
        ...
        if (n.length) {
          let e = t
            .filter(
              ([e, t]) =>
                t && t.embeddedLangs?.some((e) => n.map(([e]) => e).includes(e))
            )
      ...
      return (function (e) {
        ...
        ((nc += 1),
          !1 !== e.warnings &&
            ...
            nc % 10 == 0 &&
            console.warn(
              `[Shiki] ${nc} instances have been created. Shiki is supposed to be used as a singleton, consider refactoring your code to cache your highlighter instance; Or call \`highlighter.dispose()\` to release unused instances.`
            ));
        let n = !1;
        if (!e.engine)
        ...
        let r = (e.langs || []).flat(1),
          ...
          a = new nl(new nu(e.engine, r), i, r, e.langAlias);
        function o(e) {
          if ('none' === e)
    ...
    async function np(e) {
      ...
      return {
        ...
        codeToTokensWithThemes: (e, n) => t7(t, e, n),
        codeToTokens: (e, n) => t9(t, e, n),
    ...
    let nd = [
        { id: 'abap', name: 'ABAP', import: () => e.A(49291) },
        {
          id: 'actionscript-3',
          name: 'ActionScript',
          import: () => e.A(21867),
        },
        { id: 'ada', name: 'Ada', import: () => e.A(46245) },
        { id: 'angular-html', name: 'Angular HTML', import: () => e.A(3428) },
        {
          id: 'angular-ts',
          name: 'Angular TypeScript',
          import: () => e.A(40097),
        },
        { id: 'apache', name: 'Apache Conf', import: () => e.A(5346) },
        { id: 'apex', name: 'Apex', import: () => e.A(65470) },
        { id: 'apl', name: 'APL', import: () => e.A(56916) },
        { id: 'applescript', name: 'AppleScript', import: () => e.A(21911) },
        { id: 'ara', name: 'Ara', import: () => e.A(27222) },
        {
          id: 'asciidoc',
          name: 'AsciiDoc',
          aliases: ['adoc'],
        ...
        { id: 'asm', name: 'Assembly', import: () => e.A(75702) },
        { id: 'astro', name: 'Astro', import: () => e.A(81730) },
        { id: 'awk', name: 'AWK', import: () => e.A(98174) },
        { id: 'ballerina', name: 'Ballerina', import: () => e.A(21587) },
        {
          id: 'bat',
          name: 'Batch File',
          aliases: ['batch'],
        ...
        { id: 'beancount', name: 'Beancount', import: () => e.A(43621) },
        {
          id: 'berry',
          name: 'Berry',
          aliases: ['be'],
        ...
        { id: 'bibtex', name: 'BibTeX', import: () => e.A(65436) },
        { id: 'bicep', name: 'Bicep', import: () => e.A(60012) },
        { id: 'blade', name: 'Blade', import: () => e.A(7040) },
        {
          id: 'bsl',
          name: '1C (Enterprise)',
          aliases: ['1c'],
        ...
        { id: 'cairo', name: 'Cairo', import: () => e.A(37502) },
        { id: 'clarity', name: 'Clarity', import: () => e.A(2866) },
        {
          id: 'clojure',
          name: 'Clojure',
          aliases: ['clj'],
        ...
        { id: 'cmake', name: 'CMake', import: () => e.A(81835) },
        { id: 'cobol', name: 'COBOL', import: () => e.A(60771) },
        { id: 'codeowners', name: 'CODEOWNERS', import: () => e.A(19610) },
        {
          id: 'codeql',
          name: 'CodeQL',
          aliases: ['ql'],
        ...
        { id: 'coq', name: 'Coq', import: () => e.A(27914) },
        { id: 'cpp', name: 'C++', aliases: ['c++'], import: () => e.A(96052) },
        { id: 'crystal', name: 'Crystal', import: () => e.A(39131) },
        {
          id: 'csharp',
          name: 'C#',
          aliases: ['c#', 'cs'],
        ...
        { id: 'css', name: 'CSS', import: () => e.A(40013) },
        { id: 'csv', name: 'CSV', import: () => e.A(38735) },
        { id: 'cue', name: 'CUE', import: () => e.A(76098) },
        {
          id: 'cypher',
          name: 'Cypher',
          aliases: ['cql'],
        ...
        { id: 'd', name: 'D', import: () => e.A(48866) },
        { id: 'dart', name: 'Dart', import: () => e.A(14284) },
        { id: 'dax', name: 'DAX', import: () => e.A(60177) },
        { id: 'desktop', name: 'Desktop', import: () => e.A(38982) },
        { id: 'diff', name: 'Diff', import: () => e.A(71486) },
        {
          id: 'docker',
          name: 'Dockerfile',
          aliases: ['dockerfile'],
        ...
        { id: 'dotenv', name: 'dotEnv', import: () => e.A(86486) },
        { id: 'dream-maker', name: 'Dream Maker', import: () => e.A(41567) },
        { id: 'edge', name: 'Edge', import: () => e.A(74335) },
        { id: 'elixir', name: 'Elixir', import: () => e.A(89586) },
        { id: 'elm', name: 'Elm', import: () => e.A(27252) },
        {
          id: 'emacs-lisp',
          name: 'Emacs Lisp',
          aliases: ['elisp'],
        ...
        { id: 'erb', name: 'ERB', import: () => e.A(96510) },
        {
          id: 'erlang',
          name: 'Erlang',
          aliases: ['erl'],
        ...
        { id: 'fennel', name: 'Fennel', import: () => e.A(11689) },
        { id: 'fish', name: 'Fish', import: () => e.A(38492) },
        {
          id: 'fluent',
          name: 'Fluent',
          aliases: ['ftl'],
        ...
        { id: 'gdresource', name: 'GDResource', import: () => e.A(59637) },
        { id: 'gdscript', name: 'GDScript', import: () => e.A(99413) },
        { id: 'gdshader', name: 'GDShader', import: () => e.A(13964) },
        { id: 'genie', name: 'Genie', import: () => e.A(91833) },
        { id: 'gherkin', name: 'Gherkin', import: () => e.A(17020) },
        {
          id: 'git-commit',
        ...
        { id: 'gleam', name: 'Gleam', import: () => e.A(54700) },
        {
          id: 'glimmer-js',
          name: 'Glimmer JS',
          aliases: ['gjs'],
        ...
        { id: 'glsl', name: 'GLSL', import: () => e.A(59935) },
        { id: 'gnuplot', name: 'Gnuplot', import: () => e.A(56695) },
        { id: 'go', name: 'Go', import: () => e.A(73875) },
        {
          id: 'graphql',
          name: 'GraphQL',
          aliases: ['gql'],
        ...
        { id: 'groovy', name: 'Groovy', import: () => e.A(48157) },
        { id: 'hack', name: 'Hack', import: () => e.A(32260) },
        { id: 'haml', name: 'Ruby Haml', import: () => e.A(79942) },
        {
          id: 'handlebars',
          name: 'Handlebars',
          aliases: ['hbs'],
        ...
        { id: 'haxe', name: 'Haxe', import: () => e.A(84750) },
        { id: 'hcl', name: 'HashiCorp HCL', import: () => e.A(17255) },
        { id: 'hjson', name: 'Hjson', import: () => e.A(18392) },
        { id: 'hlsl', name: 'HLSL', import: () => e.A(6572) },
        { id: 'html', name: 'HTML', import: () => e.A(38354) },
        {
          id: 'html-derivative',
          name: 'HTML (Derivative)',
          import: () => e.A(3575),
        },
        { id: 'http', name: 'HTTP', import: () => e.A(65394) },
        { id: 'hurl', name: 'Hurl', import: () => e.A(95404) },
        { id: 'hxml', name: 'HXML', import: () => e.A(44451) },
        { id: 'hy', name: 'Hy', import: () => e.A(16860) },
        { id: 'imba', name: 'Imba', import: () => e.A(11848) },
        {
          id: 'ini',
          name: 'INI',
          aliases: ['properties'],
        ...
        { id: 'java', name: 'Java', import: () => e.A(33092) },
        {
          id: 'javascript',
          name: 'JavaScript',
          aliases: ['js', 'cjs', 'mjs'],
        ...
        { id: 'jinja', name: 'Jinja', import: () => e.A(32234) },
        { id: 'jison', name: 'Jison', import: () => e.A(29881) },
        { id: 'json', name: 'JSON', import: () => e.A(43599) },
        { id: 'json5', name: 'JSON5', import: () => e.A(92031) },
        { id: 'jsonc', name: 'JSON with Comments', import: () => e.A(38164) },
        { id: 'jsonl', name: 'JSON Lines', import: () => e.A(17907) },
        { id: 'jsonnet', name: 'Jsonnet', import: () => e.A(6395) },
        {
          id: 'jssm',
          name: 'JSSM',
          aliases: ['fsl'],
        ...
        { id: 'jsx', name: 'JSX', import: () => e.A(37395) },
        {
          id: 'julia',
          name: 'Julia',
          aliases: ['jl'],
        ...
        { id: 'kdl', name: 'KDL', import: () => e.A(62039) },
        {
          id: 'kotlin',
          name: 'Kotlin',
          aliases: ['kt', 'kts'],
        ...
        { id: 'latex', name: 'LaTeX', import: () => e.A(40927) },
        {
          id: 'lean',
          name: 'Lean 4',
          aliases: ['lean4'],
        ...
        { id: 'less', name: 'Less', import: () => e.A(35113) },
        { id: 'liquid', name: 'Liquid', import: () => e.A(84439) },
        { id: 'llvm', name: 'LLVM IR', import: () => e.A(14523) },
        { id: 'log', name: 'Log file', import: () => e.A(94164) },
        { id: 'logo', name: 'Logo', import: () => e.A(46085) },
        { id: 'lua', name: 'Lua', import: () => e.A(16785) },
        { id: 'luau', name: 'Luau', import: () => e.A(27801) },
        {
          id: 'make',
          name: 'Makefile',
          aliases: ['makefile'],
        ...
        { id: 'marko', name: 'Marko', import: () => e.A(45032) },
        { id: 'matlab', name: 'MATLAB', import: () => e.A(87681) },
        { id: 'mdc', name: 'MDC', import: () => e.A(66913) },
        { id: 'mdx', name: 'MDX', import: () => e.A(31867) },
        {
          id: 'mermaid',
          name: 'Mermaid',
          aliases: ['mmd'],
        ...
        { id: 'mojo', name: 'Mojo', import: () => e.A(60515) },
        { id: 'move', name: 'Move', import: () => e.A(12191) },
        {
          id: 'narrat',
        ...
        { id: 'nginx', name: 'Nginx', import: () => e.A(65153) },
        { id: 'nim', name: 'Nim', import: () => e.A(51975) },
        { id: 'nix', name: 'Nix', import: () => e.A(4003) },
        {
          id: 'nushell',
          name: 'nushell',
          aliases: ['nu'],
        ...
        { id: 'objective-cpp', name: 'Objective-C++', import: () => e.A(4761) },
        { id: 'ocaml', name: 'OCaml', import: () => e.A(71940) },
        {
          id: 'openscad',
          name: 'OpenSCAD',
          aliases: ['scad'],
        ...
        { id: 'pascal', name: 'Pascal', import: () => e.A(5572) },
        { id: 'perl', name: 'Perl', import: () => e.A(64164) },
        { id: 'php', name: 'PHP', import: () => e.A(39478) },
        { id: 'pkl', name: 'Pkl', import: () => e.A(71435) },
        { id: 'plsql', name: 'PL/SQL', import: () => e.A(21649) },
        {
          id: 'po',
          name: 'Gettext PO',
          aliases: ['pot', 'potx'],
        ...
        { id: 'polar', name: 'Polar', import: () => e.A(9442) },
        { id: 'postcss', name: 'PostCSS', import: () => e.A(30132) },
        { id: 'powerquery', name: 'PowerQuery', import: () => e.A(85102) },
        {
          id: 'powershell',
          name: 'PowerShell',
          aliases: ['ps', 'ps1'],
        ...
        { id: 'prisma', name: 'Prisma', import: () => e.A(81447) },
        { id: 'prolog', name: 'Prolog', import: () => e.A(72327) },
        {
          id: 'proto',
        ...
        { id: 'pug', name: 'Pug', aliases: ['jade'], import: () => e.A(66040) },
        { id: 'puppet', name: 'Puppet', import: () => e.A(58316) },
        { id: 'purescript', name: 'PureScript', import: () => e.A(50793) },
        {
          id: 'python',
          name: 'Python',
          aliases: ['py'],
        ...
        { id: 'qml', name: 'QML', import: () => e.A(59678) },
        { id: 'qmldir', name: 'QML Directory', import: () => e.A(29839) },
        { id: 'qss', name: 'Qt Style Sheets', import: () => e.A(72903) },
        { id: 'r', name: 'R', import: () => e.A(22702) },
        { id: 'racket', name: 'Racket', import: () => e.A(16427) },
        {
          id: 'raku',
          name: 'Raku',
          aliases: ['perl6'],
        ...
        { id: 'razor', name: 'ASP.NET Razor', import: () => e.A(53864) },
        {
          id: 'reg',
        ...
        { id: 'rel', name: 'Rel', import: () => e.A(65108) },
        { id: 'riscv', name: 'RISC-V', import: () => e.A(37175) },
        { id: 'rosmsg', name: 'ROS Interface', import: () => e.A(10155) },
        { id: 'rst', name: 'reStructuredText', import: () => e.A(72492) },
        { id: 'ruby', name: 'Ruby', aliases: ['rb'], import: () => e.A(50487) },
        { id: 'rust', name: 'Rust', aliases: ['rs'], import: () => e.A(74590) },
        { id: 'sas', name: 'SAS', import: () => e.A(71590) },
        { id: 'sass', name: 'Sass', import: () => e.A(29515) },
        { id: 'scala', name: 'Scala', import: () => e.A(49161) },
        { id: 'scheme', name: 'Scheme', import: () => e.A(13345) },
        { id: 'scss', name: 'SCSS', import: () => e.A(30047) },
        {
          id: 'sdbl',
          name: '1C (Query)',
          aliases: ['1c-query'],
        ...
        { id: 'smalltalk', name: 'Smalltalk', import: () => e.A(41609) },
        { id: 'solidity', name: 'Solidity', import: () => e.A(42447) },
        {
          id: 'soy',
        ...
        { id: 'sparql', name: 'SPARQL', import: () => e.A(18180) },
        {
          id: 'splunk',
        ...
        { id: 'sql', name: 'SQL', import: () => e.A(41803) },
        { id: 'ssh-config', name: 'SSH Config', import: () => e.A(11390) },
        { id: 'stata', name: 'Stata', import: () => e.A(786) },
        {
          id: 'stylus',
          name: 'Stylus',
          aliases: ['styl'],
        ...
        { id: 'svelte', name: 'Svelte', import: () => e.A(91545) },
        { id: 'swift', name: 'Swift', import: () => e.A(39371) },
        {
          id: 'system-verilog',
          name: 'SystemVerilog',
          import: () => e.A(86025),
        },
        { id: 'systemd', name: 'Systemd Units', import: () => e.A(2171) },
        {
          id: 'talonscript',
          name: 'TalonScript',
          aliases: ['talon'],
        ...
        { id: 'tasl', name: 'Tasl', import: () => e.A(86972) },
        { id: 'tcl', name: 'Tcl', import: () => e.A(5240) },
        { id: 'templ', name: 'Templ', import: () => e.A(4872) },
        {
          id: 'terraform',
          name: 'Terraform',
          aliases: ['tf', 'tfvars'],
        ...
        { id: 'tex', name: 'TeX', import: () => e.A(18237) },
        { id: 'toml', name: 'TOML', import: () => e.A(93372) },
        {
          id: 'ts-tags',
        ...
        { id: 'tsv', name: 'TSV', import: () => e.A(21345) },
        { id: 'tsx', name: 'TSX', import: () => e.A(10555) },
        { id: 'turtle', name: 'Turtle', import: () => e.A(73984) },
        { id: 'twig', name: 'Twig', import: () => e.A(43210) },
        {
          id: 'typescript',
          name: 'TypeScript',
          aliases: ['ts', 'cts', 'mts'],
        ...
        { id: 'v', name: 'V', import: () => e.A(45840) },
        { id: 'vala', name: 'Vala', import: () => e.A(38405) },
        {
          id: 'vb',
          name: 'Visual Basic',
          aliases: ['cmd'],
        ...
        { id: 'verilog', name: 'Verilog', import: () => e.A(90967) },
        { id: 'vhdl', name: 'VHDL', import: () => e.A(17026) },
        {
          id: 'viml',
          name: 'Vim Script',
        ...
        { id: 'vue', name: 'Vue', import: () => e.A(4354) },
        { id: 'vue-html', name: 'Vue HTML', import: () => e.A(83739) },
        { id: 'vue-vine', name: 'Vue Vine', import: () => e.A(19868) },
        {
          id: 'vyper',
          name: 'Vyper',
          aliases: ['vy'],
        ...
        { id: 'wasm', name: 'WebAssembly', import: () => e.A(45166) },
        {
          id: 'wenyan',
          name: 'Wenyan',
          aliases: ['文言'],
        ...
        { id: 'wgsl', name: 'WGSL', import: () => e.A(70748) },
        {
          id: 'wikitext',
          name: 'Wikitext',
        ...
        { id: 'xml', name: 'XML', import: () => e.A(75284) },
        { id: 'xsl', name: 'XSL', import: () => e.A(2717) },
        {
          id: 'yaml',
          name: 'YAML',
          aliases: ['yml'],
        ...
        { id: 'zenscript', name: 'ZenScript', import: () => e.A(99707) },
        { id: 'zig', name: 'Zig', import: () => e.A(84117) },
      ],
      nm = Object.fromEntries(nd.map((e) => [e.id, e.import])),
      nf = Object.fromEntries(
        nd.flatMap((e) => e.aliases?.map((t) => [t, e.import]) || [])
      ),
      ng = { ...nm, ...nf },
      ny = Object.fromEntries(
        [
          {
            id: 'andromeeda',
        ...
        emscripten_resize_heap: function (e) {
          ...
          for (let r = 1; r <= 4; r *= 2) {
            ...
            if (
              ...
              })(Math.min(0x80000000, nv(Math.max(e, o), 65536))))
            )
              return !0;
          }
          return !1;
    ...
    class nN {
      constructor(e) {
        (nS(this, 'utf16Length'),
          ...
          nS(this, 'utf16Value'),
          nS(this, 'utf8Value'),
          nS(this, 'utf16OffsetToUtf8'),
          nS(this, 'utf8OffsetToUtf16'));
        const t = e.length,
          n = nN._utf8ByteLength(e),
          r = n !== t,
    ...
    let nx = class e {
      constructor(t) {
        if (
          (nS(this, 'id', ++e.LAST_ID),
          nS(this, '_onigBinding'),
          nS(this, 'content'),
          nS(this, 'utf16Length'),
          nS(this, 'utf8Length'),
          nS(this, 'utf16OffsetToUtf8'),
          ...
          throw new nA('Must invoke loadWasm first.');
        ((this._onigBinding = nC), (this.content = t));
        const n = new nN(t);
        ((this.utf16Length = n.utf16Length),
          ...
          this.utf8Length < 1e4 && !e._sharedPtrInUse
            ? (e._sharedPtr || (e._sharedPtr = nC.omalloc(1e4)),
              (e._sharedPtrInUse = !0),
              nC.HEAPU8.set(n.utf8Value, e._sharedPtr),
              (this.ptr = e._sharedPtr))
            : (this.ptr = n.createString(nC)));
      }
    ...
    (nS(nx, 'LAST_ID', 0),
      nS(nx, '_sharedPtr', 0),
      nS(nx, '_sharedPtrInUse', !1));
    class nT {
      constructor(e) {
        if ((nS(this, '_onigBinding'), nS(this, '_ptr'), !nC))
          throw new nA('Must invoke loadWasm first.');
        const t = [],
          n = [];
        for (let r = 0, i = e.length; r < i; r++) {
          const i = new nN(e[r]);
          ((t[r] = i.createString(nC)), (n[r] = i.utf8Length));
        }
        const r = nC.omalloc(4 * e.length);
        nC.HEAPU32.set(t, r / 4);
        const i = nC.omalloc(4 * e.length);
        nC.HEAPU32.set(n, i / 4);
        const a = nC.createOnigScanner(r, i, e.length);
        for (let n = 0, r = e.length; n < r; n++) nC.ofree(t[n]);
        (nC.ofree(i),
          nC.ofree(r),
          0 === a &&
            (function (e) {
              throw new nA(e.UTF8ToString(e.getLastOnigError()));
            })(nC),
          (this._onigBinding = nC),
          (this._ptr = a));
      }
      dispose() {
    ...
    async function nP(e) {
      return (
                ...
                if (
                  ...
                  if (
                    ...
                    ('undefined' != typeof ArrayBuffer &&
                      ...
                      (void 0 !== nb.Buffer && nb.Buffer.isBuffer?.(i)) ||
                      ('undefined' != typeof SharedArrayBuffer &&
            ...
            })()))),
        {
          ...
          createString: (e) => new nx(e),
        }
      );
    }
    let { codeToHtml: nE } = (function (e, t) {
      let n,
        r = async function (t = {}) {
          if (n) {
            let e = await n;
      ...
      ((r = (l = { langs: ng, themes: ny, engine: () => nP(e.A(95415)) })
        .langs),
      (i = l.themes),
      (a = l.engine),
      async function (e) {
        ...
        let o = (e.themes ?? []).map((e) => n(e)),
          s = (e.langs ?? []).map((e) => t(e)),
          l = await np({ engine: e.engine ?? a(), ...e, themes: o, langs: s });
        return {
          ...l,
      ...
      [
        ...
        ({ code: e, lang: t }) => {
          ...
          return (
            (0, c.useEffect)(() => {
              (async () => {
                r(await nE(e, { lang: t, theme: 'github-dark' }));
              })();
            }),
            (0, u.jsx)('div', {
              className:
