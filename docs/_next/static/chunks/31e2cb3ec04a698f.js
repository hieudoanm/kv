(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
            ...
            if (
              ...
              (e6 =
                ...
                (e7 =
                  ...
                  ? T
                  : g),
              (eE = b(e, 'ALLOWED_TAGS') ? v({}, e.ALLOWED_TAGS, e6) : eA),
              (eb = b(e, 'ALLOWED_ATTR') ? v({}, e.ALLOWED_ATTR, e6) : eN),
              (e2 = b(e, 'ALLOWED_NAMESPACES')
                ? v({}, e.ALLOWED_NAMESPACES, T)
                : e3),
              (e$ = b(e, 'ADD_URI_SAFE_ATTR')
                ? v(C(eV), e.ADD_URI_SAFE_ATTR, e6)
                : eV),
              (eq = b(e, 'ADD_DATA_URI_TAGS')
                ? v(C(eK), e.ADD_DATA_URI_TAGS, e6)
                : eK),
              (eY = b(e, 'FORBID_CONTENTS')
                ? v({}, e.FORBID_CONTENTS, e6)
                : eX),
              (ew = b(e, 'FORBID_TAGS') ? v({}, e.FORBID_TAGS, e6) : C({})),
              (ev = b(e, 'FORBID_ATTR') ? v({}, e.FORBID_ATTR, e6) : C({})),
              ...
              e.ADD_TAGS &&
                ('function' == typeof e.ADD_TAGS
                  ...
                  : (eE === eA && (eE = C(eE)), v(eE, e.ADD_TAGS, e6))),
              e.ADD_ATTR &&
                ('function' == typeof e.ADD_ATTR
                  ? (eC.attributeCheck = e.ADD_ATTR)
                  : (eb === eN && (eb = C(eb)), v(eb, e.ADD_ATTR, e6))),
              e.ADD_URI_SAFE_ATTR && v(e$, e.ADD_URI_SAFE_ATTR, e6),
              e.FORBID_CONTENTS &&
                (eY === eX && (eY = C(eY)), v(eY, e.FORBID_CONTENTS, e6)),
              e.ADD_FORBID_CONTENTS &&
                (eY === eX && (eY = C(eY)), v(eY, e.ADD_FORBID_CONTENTS, e6)),
              eB && (eE['#text'] = !0),
  ...
  (e) => {
    e.v((t) =>
      Promise.all(
        ['static/chunks/889d7436c8dbb3d7.js'].map((t) => e.l(t))
      ).then(() => t(41618))
    );
  },
  27403,
  (e) => {
    e.v((t) =>
      Promise.all(
        ['static/chunks/ae3ae7cea34a41a9.js'].map((t) => e.l(t))
      ).then(() => t(45367))
    );
  },
]);
