(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (s) => {
    ...
    s.s([
      ...
      ({
        ...
        let [u, f] = (0, e.useState)(''),
          [b, r] = (0, e.useState)(!0);
        return (
          (0, e.useEffect)(() => {
            f((0, t.default)(window).sanitize(m));
          }, [m]),
          (0, a.jsxs)('div', {
            id: s,
  ...
  (s) => {
    ...
    var i = s.i(60373),
      n = s.i(23402);
    let h = (0, s.i(38414).fileURLToPath)(
      {
        get url() {
          ...
          ({ template: s = { id: '', name: '', code: '' } }) => {
            ...
            return (0, a.jsxs)(i.PageTemplate, {
              ...
              children: [
                ...
                t && (0, a.jsx)(l, { name: m, code: d, onClose: () => n() }),
              ],
            });
          },
        ],
  ...
  (s) => {
    s.v((a) =>
      Promise.all(
        ['static/chunks/77de16e9cf8b9ce2.js'].map((a) => s.l(a))
      ).then(() => a(43113))
    );
  },
  24706,
  (s) => {
    s.v((a) =>
      Promise.all(
        ['static/chunks/510412e70dc4a40c.js'].map((a) => s.l(a))
      ).then(() => a(8757))
    );
  },
  41402,
