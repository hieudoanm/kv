(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    !(function () {
          ...
          114: function (e) {
            ...
            var o = {
              ...
              relative: function (e, r) {
                ...
                for (
                  var l = r.length - i, c = s < l ? s : l, h = -1, p = 0;
                  p <= c;
                  ++p
                ) {
                  if (p === c) {
              ...
              parse: function (e) {
                ...
                a ? ((o.root = '/'), (r = 1)) : (r = 0);
                for (
                  var s = -1, i = 0, l = -1, c = !0, h = e.length - 1, p = 0;
                  h >= r;
                  --h
                ) {
                ...
                return (
                  ...
                  (1 === p && s === l - 1 && s === i + 1)
                    ? -1 !== l &&
                      (0 === i && a
                        ? (o.base = o.name = e.slice(1, l))
                        : (o.base = o.name = e.slice(i, l)))
                    : (0 === i && a
                        ? ((o.name = e.slice(1, s)), (o.base = e.slice(1, l)))
                        : ((o.name = e.slice(i, s)), (o.base = e.slice(i, l))),
                      (o.ext = e.slice(s, l))),
      ...
      ((o.ab =
        '/ROOT/node_modules/.pnpm/next@16.0.7_@babel+core@7.28.5_react-dom@19.2.1_react@19.2.1__react@19.2.1/node_modules/next/dist/compiled/path-browserify/'),
        (t.exports = o(114)));
    })();
  },
  70322,
  (e, t, r) => {
    !(function () {
      ...
      o.ab =
        '/ROOT/node_modules/.pnpm/next@16.0.7_@babel+core@7.28.5_react-dom@19.2.1_react@19.2.1__react@19.2.1/node_modules/next/dist/compiled/querystring-es3/';
      var n = {};
  ...
  (e, t, r) => {
    ...
    a.ab =
      '/ROOT/node_modules/.pnpm/next@16.0.7_@babel+core@7.28.5_react-dom@19.2.1_react@19.2.1__react@19.2.1/node_modules/next/dist/compiled/native-url/';
    var s = {};
    (!(function () {
      var e,
        t =
      ...
      function v(e, r, n) {
        ...
        var s = !/(^javascript)/.test(e) && e.match(f),
          ...
          c = '';
        s &&
          (u.test(s[1]) || ((c = s[1].toLowerCase()), (e = '' + s[2] + s[3])),
          s[2] ||
            ((l = !1),
            u.test(s[1]) ? ((c = s[1]), (e = '' + s[3])) : (e = '//' + s[3])),
  ...
  (e) => {
    ...
    var t = e.i(28626),
      ...
      n = e.i(39186),
      a = e.i(73173);
    let s = (0, e.i(42494).fileURLToPath)(
      {
        get url() {
          return `file://${e.P('src/pages/tools/log/index.tsx')}`;
        },
      }.url
    );
                ...
                children: (0, t.jsxs)('div', {
                  ...
                  children: [
                    ...
                    (0, t.jsx)('div', {
                      ...
                      children: (0, t.jsx)(r.Shiki, { code: e, lang: 'ts' }),
                    }),
                  ],
                }),
              }),
  ...
  (e, t, r) => {
    let o = '/tools/log';
    ((window.__NEXT_P = window.__NEXT_P || []).push([o, () => e.r(17356)]),
      t.hot &&
