(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    var n = e.i(3690);
    let o = ({ emoji: e = '', title: r = '', description: o = '' }) =>
      (0, t.jsx)('section', {
    ...
    let i = ({ checked: e = !1, onChange: r = () => {} }) =>
      ...
      u = ({ links: e = [] }) => {
        let r = Array.from(new Set(e.map(({ group: e }) => e))).map((t) => ({
          group: t,
          links: e.filter(({ group: e }) => t === e),
        }));
        return (0, t.jsx)('div', {
          className: 'hidden items-center gap-x-2 md:flex md:gap-x-4',
          children: r.map(({ group: e, links: r = [] }) =>
            (0, t.jsxs)(
              'div',
              {
                className: 'group relative inline-block text-left',
      ...
      c = ({
        ...
        let { darkMode: d = !1, toggleDarkMode: p } = (0, a.useDarkMode)();
        return (0, t.jsx)('nav', {
          className:
              ...
              (0, t.jsxs)('div', {
                ...
                children: [
                  ...
                  (0, t.jsxs)('div', {
                    ...
                    children: [
                      (0, t.jsx)(u, { links: o }),
                      (0, t.jsx)(i, { checked: d, onChange: () => p() }),
                    ],
                  }),
                ],
              }),
    ...
    e.s(
      [
        ...
        ({
          ...
          title: l = '',
          description: u = '',
          children: m = (0, t.jsx)(t.Fragment, {}),
        }) => {
          let { emoji: h = s, description: g = u } = p.find(
              ({ id: e = '' }) => i === e
            ) ?? { emoji: s, description: u },
            y = `${h} ${l}`;
          return (0, t.jsxs)(t.Fragment, {
            children: [
              (0, t.jsxs)(d.default, {
                children: [
                  (0, t.jsx)('title', { children: y }),
                  (0, t.jsx)('meta', { name: 'description', content: g || u }),
                ],
              }),
              (0, t.jsx)(f.RadialGradientBackground, {}),
              (0, t.jsxs)('div', {
                className:
  ...
  (e, t, r) => {
    ...
    ((a.ab =
      '/ROOT/node_modules/.pnpm/next@16.0.10_@babel+core@7.28.5_react-dom@19.2.3_react@19.2.3__react@19.2.3/node_modules/next/dist/compiled/process/'),
      (t.exports = a(229)));
  },
  79022,
  (e, t, r) => {
  ...
  (e, t, r) => {
    ...
    var _ = (k.prototype = new j());
    ((_.constructor = k), b(_, x.prototype), (_.isPureReactComponent = !0));
    var w = Array.isArray;
    function E() {}
        ...
        !(function e(t, r, n, i, s) {
          ...
          if (w(t))
            ...
            for (t = h.call(t), h = 0; !(i = t.next()).done; )
              ((f = p + T((i = i.value), h++)), (d += e(i, r, n, f, s)));
          else if ('object' === f) {
  ...
  (e, t, r) => {
    ...
    let j = s.default.forwardRef(function (e, t) {
        ...
        let R = s.default.useContext(p.RouterContext),
          M = !1 !== b,
          { href: I, as: A } = s.default.useMemo(() => {
            if (!R) {
              let e = x(o);
              return { href: e, as: a ? x(a) : e };
            }
            let [e, t] = (0, l.resolveHref)(R, o, !0);
            return { href: e, as: a ? (0, l.resolveHref)(R, a) : t || e };
          }, [R, o, a]),
          U = s.default.useRef(I),
          L = s.default.useRef(A);
        N && (n = s.default.Children.only(r));
        let H = N ? n && 'object' == typeof n && n.ref : t,
          [$, D, z] = (0, m.useIntersection)({ rootMargin: '200px' }),
          F = s.default.useCallback(
            (e) => {
              ((L.current !== A || U.current !== I) &&
                (z(), (L.current = A), (U.current = I)),
                $(e));
            },
            [A, I, z, $]
          ),
          B = (0, y.useMergedRef)(F, H);
        s.default.useEffect(() => {
          !R || (D && M && v(R, I, A, { locale: E }));
        }, [A, I, D, E, M, R?.locale, R]);
        let V = {
          ref: B,
          onClick(e) {
        ...
        if ((0, f.isAbsoluteUrl)(A)) V.href = A;
        else if (!N || j || ('a' === n.type && !('href' in n.props))) {
          let e = void 0 !== E ? E : R?.locale;
          V.href =
            (R?.isLocaleDomain &&
              (0, h.getDomainLocale)(A, e, R?.locales, R?.domainLocales)) ||
            (0, g.addBasePath)((0, d.addLocale)(A, e, R?.defaultLocale));
        }
        return N
          ? s.default.cloneElement(n, V)
          : (0, i.jsx)('a', { ...T, ...V, children: r });
      }),
      k = (0, s.createContext)({ pending: !1 }),
      _ = () => (0, s.useContext)(k),
      w = j;
    ('function' == typeof r.default ||
      ('object' == typeof r.default && null !== r.default)) &&
