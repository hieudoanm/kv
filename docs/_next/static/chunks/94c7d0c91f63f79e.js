...
${e.stack}`
  ...
  (e, t, n) => {
    ...
    async function q(t = {}) {
      ...
      if (
        ...
        let { initScriptLoader: t } = e.r(89453);
        t(a.scriptLoader);
      }
          ...
          .then(({ page: r, styleSheets: a }) =>
            s?.Component === r
              ? e
                  .A(17894)
                  .then((r) =>
                    e.A(77244).then((e) => ((t.App = n = e.default), r))
                  )
  ...
  (e, t, n) => {
    'use strict';
    (Object.defineProperty(n, '__esModule', { value: !0 }), e.r(43796));
    let r = e.r(55163),
      a = e.r(50463);
    ((window.next = {
      version: r.version,
