(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    let i = ({ name: e = '', code: i = '' }) => {
      ...
      return (
        (0, a.useEffect)(() => {
          n((0, l.default)(window).sanitize(i));
        }, [i]),
        (0, s.jsx)('button', {
          type: 'button',
          title: e,
    ...
    var r = e.i(60373),
      n = e.i(10583);
    let c = (0, e.i(50148).fileURLToPath)(
      {
        get url() {
    ...
    (console.log((0, n.join)((0, n.dirname)(c), '../../../..')),
      e.s(
        [
          '__N_SSG',
          () => !0,
  ...
  (e) => {
    e.v((s) =>
      Promise.all(
        ['static/chunks/aa43610abbf6342c.js'].map((s) => e.l(s))
      ).then(() => s(64356))
    );
  },
  49246,
  (e) => {
    e.v((s) =>
      Promise.all(
        ['static/chunks/28124e50d99e8857.js'].map((s) => e.l(s))
      ).then(() => s(31422))
    );
  },
]);
