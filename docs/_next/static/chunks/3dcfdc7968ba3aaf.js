(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, n) => {
    ...
    ((a.ab =
      '/ROOT/node_modules/.pnpm/next@16.0.7_@babel+core@7.28.5_react-dom@19.2.1_react@19.2.1__react@19.2.1/node_modules/next/dist/compiled/buffer/'),
      (t.exports = a(72)));
  },
  98726,
  (e) => {
      ...
      if (
        ...
        let r,
          a =
            ...
            (r = '&#' + String(e)),
            i && t && !e8.test(String.fromCharCode(t)) ? r : r + ';');
    ...
    function t8(e, t, n = {}) {
      ...
      let l,
        u,
        { theme: c = e.getLoadedThemes()[0] } = n,
        p = e.resolveLangAlias(n.lang || 'text');
      if (tG(p) || t$(c))
        return tH(t).map((e) => [{ content: e[0], offset: e[1] }]);
      let { theme: d, colorMap: m } = e.setTheme(c);
      if ('ansi' === p) {
        let e, r, i, a, o, s, l;
        return (
          (e = tM(d, n)),
          ...
          r.map((t) =>
            l.parse(t[0]).map((n) => {
              ...
              (n.decorations.has('reverse')
                ? ((r = n.background ? i.value(n.background) : d.bg),
                  (a = n.foreground ? i.value(n.foreground) : d.fg))
                : ((r = n.foreground ? i.value(n.foreground) : d.fg),
      ...
      let f = e.getLanguage(n.lang || 'text');
      if (n.grammarState) {
        if (n.grammarState.lang !== f.name)
          throw new h(
            `Grammar state language "${n.grammarState.lang}" does not match highlight language "${f.name}"`
          );
        if (!n.grammarState.themes.includes(d.name))
          throw new h(
            `Grammar state themes "${n.grammarState.themes}" do not contain highlight theme "${d.name}"`
          );
      }
      return (
        (l = t3((r = t), (i = f), (a = d), (o = m), (s = n))),
        (u = new tJ(t3(r, i, a, o, s).stateStack, i.name, a.name)),
        tX(l.tokens, u),
        l.tokens
      );
    }
    ...
    let nm = [
        { id: 'abap', name: 'ABAP', import: () => e.A(53799) },
        {
          id: 'actionscript-3',
          name: 'ActionScript',
          import: () => e.A(21483),
        },
        { id: 'ada', name: 'Ada', import: () => e.A(19965) },
        { id: 'angular-html', name: 'Angular HTML', import: () => e.A(25587) },
        {
          id: 'angular-ts',
          name: 'Angular TypeScript',
          import: () => e.A(66065),
        },
        { id: 'apache', name: 'Apache Conf', import: () => e.A(63281) },
        { id: 'apex', name: 'Apex', import: () => e.A(50926) },
        { id: 'apl', name: 'APL', import: () => e.A(9722) },
        { id: 'applescript', name: 'AppleScript', import: () => e.A(63757) },
        { id: 'ara', name: 'Ara', import: () => e.A(76085) },
        {
          id: 'asciidoc',
          name: 'AsciiDoc',
          aliases: ['adoc'],
        ...
        { id: 'asm', name: 'Assembly', import: () => e.A(65618) },
        { id: 'astro', name: 'Astro', import: () => e.A(86751) },
        { id: 'awk', name: 'AWK', import: () => e.A(90606) },
        { id: 'ballerina', name: 'Ballerina', import: () => e.A(41274) },
        {
          id: 'bat',
          name: 'Batch File',
          aliases: ['batch'],
        ...
        { id: 'beancount', name: 'Beancount', import: () => e.A(55188) },
        {
          id: 'berry',
          name: 'Berry',
          aliases: ['be'],
        ...
        { id: 'bibtex', name: 'BibTeX', import: () => e.A(19081) },
        { id: 'bicep', name: 'Bicep', import: () => e.A(12803) },
        { id: 'blade', name: 'Blade', import: () => e.A(63378) },
        {
          id: 'bsl',
          name: '1C (Enterprise)',
          aliases: ['1c'],
        ...
        { id: 'cairo', name: 'Cairo', import: () => e.A(17871) },
        { id: 'clarity', name: 'Clarity', import: () => e.A(41588) },
        {
          id: 'clojure',
          name: 'Clojure',
          aliases: ['clj'],
        ...
        { id: 'cmake', name: 'CMake', import: () => e.A(35733) },
        { id: 'cobol', name: 'COBOL', import: () => e.A(22067) },
        { id: 'codeowners', name: 'CODEOWNERS', import: () => e.A(66758) },
        {
          id: 'codeql',
          name: 'CodeQL',
          aliases: ['ql'],
        ...
        { id: 'coq', name: 'Coq', import: () => e.A(14142) },
        { id: 'cpp', name: 'C++', aliases: ['c++'], import: () => e.A(6288) },
        { id: 'crystal', name: 'Crystal', import: () => e.A(53846) },
        {
          id: 'csharp',
          name: 'C#',
          aliases: ['c#', 'cs'],
        ...
        { id: 'css', name: 'CSS', import: () => e.A(91639) },
        { id: 'csv', name: 'CSV', import: () => e.A(85659) },
        { id: 'cue', name: 'CUE', import: () => e.A(80193) },
        {
          id: 'cypher',
          name: 'Cypher',
          aliases: ['cql'],
        ...
        { id: 'd', name: 'D', import: () => e.A(61289) },
        { id: 'dart', name: 'Dart', import: () => e.A(99486) },
        { id: 'dax', name: 'DAX', import: () => e.A(58571) },
        { id: 'desktop', name: 'Desktop', import: () => e.A(94033) },
        { id: 'diff', name: 'Diff', import: () => e.A(44203) },
        {
          id: 'docker',
          name: 'Dockerfile',
          aliases: ['dockerfile'],
        ...
        { id: 'dotenv', name: 'dotEnv', import: () => e.A(95166) },
        { id: 'dream-maker', name: 'Dream Maker', import: () => e.A(52341) },
        { id: 'edge', name: 'Edge', import: () => e.A(4773) },
        { id: 'elixir', name: 'Elixir', import: () => e.A(12997) },
        { id: 'elm', name: 'Elm', import: () => e.A(22284) },
        {
          id: 'emacs-lisp',
          name: 'Emacs Lisp',
          aliases: ['elisp'],
        ...
        { id: 'erb', name: 'ERB', import: () => e.A(3390) },
        {
          id: 'erlang',
          name: 'Erlang',
          aliases: ['erl'],
        ...
        { id: 'fennel', name: 'Fennel', import: () => e.A(18525) },
        { id: 'fish', name: 'Fish', import: () => e.A(34432) },
        {
          id: 'fluent',
          name: 'Fluent',
          aliases: ['ftl'],
        ...
        { id: 'gdresource', name: 'GDResource', import: () => e.A(19547) },
        { id: 'gdscript', name: 'GDScript', import: () => e.A(74339) },
        { id: 'gdshader', name: 'GDShader', import: () => e.A(56061) },
        { id: 'genie', name: 'Genie', import: () => e.A(12875) },
        { id: 'gherkin', name: 'Gherkin', import: () => e.A(66245) },
        {
          id: 'git-commit',
        ...
        { id: 'gleam', name: 'Gleam', import: () => e.A(61240) },
        {
          id: 'glimmer-js',
          name: 'Glimmer JS',
          aliases: ['gjs'],
        ...
        { id: 'glsl', name: 'GLSL', import: () => e.A(53878) },
        { id: 'gnuplot', name: 'Gnuplot', import: () => e.A(17622) },
        { id: 'go', name: 'Go', import: () => e.A(90334) },
        {
          id: 'graphql',
          name: 'GraphQL',
          aliases: ['gql'],
        ...
        { id: 'groovy', name: 'Groovy', import: () => e.A(10641) },
        { id: 'hack', name: 'Hack', import: () => e.A(56193) },
        { id: 'haml', name: 'Ruby Haml', import: () => e.A(18849) },
        {
          id: 'handlebars',
          name: 'Handlebars',
          aliases: ['hbs'],
        ...
        { id: 'haxe', name: 'Haxe', import: () => e.A(88693) },
        { id: 'hcl', name: 'HashiCorp HCL', import: () => e.A(6705) },
        { id: 'hjson', name: 'Hjson', import: () => e.A(45416) },
        { id: 'hlsl', name: 'HLSL', import: () => e.A(29689) },
        { id: 'html', name: 'HTML', import: () => e.A(36762) },
        {
          id: 'html-derivative',
          name: 'HTML (Derivative)',
          import: () => e.A(49729),
        },
        { id: 'http', name: 'HTTP', import: () => e.A(18908) },
        { id: 'hurl', name: 'Hurl', import: () => e.A(41475) },
        { id: 'hxml', name: 'HXML', import: () => e.A(72382) },
        { id: 'hy', name: 'Hy', import: () => e.A(35370) },
        { id: 'imba', name: 'Imba', import: () => e.A(26872) },
        {
          id: 'ini',
          name: 'INI',
          aliases: ['properties'],
        ...
        { id: 'java', name: 'Java', import: () => e.A(76921) },
        {
          id: 'javascript',
          name: 'JavaScript',
          aliases: ['js', 'cjs', 'mjs'],
        ...
        { id: 'jinja', name: 'Jinja', import: () => e.A(67404) },
        { id: 'jison', name: 'Jison', import: () => e.A(10449) },
        { id: 'json', name: 'JSON', import: () => e.A(92493) },
        { id: 'json5', name: 'JSON5', import: () => e.A(71360) },
        { id: 'jsonc', name: 'JSON with Comments', import: () => e.A(92007) },
        { id: 'jsonl', name: 'JSON Lines', import: () => e.A(62941) },
        { id: 'jsonnet', name: 'Jsonnet', import: () => e.A(45092) },
        {
          id: 'jssm',
          name: 'JSSM',
          aliases: ['fsl'],
        ...
        { id: 'jsx', name: 'JSX', import: () => e.A(42470) },
        {
          id: 'julia',
          name: 'Julia',
          aliases: ['jl'],
        ...
        { id: 'kdl', name: 'KDL', import: () => e.A(62560) },
        {
          id: 'kotlin',
          name: 'Kotlin',
          aliases: ['kt', 'kts'],
        ...
        { id: 'latex', name: 'LaTeX', import: () => e.A(72081) },
        {
          id: 'lean',
          name: 'Lean 4',
          aliases: ['lean4'],
        ...
        { id: 'less', name: 'Less', import: () => e.A(62200) },
        { id: 'liquid', name: 'Liquid', import: () => e.A(76405) },
        { id: 'llvm', name: 'LLVM IR', import: () => e.A(8402) },
        { id: 'log', name: 'Log file', import: () => e.A(85836) },
        { id: 'logo', name: 'Logo', import: () => e.A(60389) },
        { id: 'lua', name: 'Lua', import: () => e.A(61426) },
        { id: 'luau', name: 'Luau', import: () => e.A(64032) },
        {
          id: 'make',
          name: 'Makefile',
          aliases: ['makefile'],
        ...
        { id: 'marko', name: 'Marko', import: () => e.A(10257) },
        { id: 'matlab', name: 'MATLAB', import: () => e.A(44379) },
        { id: 'mdc', name: 'MDC', import: () => e.A(8652) },
        { id: 'mdx', name: 'MDX', import: () => e.A(2092) },
        {
          id: 'mermaid',
          name: 'Mermaid',
          aliases: ['mmd'],
        ...
        { id: 'mojo', name: 'Mojo', import: () => e.A(32828) },
        { id: 'move', name: 'Move', import: () => e.A(55011) },
        {
          id: 'narrat',
        ...
        { id: 'nginx', name: 'Nginx', import: () => e.A(8285) },
        { id: 'nim', name: 'Nim', import: () => e.A(886) },
        { id: 'nix', name: 'Nix', import: () => e.A(65673) },
        {
          id: 'nushell',
          name: 'nushell',
          aliases: ['nu'],
        ...
        { id: 'ocaml', name: 'OCaml', import: () => e.A(83825) },
        {
          id: 'openscad',
          name: 'OpenSCAD',
          aliases: ['scad'],
        ...
        { id: 'pascal', name: 'Pascal', import: () => e.A(99527) },
        { id: 'perl', name: 'Perl', import: () => e.A(55827) },
        { id: 'php', name: 'PHP', import: () => e.A(11576) },
        { id: 'pkl', name: 'Pkl', import: () => e.A(6591) },
        { id: 'plsql', name: 'PL/SQL', import: () => e.A(14754) },
        {
          id: 'po',
          name: 'Gettext PO',
          aliases: ['pot', 'potx'],
        ...
        { id: 'polar', name: 'Polar', import: () => e.A(555) },
        { id: 'postcss', name: 'PostCSS', import: () => e.A(30095) },
        { id: 'powerquery', name: 'PowerQuery', import: () => e.A(94875) },
        {
          id: 'powershell',
          name: 'PowerShell',
          aliases: ['ps', 'ps1'],
        ...
        { id: 'prisma', name: 'Prisma', import: () => e.A(7758) },
        { id: 'prolog', name: 'Prolog', import: () => e.A(37322) },
        {
          id: 'proto',
        ...
        { id: 'pug', name: 'Pug', aliases: ['jade'], import: () => e.A(14479) },
        { id: 'puppet', name: 'Puppet', import: () => e.A(68018) },
        { id: 'purescript', name: 'PureScript', import: () => e.A(78906) },
        {
          id: 'python',
          name: 'Python',
          aliases: ['py'],
        ...
        { id: 'qml', name: 'QML', import: () => e.A(95529) },
        { id: 'qmldir', name: 'QML Directory', import: () => e.A(88310) },
        { id: 'qss', name: 'Qt Style Sheets', import: () => e.A(23106) },
        { id: 'r', name: 'R', import: () => e.A(85140) },
        { id: 'racket', name: 'Racket', import: () => e.A(29582) },
        {
          id: 'raku',
          name: 'Raku',
          aliases: ['perl6'],
        ...
        { id: 'razor', name: 'ASP.NET Razor', import: () => e.A(50944) },
        {
          id: 'reg',
        ...
        { id: 'rel', name: 'Rel', import: () => e.A(90582) },
        { id: 'riscv', name: 'RISC-V', import: () => e.A(61300) },
        { id: 'rosmsg', name: 'ROS Interface', import: () => e.A(15455) },
        { id: 'rst', name: 'reStructuredText', import: () => e.A(50051) },
        { id: 'ruby', name: 'Ruby', aliases: ['rb'], import: () => e.A(96495) },
        { id: 'rust', name: 'Rust', aliases: ['rs'], import: () => e.A(62183) },
        { id: 'sas', name: 'SAS', import: () => e.A(3261) },
        { id: 'sass', name: 'Sass', import: () => e.A(53368) },
        { id: 'scala', name: 'Scala', import: () => e.A(43295) },
        { id: 'scheme', name: 'Scheme', import: () => e.A(57803) },
        { id: 'scss', name: 'SCSS', import: () => e.A(16909) },
        {
          id: 'sdbl',
          name: '1C (Query)',
          aliases: ['1c-query'],
        ...
        { id: 'smalltalk', name: 'Smalltalk', import: () => e.A(26873) },
        { id: 'solidity', name: 'Solidity', import: () => e.A(97848) },
        {
          id: 'soy',
        ...
        { id: 'sparql', name: 'SPARQL', import: () => e.A(71089) },
        {
          id: 'splunk',
        ...
        { id: 'sql', name: 'SQL', import: () => e.A(4908) },
        { id: 'ssh-config', name: 'SSH Config', import: () => e.A(17986) },
        { id: 'stata', name: 'Stata', import: () => e.A(55555) },
        {
          id: 'stylus',
          name: 'Stylus',
          aliases: ['styl'],
        ...
        { id: 'svelte', name: 'Svelte', import: () => e.A(8116) },
        { id: 'swift', name: 'Swift', import: () => e.A(63135) },
        {
          id: 'system-verilog',
          name: 'SystemVerilog',
          import: () => e.A(44674),
        },
        { id: 'systemd', name: 'Systemd Units', import: () => e.A(77915) },
        {
          id: 'talonscript',
          name: 'TalonScript',
          aliases: ['talon'],
        ...
        { id: 'tasl', name: 'Tasl', import: () => e.A(78721) },
        { id: 'tcl', name: 'Tcl', import: () => e.A(95809) },
        { id: 'templ', name: 'Templ', import: () => e.A(79691) },
        {
          id: 'terraform',
          name: 'Terraform',
          aliases: ['tf', 'tfvars'],
        ...
        { id: 'tex', name: 'TeX', import: () => e.A(58093) },
        { id: 'toml', name: 'TOML', import: () => e.A(44209) },
        {
          id: 'ts-tags',
        ...
        { id: 'tsv', name: 'TSV', import: () => e.A(67169) },
        { id: 'tsx', name: 'TSX', import: () => e.A(56670) },
        { id: 'turtle', name: 'Turtle', import: () => e.A(70802) },
        { id: 'twig', name: 'Twig', import: () => e.A(23085) },
        {
          id: 'typescript',
          name: 'TypeScript',
          aliases: ['ts', 'cts', 'mts'],
        ...
        { id: 'v', name: 'V', import: () => e.A(45436) },
        { id: 'vala', name: 'Vala', import: () => e.A(25643) },
        {
          id: 'vb',
          name: 'Visual Basic',
          aliases: ['cmd'],
        ...
        { id: 'verilog', name: 'Verilog', import: () => e.A(82389) },
        { id: 'vhdl', name: 'VHDL', import: () => e.A(28289) },
        {
          id: 'viml',
          name: 'Vim Script',
        ...
        { id: 'vue', name: 'Vue', import: () => e.A(81963) },
        { id: 'vue-html', name: 'Vue HTML', import: () => e.A(96534) },
        { id: 'vue-vine', name: 'Vue Vine', import: () => e.A(92376) },
        {
          id: 'vyper',
          name: 'Vyper',
          aliases: ['vy'],
        ...
        { id: 'wasm', name: 'WebAssembly', import: () => e.A(98199) },
        {
          id: 'wenyan',
          name: 'Wenyan',
          aliases: ['文言'],
        ...
        { id: 'wgsl', name: 'WGSL', import: () => e.A(48010) },
        {
          id: 'wikitext',
          name: 'Wikitext',
        ...
        { id: 'xml', name: 'XML', import: () => e.A(88264) },
        { id: 'xsl', name: 'XSL', import: () => e.A(94749) },
        {
          id: 'yaml',
          name: 'YAML',
          aliases: ['yml'],
        ...
        { id: 'zenscript', name: 'ZenScript', import: () => e.A(66553) },
        { id: 'zig', name: 'Zig', import: () => e.A(40553) },
      ],
    ...
    let { codeToHtml: nR } = (function (e, t) {
      ...
      ((r = (l = { langs: ny, themes: nb, engine: () => nE(e.A(28941)) })
        .langs),
      (i = l.themes),
      (a = l.engine),
      async function (e) {
