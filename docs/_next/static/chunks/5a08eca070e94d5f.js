(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
        ...
        !(function e(t, r, n, i, a) {
          ...
          if (w(t))
            ...
            for (t = m.call(t), m = 0; !(i = t.next()).done; )
              ((f = p + M((i = i.value), m++)), (d += e(i, r, n, f, a)));
          else if ('object' === f) {
    ...
    let j = a.default.forwardRef(function (e, t) {
        ...
        let R = a.default.useContext(p.RouterContext),
          ...
          { href: $, as: I } = a.default.useMemo(() => {
            ...
            return { href: e, as: u ? (0, l.resolveHref)(R, u) : t || e };
          }, [R, o, u]),
          L = a.default.useRef($),
        ...
        let A = C ? n && 'object' == typeof n && n.ref : t,
          ...
          B = a.default.useCallback(
            (e) => {
              ((H.current !== I || L.current !== $) &&
                (F(), (H.current = I), (L.current = $)),
                D(e));
            },
            [I, $, F, D]
          ),
        ...
        if ((0, f.isAbsoluteUrl)(I)) q.href = I;
          ...
          let e = void 0 !== k ? k : R?.locale;
          q.href =
            (R?.isLocaleDomain &&
              (0, m.getDomainLocale)(I, e, R?.locales, R?.domainLocales)) ||
            (0, h.addBasePath)((0, d.addLocale)(I, e, R?.defaultLocale));
        }
        return C
          ? a.default.cloneElement(n, q)
          : (0, i.jsx)('a', { ...M, ...q, children: r });
      }),
  ...
  (e) => {
    ...
    e.s([
      'ErrorTemplate',
      0,
      ({ code: e = '', title: u = '', message: i = '', action: a = '' }) => {
        let { darkMode: l } = (0, n.useDarkMode)();
        return (
          console.info('darkMode', l),
          (0, t.jsxs)(t.Fragment, {
            children: [
              (0, t.jsx)(r.RadialGradientBackground, {}),
              (0, t.jsx)('div', {
                className:
  ...
  (e, t, r) => {
    let n = '/500';
    ((window.__NEXT_P = window.__NEXT_P || []).push([n, () => e.r(91693)]),
      t.hot &&
  ...
  (e) => {
    e.v((t) =>
      Promise.all(
        ['static/chunks/0f6f87598d05c580.js'].map((t) => e.l(t))
      ).then(() => t(64356))
    );
  },
  49246,
