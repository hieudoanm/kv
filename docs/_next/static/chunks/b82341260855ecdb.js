(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, n) => {
    ...
    var cj = o.version;
    if ('19.2.1' !== cj) throw Error(u(527, cj, '19.2.1'));
    if (
...
${e.stack}`
  ...
  (e, t, n) => {
    ...
    async function q(t = {}) {
      ...
      if (
        ...
        let { initScriptLoader: t } = e.r(37672);
        t(a.scriptLoader);
      }
          ...
          .then(({ page: r, styleSheets: a }) =>
            s?.Component === r
              ? e
                  .A(85086)
                  .then((r) =>
                    e.A(28500).then((e) => ((t.App = n = e.default), r))
                  )
  ...
  (e, t, n) => {
    'use strict';
    (Object.defineProperty(n, '__esModule', { value: !0 }), e.r(80259));
    let r = e.r(77276),
      a = e.r(1757);
    ((window.next = {
      version: r.version,
