(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, n) => {
    ...
    function tR() {
      ...
      return (tO = a.slice(e, 1 < t ? 1 - t : void 0));
    }
    function tN(e) {
      var t = e.keyCode;
      return (
    ...
    var t2 = tM(
      ...
      t5 = tM(h({}, tU, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 })),
      t8 = tM(
        h({}, tW, {
          deltaX: function (e) {
            return 'deltaX' in e
    ...
    function rN(e) {
      ...
      switch (((t[eM] = e), (t[eI] = r), n)) {
        ...
        case 'video':
        case 'audio':
          for (n = 0; n < u2.length; n++) u5(u2[n], t);
          break;
        case 'source':
          u5('error', t);
          break;
        ...
        case 'select':
          ...
          break;
        case 'textarea':
          (u5('invalid', t), to(t, r.value, r.defaultValue, r.children));
      }
      ...
      su(t.textContent, n)
        ? (null != r.popover && (u5('beforetoggle', t), u5('toggle', t)),
          null != r.onScroll && u5('scroll', t),
          null != r.onScrollEnd && u5('scrollend', t),
    ...
    function lc(e, t, n) {
      ...
      if (((l = e.baseState), null === a)) e.memoizedState = l;
        ...
        if (
          (null === s ? (o = l) : (s.next = i),
          !nk(l, e.memoizedState) && ((ob = !0), f && null !== (n = r5)))
        )
          throw n;
        ((e.memoizedState = l),
          (e.baseState = o),
        ...
        if (null !== n) {
          e: {
            ...
            if (rx) {
              if (rP) {
                t: {
                  for (var a = rP, l = rC; 8 !== a.nodeType; )
    ...
    function lG(e, t, n, r, a) {
      ...
      try {
        ...
        l5(e, t, { then: function () {}, status: 'rejected', reason: n }, ua());
      } finally {
        ((I.p = l),
    ...
    function o_(e, t, n, r, a) {
      ...
      return (rV(t), (r = a5(e, t, n, o, l, a)), (i = a7()), null === e || ob)
      ...
      if (
        ...
        if (rx) {
          if (
            ...
            (e = rP)
              ? null !==
                  (e = null !== (e = sO(e, rC)) && '&' !== e.data ? e : null) &&
                ((t.memoizedState = {
                  dehydrated: e,
      ...
      switch (((t.lanes = 0), t.tag)) {
        ...
        case 3:
          e: {
            ...
            ((a = l.element), aw(e, t), aO(t, r, null, n));
        ...
        case 5:
          return (
            ...
            null !== t.memoizedState &&
              (s7._currentValue = a = a5(e, t, a9, null, null, n)),
            oC(e, t),
            ov(e, t, r, n),
            t.child
          );
          ...
          return (
            ...
            null === e
              ? (null === (a = r7()) &&
                ...
                aS(t),
                rU(t, rZ, a))
              : (0 != (e.lanes & n) && (aw(e, t), aO(t, null, null, n), aC()),
                (a = e.memoizedState),
                (l = t.memoizedState),
                a.parent !== r
                  ? ((a = { parent: r, cache: r }),
    ...
    function ii(e, t, n) {
      ...
      switch (n.tag) {
        ...
        case 26:
        case 5:
          (i_(e, n), null === t && 4 & r && o5(n), 512 & r && o3(n, n.return));
          break;
        case 12:
        default:
          i_(e, n);
                  ...
                  if (null === n.instance) {
                    ...
                    if (l) {
                      (null !== (t = l._p) &&
                        'object' == typeof t &&
                        'function' == typeof t.then &&
                        (e.count++, (e = s5.bind(e)), t.then(e, e)),
                        (n.state.loading |= 4),
                        (n.instance = l),
                        eQ(l));
                      return;
              ...
              return (
                null !== (t = aD.current)
                  ? (0 == (65536 & t.flags) && (t.flags |= 256),
                    (t.flags |= 65536),
                    (t.lanes = a),
                    r !== rO && rj(rs((e = Error(u(422), { cause: r })), n)))
                  : (r !== rO && rj(rs((t = Error(u(423), { cause: r })), n)),
    ...
    function uk(e, t, n, r, a, l, o, i, s) {
      ...
      if (null !== t) {
        ...
        if (
          ...
          try {
            !(function (e, t) {
              if (((e = e.containerInfo), (sp = ci), nO((e = nC(e))))) {
    ...
    function uT() {
      if (4 === i5 || 3 === i5) {
        ...
        0 != (10256 & t.subtreeFlags) || 0 != (10256 & t.flags)
          ? (i5 = 5)
          : ((i5 = 0), (i6 = i8 = null), uC(e, e.pendingLanes));
    ...
    function uR() {
      ...
      try {
        ...
        var l = i8,
          o = i9;
        if (((i5 = 0), (i6 = i8 = null), (i9 = 0), 0 != (6 & iI)))
          throw Error(u(331));
        var i = iI;
        if (
          ((iI |= 4),
    ...
    function ss(e, t, n, r, a, l) {
      switch (n) {
        ...
        case 'start':
          ...
          break;
        case 'popover':
          (u5('beforetoggle', e), u5('toggle', e), e1(e, 'popover', r));
          break;
        case 'xlinkActuate':
    ...
    function sf(e, t, n) {
      switch (t) {
        ...
        case 'input':
          ...
          return;
        case 'select':
          for (l in (u5('invalid', e), (a = o = r = null), n))
          ...
          return;
        case 'textarea':
          for (o in (u5('invalid', e), (r = l = a = null), n))
        ...
        case 'video':
        case 'audio':
          for (a = 0; a < u2.length; a++) u5(u2[a], e);
          break;
        case 'image':
          (u5('error', e), u5('load', e));
          break;
  ...
  (e, t, n) => {
    ...
    class X {
      ...
      async change(e, t, n, r, a) {
        ...
        let { shallow: O = !1, scroll: L = !0 } = r,
          I = { shallow: O };
        (this._inFlightRoute &&
          this.clc &&
          (T || X.events.emit('routeChangeError', D(), this._inFlightRoute, I),
          this.clc(),
          (this.clc = null)),
          (n = (0, k.addBasePath)(
            (0, S.addLocale)(
        ...
        let F = C !== p.locale;
        if (!f && this.onlyAHashChange(j) && !F) {
          ((p.asPath = j),
            X.events.emit('hashChangeStart', n, I),
          ...
          try {
            ...
            throw (
              (0, c.default)(e) &&
                e.cancelled &&
                X.events.emit('routeChangeError', e, j, I),
              e
            );
          }
          return (X.events.emit('hashChangeComplete', n, I), !0);
        }
        let H = (0, g.parseRelativeUrl)(t),
          { pathname: W, query: q } = H;
        try {
        ...
        this.urlIsNew(j) || F || (e = 'replaceState');
        let V = n;
        ...
        if (
          ...
          d &&
            ...
            H.pathname !== W &&
              ((W = H.pathname),
              (H.pathname = (0, k.addBasePath)(W)),
              J || (t = (0, v.formatWithValidation)(H)))),
          !(0, N.isLocalURL)(n))
        )
          return (Q({ url: n, router: this }), !1);
        ...
        f || X.events.emit('routeChangeStart', n, I);
        ...
        try {
          ...
          if (
            ...
            let e = (0, P.hasBasePath)(H.pathname)
              ? (0, E.removeBasePath)(H.pathname)
              : H.pathname;
            if (
              (Z &&
                W !== e &&
          ...
          if (
            ...
            if (
              ((p.isPreview = !!o.props.__N_PREVIEW), o.props.notFound === $)
            ) {
              let e;
              try {
          ...
          if (
            (X.events.emit('beforeHistoryChange', n, I),
            ...
            if (o.error)
              throw (
                f || X.events.emit('routeChangeError', o.error, j, I),
                o.error
              );
            (f || X.events.emit('routeChangeComplete', n, I),
...
${e.stack}`
  ...
  (e, t, n) => {
      ...
      componentDidMount() {
        (this.scrollToHash(),
          r.isSsr &&
            (a.isFallback ||
              (a.nextExport &&
                ((0, P.isDynamicRoute)(r.pathname) || location.search || $)) ||
    ...
    async function q(t = {}) {
      ...
      if (
        ...
        let { initScriptLoader: t } = e.r(52597);
        t(a.scriptLoader);
      }
          ...
          .then(({ page: r, styleSheets: a }) =>
            s?.Component === r
              ? e
                  .A(24713)
                  .then((r) =>
                    e.A(49246).then((e) => ((t.App = n = e.default), r))
                  )
  ...
  (e, t, n) => {
    'use strict';
    (Object.defineProperty(n, '__esModule', { value: !0 }), e.r(31403));
    let r = e.r(34960),
      a = e.r(56745);
    ((window.next = {
      version: r.version,
