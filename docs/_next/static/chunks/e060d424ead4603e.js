(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    var a = e.i(68601),
      ...
      s = e.i(53791);
    let t = ({ code: e = '' }) => {
      let [t, i] = (0, l.useState)('');
      return (
        (0, l.useEffect)(() => {
          i((0, s.default)(window).sanitize(e));
        }, [e]),
    ...
    var i = e.i(60373),
      d = e.i(3690),
      r = e.i(10583);
    let n = (0, e.i(50148).fileURLToPath)(
      {
        get url() {
  ...
  (e) => {
    e.v((a) =>
      Promise.all(
        ['static/chunks/aa43610abbf6342c.js'].map((a) => e.l(a))
      ).then(() => a(64356))
    );
  },
  49246,
  (e) => {
    e.v((a) =>
      Promise.all(
        ['static/chunks/28124e50d99e8857.js'].map((a) => e.l(a))
      ).then(() => a(31422))
    );
  },
]);
