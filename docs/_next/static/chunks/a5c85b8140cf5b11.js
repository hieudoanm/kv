(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    e.s([
      ...
      ({
        ...
        let [u, p] = (0, a.useState)(''),
          [x, h] = (0, a.useState)(!0);
        return (
          (0, a.useEffect)(() => {
            p((0, i.default)(window).sanitize(n));
          }, [n]),
          (0, s.jsxs)('div', {
            id: e,
            ...
            children: [
              ...
              (0, s.jsx)('div', {
                ...
                children: c
                  ? (0, s.jsx)(r.Shiki, { code: n, lang: 'tsx' })
                  : (0, s.jsx)(s.Fragment, {
                      children: x
                        ? (0, s.jsx)('div', {
                        ...
                        : (0, s.jsx)(r.Shiki, { code: n, lang: 'html' }),
                    }),
              }),
            ],
          })
  ...
  (e) => {
    ...
    let o = (0, t.fileURLToPath)(
      {
        get url() {
          return `file://${e.P('src/pages/tools/utils/index.tsx')}`;
        },
      }.url
    );
    (console.log((0, r.join)((0, r.dirname)(o), '../../../..')),
      e.s([
        '__N_SSG',
        () => !0,
        'default',
        0,
        ({ utils: e = [] }) => {
          let [{ query: r = '' }, t] = (0, d.useState)({ query: '' }),
            o = e.filter(
              ({ id: e, name: s }) =>
  ...
  (e, s, l) => {
    let i = '/tools/utils';
    ((window.__NEXT_P = window.__NEXT_P || []).push([i, () => e.r(67788)]),
      s.hot &&
