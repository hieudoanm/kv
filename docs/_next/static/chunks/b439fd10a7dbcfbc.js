(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, n) => {
    var r = {
        ...
        72: function (e, t, n) {
          ...
          function b(e, t, n) {
            ...
            for (var m = '', f = 0; f < d; )
              m += String.fromCharCode.apply(String, p.slice(f, (f += 4096)));
            return m;
          }
          function A(e, t, n) {
          ...
          ((s.prototype.write = function (e, t, n, r) {
              ...
              switch (r) {
                ...
                case 'utf-8':
                  return (
                    (i = t),
                    (a = n),
                    L(C(e, this.length - i), this, i, a)
                  );
                case 'ascii':
                  return ((o = t), (s = n), L(N(e), this, o, s));
                case 'latin1':
                case 'binary':
                  return (function (e, t, n, r) {
                    return L(N(t), e, n, r);
            ...
            (s.prototype.writeInt32LE = function (e, t, n) {
              return (
                (e *= 1),
                (t >>>= 0),
                n || _(this, e, t, 4, 0x7fffffff, -0x80000000),
                (this[t] = 255 & e),
                (this[t + 1] = e >>> 8),
                (this[t + 2] = e >>> 16),
                (this[t + 3] = e >>> 24),
          ...
          function x(e) {
            return r.toByteArray(
              (function (e) {
                if (
                  (e = (e = e.split('=')[0]).trim().replace(S, '')).length < 2
                )
                  return '';
                for (; e.length % 4 != 0; ) e += '=';
                return e;
              ...
              for (
                isNaN((t = Math.abs(t))) || t === 1 / 0
                  ...
                  : ((o = Math.floor(Math.log(t) / Math.LN2)),
                    ...
                    o + h >= 1 ? (t += p / l) : (t += p * Math.pow(2, 1 - h)),
                    t * l >= 2 && (o++, (l /= 2)),
                    o + h >= c
                      ? ((s = 0), (o = c))
                      : o + h >= 1
                        ? ((s = (t * l - 1) * Math.pow(2, i)), (o += h))
    ...
    ((a.ab =
      '/ROOT/node_modules/.pnpm/next@16.1.1_@babel+core@7.28.5_react-dom@19.2.3_react@19.2.3__react@19.2.3/node_modules/next/dist/compiled/buffer/'),
      (t.exports = a(72)));
  },
  98726,
  (e) => {
    ...
    var m = /\$(\d+)|\${(\d+):\/(downcase|upcase)}/g,
      f = class {
        static hasCaptures(e) {
          return null !== e && ((m.lastIndex = 0), m.test(e));
        }
        static replaceCaptures(e, t, n) {
          return e.replace(m, (e, r, i, a) => {
    ...
    var A = class {
      ...
      _ = class {
          ...
          return this.createFromParsedTheme(
            (function (e) {
              ...
              for (let e = 0, i = t.length; e < i; e++) {
                ...
                let s = null;
                'string' == typeof a.settings.foreground &&
                  y(a.settings.foreground) &&
                  (s = a.settings.foreground);
                let l = null;
                'string' == typeof a.settings.background &&
                  y(a.settings.background) &&
                  (l = a.settings.background);
                for (let t = 0, a = i.length; t < a; t++) {
                  let a = i[t].trim().split(' '),
                    u = a[a.length - 1],
                    c = null;
                  (a.length > 1 && (c = a.slice(0, a.length - 1)).reverse(),
                    (n[r++] = new w(u, c, e, o, s, l)));
                }
              }
              return n;
            })(e),
        ...
        static createFromParsedTheme(e, t) {
          return (function (e, t) {
            e.sort((e, t) => {
              ...
              return 0 !== i || 0 !== (i = g(e.parentScopes, t.parentScopes))
                ? i
                : e.index - t.index;
            });
            let n = 0,
            ...
            let a = new C(t),
              o = new k(n, a.getId(r), a.getId(i)),
              s = new L(new x(0, null, -1, 0, 0), []);
            for (let t = 0, n = e.length; t < n; t++) {
              let n = e[t];
              s.insert(
                0,
        ...
        _cachedMatchRoot = new A((e) => this._root.match(e));
        getColorMap() {
        ...
        match(e) {
          ...
          return n ? new k(n.fontStyle, n.foreground, n.background) : null;
        }
      },
      v = class e {
        constructor(e, t) {
      ...
      S =
        (((o = S || {})[(o.NotSet = -1)] = 'NotSet'),
        (o[(o.None = 0)] = 'None'),
        (o[(o.Italic = 1)] = 'Italic'),
        (o[(o.Bold = 2)] = 'Bold'),
        (o[(o.Underline = 4)] = 'Underline'),
        (o[(o.Strikethrough = 8)] = 'Strikethrough'),
        o),
      C = class {
        _isFrozen;
        _lastColorId;
      ...
      L = class e {
          ...
          (-1 === c
            ...
            this._children.hasOwnProperty(s)
              ...
              : ((u = new e(
                  ...
                  x.cloneArr(this._rulesWithParentScopes)
                )),
                (this._children[s] = u)),
        ...
        _doInsertHere(e, t, n, r, i) {
          ...
          for (let a = 0, o = this._rulesWithParentScopes.length; a < o; a++) {
            ...
            if (0 === g(o.parentScopes, t))
              return void o.acceptOverwrite(e, n, r, i);
          }
          (-1 === n && (n = this._mainRule.fontStyle),
            0 === r && (r = this._mainRule.foreground),
            0 === i && (i = this._mainRule.background),
            this._rulesWithParentScopes.push(new x(e, t, n, r, i)));
        }
      },
      T = class e {
    ...
    var R =
      (((s = R || {})[(s.None = 0)] = 'None'),
      (s[(s.NotBeginString = 1)] = 'NotBeginString'),
      (s[(s.NotEndString = 2)] = 'NotEndString'),
      (s[(s.NotBeginPosition = 4)] = 'NotBeginPosition'),
      (s[(s.DebugCall = 8)] = 'DebugCall'),
      s);
    function O(e) {
      ...
      D = class {
        constructor(e, t) {
          ((this.repo = e),
            ...
            (this.Q = [new I(this.initialScopeName)]));
        }
        ...
        processQueue() {
          ...
          for (let n of e)
            !(function (e, t, n, r) {
              ...
              let a = n.lookup(t);
              e instanceof I
                ? G({ baseGrammar: a, selfGrammar: i }, r)
                : U(
                    e.ruleName,
                    {
                      baseGrammar: a,
              ...
              if (o) for (let e of o) r.add(new I(e));
    ...
    function U(e, t, n) {
      t.repository && t.repository[e] && j([t.repository[e]], t, n);
    }
    function G(e, t) {
    ...
    function j(e, t, n) {
      for (let r of e) {
        ...
        n.visitedRule.add(r);
        let e = r.repository ? d({}, t.repository, r.repository) : t.repository;
        Array.isArray(r.patterns) && j(r.patterns, { ...t, repository: e }, n);
        let i = r.include;
        if (!i) continue;
        let a = z(i);
        switch (a.kind) {
          case 0:
            G({ ...t, selfGrammar: t.baseGrammar }, n);
            break;
          case 1:
            G(t, n);
            break;
          case 2:
            U(a.ruleName, { ...t, repository: e }, n);
            break;
          case 3:
          case 4:
            let o =
            ...
            if (o) {
              ...
              4 === a.kind ? U(a.ruleName, r, n) : G(r, n);
            } else
              4 === a.kind
                ? n.add(new B(a.scopeName, a.ruleName))
                : n.add(new I(a.scopeName));
        }
      }
    }
    var $ = class {
    ...
    function z(e) {
      if ('$base' === e) return new $();
      if ('$self' === e) return new F();
      let t = e.indexOf('#');
      return -1 === t
        ? new W(e)
        : 0 === t
          ? new H(e.substring(1))
          : new q(e.substring(0, t), e.substring(t + 1));
    }
    var V = /\\(\d+)/,
      K = /\\(\d+)/g;
    Symbol('RuleId');
    var X = class {
        ...
        constructor(e, t, n, r) {
          ((this.$location = e),
            (this.id = t),
            (this._name = n || null),
            (this._nameIsCapturing = f.hasCaptures(this._name)),
            (this._contentName = r || null),
            (this._contentNameIsCapturing = f.hasCaptures(this._contentName)));
        }
        get debugName() {
          let e = this.$location
            ? `${(function e(t) {
        ...
        getName(e, t) {
          return this._nameIsCapturing &&
            ...
            null !== e &&
            null !== t
            ? f.replaceCaptures(this._name, e, t)
            : this._name;
        }
        getContentName(e, t) {
          return this._contentNameIsCapturing && null !== this._contentName
            ? f.replaceCaptures(this._contentName, e, t)
            : this._contentName;
        }
      },
      Y = class extends X {
      ...
      J = class extends X {
        ...
        _getCachedCompiledPatterns(e) {
          return (
            this._cachedCompiledPatterns ||
              ((this._cachedCompiledPatterns = new er()),
      ...
      Z = class extends X {
        ...
        constructor(e, t, n, r, i, a, o, s, l, u) {
          (super(e, t, n, r),
            (this._begin = new en(i, this.id)),
            (this.beginCaptures = a),
            (this._end = new en(o || '￿', -1)),
        ...
        _getCachedCompiledPatterns(e, t) {
          if (!this._cachedCompiledPatterns) {
            for (let t of ((this._cachedCompiledPatterns = new er()),
            this.patterns))
      ...
      ee = class extends X {
        ...
        _getCachedCompiledWhilePatterns(e, t) {
          return (
            this._cachedCompiledWhilePatterns ||
              ((this._cachedCompiledWhilePatterns = new er()),
      ...
      et = class e {
        static createCaptureRule(e, t, n, r, i) {
          return e.registerRule((e) => new Y(t, e, n, r, i));
        }
          ...
          return (
            t.id ||
              n.registerRule((i) => {
                ...
                if (void 0 === t.begin) {
                  t.repository && (r = d({}, r, t.repository));
                  let i = t.patterns;
                  return (
            ...
            for (let a = 0, o = t.length; a < o; a++) {
              ...
              if (-1 !== s) {
                let e = n.getRule(s),
                  t = !1;
                if (
                  ((e instanceof Q || e instanceof Z || e instanceof ee) &&
      ...
      en = class e {
        ...
        constructor(e, t) {
          ...
          (this.hasAnchor
            ...
            'string' == typeof this.source
              ? (this.hasBackReferences = V.test(this.source))
        ...
        resolveBackReferences(e, t) {
          ...
          return (
            (K.lastIndex = 0),
            this.source.replace(K, (e, t) => b(n[parseInt(t, 10)] || ''))
          );
        }
        _buildAnchorCache() {
          let e, t, n, r;
      ...
      eo = class e {
        ...
        constructor(e, t) {
          ((this._defaultAttributes = new ea(e, 8)),
            (this._embeddedLanguagesMatcher = new es(Object.entries(t || {}))));
        }
        ...
        static _NULL_SCOPE_METADATA = new ea(0, 0);
        _getBasicScopeAttributes = new A(
          (e) => new ea(this._scopeToLanguage(e), this._toStandardTokenType(e))
        );
        _scopeToLanguage(e) {
    ...
    void 0 !== p.default && p.default.env.VSCODE_TEXTMATE_DEBUG;
    var el = class {
      constructor(e, t) {
    ...
    function eu(e, t, n, r, i, a, o, s) {
      ...
      if (o) {
        let o = (function (e, t, n, r, i, a) {
          ...
          for (let t = i; t; t = t.pop()) {
            let n = t.getRule(e);
            n instanceof ee && s.push({ rule: n, stack: t });
          }
          for (let d = s.pop(); d; d = s.pop()) {
            ...
            if (f) {
              ...
              f.captureIndices &&
                ...
                (a.produce(d.stack, f.captureIndices[0].start),
                eh(e, t, n, d.stack, a, d.rule.whileCaptures, f.captureIndices),
                a.produce(d.stack, f.captureIndices[0].end),
      ...
      let h = Date.now();
      for (; !u; ) {
        if (0 !== s && Date.now() - h > s) return new el(i, !0);
        !(function () {
          let o = (function (e, t, n, r, i, a) {
            let o = (function (e, t, n, r, i, a) {
                let { ruleScanner: o, findOptions: s } = ec(
                    i.getRule(e),
                    e,
                    i.endRule,
                    n,
            ...
            let l = (function (e, t, n, r, i, a, o) {
              let s,
                ...
                u = null,
                c = 0,
                h = a.contentNameScopesList.getScopeNames();
              for (let a = 0, p = e.length; a < p; a++) {
                let p = e[a];
                if (!p.matcher(h)) continue;
                let { ruleScanner: d, findOptions: m } = ec(
                    t.getRule(p.ruleId),
                    t,
                    null,
                    r,
            ...
            return c < u || (l.priorityMatch && c === u) ? l : o;
          })(e, t, n, r, i, c);
          if (!o) {
            (a.produce(i, l), (u = !0));
            return;
          ...
          if (-1 === h) {
            ...
            if (
              ((i = i.push(h, r, c, s[0].end === l, null, f, f)),
              o instanceof Z)
            ) {
              (eh(e, t, n, i, a, o.beginCaptures, s),
                a.produce(i, s[0].end),
                (c = s[0].end));
              ...
              if (
                ...
                o.endHasBackReferences &&
                  (i = i.withEndRule(
                    o.getEndWithResolvedBackReferences(t.content, s)
                  )),
                !p && d.hasSameRuleAs(i))
              ) {
              ...
              if (
                ...
                o.whileHasBackReferences &&
                  (i = i.withEndRule(
                    o.getWhileWithResolvedBackReferences(t.content, s)
                  )),
                !p && d.hasSameRuleAs(i))
              ) {
                ((i = i.pop()), a.produce(i, l), (u = !0));
    ...
    function eh(e, t, n, r, i, a, o) {
      ...
      for (let t = 0; t < l; t++) {
        ...
        if (
          ...
          (eu(e, d, n && 0 === h.start, h.start, p, i, !1, 0), O(d));
          continue;
        }
        let p = l.getName(s, o);
        if (null !== p) {
    ...
    function ed(e, t, n, r, i) {
      let a = P(t, em),
        o = et.getCompiledRuleId(n, r, i.repository);
      for (let n of a)
        e.push({
          debugSelector: t,
          matcher: n.matcher,
    ...
    var ef = class {
      constructor(e, t, n, r, i, a, o, s) {
        if (
          ...
          (this._onigLib = s),
          (this._basicScopeAttributesProvider = new eo(n, r)),
          (this._rootId = -1),
          (this._lastRuleId = 0),
          (this._ruleId2desc = [null]),
          (this._includedGrammars = {}),
          (this._grammarRepository = o),
          (this._grammar = eg(t, null)),
          (this._injections = null),
          (this._tokenTypeMatchers = []),
          i)
        )
          for (const e of Object.keys(i))
            for (const t of P(e, em))
              this._tokenTypeMatchers.push({ matcher: t.matcher, type: i[e] });
      }
      _rootId;
      _lastRuleId;
      _ruleId2desc;
      ...
      _collectInjections() {
        ...
        if (n) {
          let r = n.injections;
          if (r) for (let t in r) ed(e, t, r[t], this, n);
      ...
      getExternalGrammar(e, t) {
        ...
        if (this._grammarRepository) {
          ...
          if (n)
            return (
              (this._includedGrammars[e] = eg(n, t && t.$base)),
      ...
      _tokenize(e, t, n, r) {
        ...
        if (
          (-1 === this._rootId &&
            ((this._rootId = et.getCompiledRuleId(
          ...
          ((e = o
            ? ey.createRootAndLookUpScopeName(o, a, this)
            : ey.createRoot('unknown', a)),
    ...
    var ey = class e {
        ...
        static mergeAttributes(e, t, n) {
          ...
          return (
            ...
            T.set(e, t.languageId, t.tokenType, null, r, i, a)
          );
        }
        pushAttributed(t, n) {
      ...
      eb = class e {
        ...
        static _equals(e, t) {
          return (
            ...
            (!!this._structuralEquals(e, t) &&
              ey.equals(e.contentNameScopesList, t.contentNameScopesList))
          );
        }
        ...
        static pushFrame(t, n) {
          let r = ey.fromExtension(t?.nameScopesList ?? null, n.nameScopesList);
          return new e(
            t,
            n.ruleId,
            n.enterPos ?? -1,
            ...
            n.endRule,
            r,
            ey.fromExtension(r, n.contentNameScopesList)
          );
        }
      },
      eA = class {
          ...
          if (this._emitBinaryTokens) {
            ...
            if (
              ...
              for (let e of this._tokenTypeOverrides)
                e.matcher(t) && (n = T.set(n, 0, e.type, null, -1, 0, 0));
              this.balancedBracketSelectors &&
                (r = this.balancedBracketSelectors.match(t));
            }
            if (
              (r && (n = T.set(n, 0, 8, r, -1, 0, 0)),
      ...
      ev = class {
        ...
        grammarForScopeName(e, t, n, r, i) {
          if (!this._grammars.has(e)) {
            ...
            this._grammars.set(
              e,
              new ef(e, a, t, n, r, i, this, this._onigLib)
            );
          }
      ...
      ek = class {
        ...
        constructor(e) {
          ((this._options = e),
            (this._syncRegistry = new ev(
              _.createFromRawTheme(e.theme, e.colorMap),
              e.onigLib
            )),
        ...
        _loadGrammar(e, t, n, r, i) {
          let a = new D(this._syncRegistry, e);
          for (; a.Q.length > 0; )
    ...
    ((eL.prototype.attribute = ''),
      (eL.prototype.booleanish = !1),
      (eL.prototype.boolean = !1),
      (eL.prototype.commaOrSpaceSeparated = !1),
      (eL.prototype.commaSeparated = !1),
      (eL.prototype.defined = !1),
      (eL.prototype.mustUseProperty = !1),
      (eL.prototype.number = !1),
      (eL.prototype.overloadedBoolean = !1),
      (eL.prototype.property = ''),
      (eL.prototype.spaceSeparated = !1),
      (eL.prototype.space = void 0));
    let eT = 0,
      eP = eD(),
      eE = eD(),
      eR = eD(),
    ...
    function e$(e) {
      ...
      for (let [r, i] of Object.entries(e.properties)) {
        let a = new ej(r, e.transform(e.attributes || {}, r), i, e.space);
        (e.mustUseProperty &&
      ...
      return new eC(t, n, e.space);
    }
    ej.prototype.defined = !0;
    let eF = e$({
      properties: {
    ...
    let eq = e$({
      ...
      ez = e$({
        ...
        properties: {
          ...
          stopColor: null,
          stopOpacity: null,
          strikethroughPosition: eO,
          strikethroughThickness: eO,
          string: null,
          stroke: null,
          strokeDashArray: eM,
          ...
          u1: null,
          u2: null,
          underlinePosition: eO,
          underlineThickness: eO,
          unicode: null,
          unicodeBidi: null,
          unicodeRange: null,
          unitsPerEm: eO,
      ...
      eY = eN([eF, eq, eV, eK, eX], 'html'),
      eJ = eN([eF, ez, eV, eK, eX], 'svg'),
      eQ = {}.hasOwnProperty,
      eZ = /["&'<>`]/g,
      e0 = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g,
      e1 = /[\x01-\t\v\f\x0E-\x1F\x7F\x81\x8D\x8F\x90\x9D\xA0-\uFFFF]/g,
      e2 = /[|\\{}()[\]^$+*?.]/g,
      e5 = new WeakMap(),
      e8 = /[\dA-Fa-f]/,
      e6 = /\d/,
      ...
      e9 = ['cent', 'copy', 'divide', 'gt', 'lt', 'not', 'para', 'times'],
      e7 = {}.hasOwnProperty,
      te = {};
    for (t in e4) e7.call(e4, t) && (te[e4[t]] = t);
    let tt = /[^\dA-Za-z]/;
    function tn(e, t, n) {
      var r, i;
      let a,
        o,
        s =
          ((r = n.omitOptionalSemicolons),
          (a = '&#x' + e.toString(16).toUpperCase()),
          r && t && !e8.test(String.fromCharCode(t)) ? a : a + ';');
      if (
          ...
          (o = (function (e, t, n, r) {
            ...
            if (e7.call(te, i)) {
              ...
              return n &&
                e3.includes(e) &&
                !e9.includes(e) &&
                (!r || (t && 61 !== t && tt.test(String.fromCharCode(t))))
                ? a
                : a + ';';
            }
            return '';
        ...
        let r,
          a =
            ((i = n.omitOptionalSemicolons),
            (r = '&#' + String(e)),
            i && t && !e6.test(String.fromCharCode(t)) ? r : r + ';');
        a.length < s.length && (s = a);
      }
      return o && (!n.useShortestReferences || o.length < s.length) ? o : s;
    }
    function tr(e, t) {
      let n;
      var r,
        i = e,
        a = Object.assign({ format: tn }, t);
      if (
        ((i = i.replace(
          a.subset
            ? ((r = a.subset),
              (n = e5.get(r)) ||
                ((n = (function (e) {
                  let t = [],
                    n = -1;
                  for (; ++n < e.length; ) t.push(e[n].replace(e2, '\\$&'));
    ...
    let td = /[ \t\n\f\r]/g;
    function tm(e) {
      return 'object' == typeof e ? 'text' === e.type && tf(e.value) : tf(e);
    }
    function tf(e) {
      return '' === e.replace(td, '');
    }
    ...
    function tA(e) {
      return function (t, n, r) {
        let i = t ? t.children : tb,
          a = (n || 0) + e,
          o = i[a];
        if (!r) for (; o && tm(o); ) ((a += e), (o = i[a]));
        return o;
      };
    }
    ...
    function tv(e) {
      return function (t, n, r) {
        return t_.call(e, t.tagName) && e[t.tagName](t, n, r);
      };
    }
    let tk = tv({
      body: function (e, t, n) {
    ...
    function tw(e, t, n) {
      ...
      return (
        !r ||
        ('comment' !== r.type && !('text' === r.type && tm(r.value.charAt(0))))
      );
    }
    function tS(e, t, n) {
      let r = tg(n, t);
    ...
    function tT(e, t, n, r) {
      return n &&
        ...
        : tr(
            e.value,
            Object.assign({}, r.settings.characterReferences, { subset: tL })
          );
    }
    let tP = (function (e, t) {
        let n = t || {};
        ...
        handlers: {
          ...
          element: function (e, t, n, r) {
            let i,
              ...
              l = [];
            'html' === a.space && 'svg' === e.tagName && (r.schema = eJ);
            let u = (function (e, t) {
                let n,
                  r = [],
                  i = -1;
                          ...
                          : (e.settings.preferUnquoted &&
                              (r = tr(
                                ...
                                Object.assign(
                                  ...
                                  { attribute: !0, subset: tx.unquoted[a][o] }
                                )
                              )),
                            r !== n &&
                              (e.settings.quoteSmart &&
                                ts(n, s) > ts(n, e.alternative) &&
                                (s = e.alternative),
                              (r =
                                s +
                                tr(
              ...
              c = r.all(
                'html' === a.space && 'template' === e.tagName ? e.content : e
              );
            return (
              (r.schema = a),
              c && (s = !1),
              (!u && o && tN(e, t, n)) ||
                ...
                l.push('>')),
              l.push(c),
              s || (o && tk(e, t, n)) || l.push('</' + e.tagName + '>'),
              l.join('')
            );
          },
          raw: function (e, t, n, r) {
            return r.settings.allowDangerousHtml ? e.value : tT(e, t, n, r);
          },
    ...
    function tz(e) {
      ...
      if (
        ...
        (e.fontStyle & S.Italic && (t['font-style'] = 'italic'),
          e.fontStyle & S.Bold && (t['font-weight'] = 'bold'));
        let n = [];
        (e.fontStyle & S.Underline && n.push('underline'),
          e.fontStyle & S.Strikethrough && n.push('line-through'),
    ...
    class tJ {
      ...
      static initial(e, t) {
        return new tJ(
          Object.fromEntries((Array.isArray(t) ? t : [t]).map((e) => [e, ew])),
          e
        );
      }
      constructor(...e) {
      ...
      (function () {
            ...
            let r,
              i = function (e) {
                if ('number' == typeof e) {
                  ...
                  return { ...a.indexToPos(e), offset: e };
                }
                {
                  let t = a.lines[e.line];
                  if (void 0 === t)
                    throw new h(
                      `Invalid decoration position ${JSON.stringify(e)}. Lines length: ${a.lines.length}`
                    );
                  let n = e.character;
                  ...
                  return {
                    ...e,
                    character: n,
                    offset: a.posToIndex(e.line, n),
                  };
                }
              },
              a = {
                lines: (r = tH((n = t.source), !0).map(([e]) => e)),
                indexToPos: function (e) {
                  if (e === n.length)
                    return {
                      line: r.length - 1,
                  ...
                  return { line: i, character: t };
                },
                posToIndex: function (e, t) {
                  let n = 0;
                  for (let t = 0; t < e; t++) n += r[t].length;
                  return n + t;
                },
              },
        ...
        return {
          ...
          tokens(e) {
            ...
            let r = t(this).decorations.flatMap((e) => [
              e.start.offset,
              e.end.offset,
            ]);
            return (n = Array.from(r instanceof Set ? r : new Set(r)).sort(
              (e, t) => e - t
            )).length
              ? e.map((e) =>
                  e.flatMap((e) => {
                    let t = n
                      .filter(
                        (t) => e.offset < t && t < e.offset + e.content.length
                      )
                      .map((t) => t - e.offset)
                      .sort((e, t) => e - t);
          ...
          code(e) {
            ...
            function i(e, t, n, i) {
              ...
              if (
                ...
                for (let e = 0; e < o.children.length; e++)
                  ((s += (function e(t) {
                    ...
                    -1 === l && s.length === t && (l = e + 1),
                    -1 === u && s.length === n && (u = e + 1));
              if (-1 === l)
                throw new h(
              ...
              let c = o.children.slice(l, u);
              if (i.alwaysWrap || c.length !== o.children.length)
                if (i.alwaysWrap || 1 !== c.length || 'element' !== c[0].type) {
                  ...
                  (a(e, i, 'wrapper'), o.children.splice(l, c.length, e));
                } else a(c[0], i, 'token');
              else a(o, i, 'line');
            }
            function a(e, t, n) {
              ...
              return (
                ...
                t.properties?.class && tF(e, t.properties.class),
                (e = i(e, n) || e)
              );
            }
            let o = [];
    ...
    function tZ(e) {
      ...
      return [...t.pre, ...t.normal, ...t.post, ...tQ];
    }
    var t0 = [
        'black',
        'red',
    ...
    function t6(e, t, n = {}) {
      ...
      let a,
        o,
        { theme: s = e.getLoadedThemes()[0] } = n,
        l = e.resolveLangAlias(n.lang || 'text');
      if (tG(l) || t$(s))
        return tH(t).map((e) => [{ content: e[0], offset: e[1] }]);
      let { theme: u, colorMap: c } = e.setTheme(s);
      if ('ansi' === l) {
        let e, r, i, a, o, s, l;
        return (
          (e = tM(u, n)),
          ...
          (i = (function (e = t5) {
                  ...
                  case 'table':
                    ...
                    return (
                      ...
                      (function () {
                        if (t) return t;
                        t = [];
                        for (let n = 0; n < t0.length; n++) t.push(e[t0[n]]);
                        let r = [0, 95, 135, 175, 215, 255];
                        for (let e = 0; e < 6; e++)
                          for (let i = 0; i < 6; i++)
                            for (let a = 0; a < 6; a++)
                              t.push(n([r[e], r[i], r[a]]));
                        let i = 8;
            ...
            Object.fromEntries(
              t0.map((e) => {
                let t = `terminal.ansi${e[0].toUpperCase()}${e.substring(1)}`;
                return [e, u.colors?.[t] || t8[e]];
              })
            )
          )),
          (a = null),
                    ...
                    for (; e.length > 0; ) {
                      ...
                      if (!Number.isNaN(r))
                        if (0 === r) t.push({ type: 'resetAll' });
                          ...
                          t1[r] &&
                            t.push({ type: 'setDecoration', value: t1[r] });
                        else if (r <= 29) {
                          let e = t1[r - 20];
                          e &&
          ...
          r.map((t) =>
            l.parse(t[0]).map((n) => {
              ...
              (n.decorations.has('reverse')
                ? ((r = n.background ? i.value(n.background) : u.bg),
                  (a = n.foreground ? i.value(n.foreground) : u.fg))
                : ((r = n.foreground ? i.value(n.foreground) : u.fg),
                  (a = n.background ? i.value(n.background) : void 0)),
                (r = tD(r, e)),
                (a = tD(a, e)),
                n.decorations.has('dim') &&
                  (r = (function (e) {
                    ...
                    if (t) {
                      ...
                      if (8 === e.length) {
                        let t = Math.round(
                          Number.parseInt(e.slice(6, 8), 16) / 2
                        )
                          .toString(16)
                          .padStart(2, '0');
                        return `#${e.slice(0, 6)}${t}`;
                      }
                      if (6 === e.length) return `#${e}80`;
                      if (4 === e.length) {
                        let t = e[0],
                          n = e[1],
                          r = e[2],
              ...
              let o = S.None;
              return (
                n.decorations.has('bold') && (o |= S.Bold),
                n.decorations.has('italic') && (o |= S.Italic),
                n.decorations.has('underline') && (o |= S.Underline),
                n.decorations.has('strikethrough') && (o |= S.Strikethrough),
                {
                  content: n.value,
                  offset: t[1],
                  color: r,
      ...
      let p = e.getLanguage(n.lang || 'text');
      if (n.grammarState) {
        if (n.grammarState.lang !== p.name)
          throw new h(
            `Grammar state language "${n.grammarState.lang}" does not match highlight language "${p.name}"`
          );
        if (!n.grammarState.themes.includes(u.name))
          throw new h(
            `Grammar state themes "${n.grammarState.themes}" do not contain highlight theme "${u.name}"`
          );
      }
      return (
        (o = new tJ(
          (a = t3(t, (r = p), (i = u), c, n)).stateStack,
          r.name,
          i.name
        )),
        tX(a.tokens, o),
    ...
    function t3(e, t, n, r, i) {
      let a = tM(n, i),
        ...
        u = i.grammarState
          ? ((function (e, t) {
              if (!(e instanceof tJ)) throw new h('Invalid grammar state');
              return e.getInternalStack(t);
            })(i.grammarState, n.name) ?? ew)
          : null != i.grammarContextCode
            ? t3(i.grammarContextCode, t, n, r, {
                ...i,
                grammarState: void 0,
      ...
      for (let e = 0, h = l.length; e < h; e++) {
        ...
        if (o > 0 && m.length >= o) {
          ((c = []),
            p.push([{ content: m, offset: f, color: '', fontStyle: 0 }]));
          continue;
        }
        i.includeExplanation && ((h = t.tokenizeLine(m, u, s).tokens), (d = 0));
        let g = t.tokenizeLine2(m, u, s),
          y = g.tokens.length / 2;
        for (let e = 0; e < y; e++) {
          let t = g.tokens[2 * e],
            o = e + 1 < y ? g.tokens[2 * e + 2] : m.length;
          if (t === o) continue;
          let s = g.tokens[2 * e + 1],
            l = tD(r[T.getForeground(s)], a),
            u = T.getFontStyle(s),
            p = {
        ...
        (p.push(c), (c = []), (u = g.ruleStack));
      }
      return { tokens: p, stateStack: u };
    }
    function t4(e, t) {
    ...
    function t7(e, t, n) {
      ...
      if ('themes' in n) {
        ...
        if (0 === d.length) throw new h('`themes` option must not be empty');
        let m = t9(e, t, n);
        if (((l = tY(m)), u && tW !== u && !d.find((e) => e.color === u)))
          throw new h(
        ...
        ((a = m.map((e) =>
                    ...
                    if (0 === n && r && tq.includes(a))
                      if (r === tW && o.length > 1) {
                        ...
                        let c = o[e][a] || 'inherit',
                          p = o[r][a] || 'inherit';
                        ((l[a] = `light-dark(${c}, ${p})`),
                          'css-vars' === i && (l[u(n, a)] = s));
                      } else l[a] = s;
                    else 'css-vars' === i && (l[u(n, a)] = s);
                  }
                }),
                (a.htmlStyle = l),
                a
          ...
          l && tX(a, l));
        let y = d.map((e) => tM(e.theme, n));
        ((i = ne(d, f, y, c, u, 'fg', p)),
          (r = ne(d, f, y, c, u, 'bg', p)),
          (o = `shiki-themes ${f.map((e) => e.name).join(' ')}`),
          (s = u ? void 0 : [i, r].join(';')));
      } else if ('theme' in n) {
        let s = tM(n.theme, n);
        a = t6(e, t, n);
        let u = e.getTheme(n.theme);
        ((r = tD(u.bg, s)), (i = tD(u.fg, s)), (o = u.name), (l = tY(a)));
      } else
        throw new h(
    ...
    function ne(e, t, n, r, i, a, o) {
      return e
        .map((s, l) => {
          let u = tD(t[l][a], n[l]) || 'inherit',
            c = `${r + s.color}${'bg' === a ? '-bg' : ''}:${u}`;
          if (0 === l && i) {
            if (i === tW && e.length > 1) {
              ...
              let o = tD(t[r][a], n[r]) || 'inherit',
                s = tD(t[i][a], n[i]) || 'inherit';
              return `light-dark(${o}, ${s});${c}`;
            }
            return u;
          }
          return 'css-vars' === o ? c : null;
        })
        .filter((e) => !!e)
        .join(';');
    }
    function nt(
      ...
      r = {
        meta: {},
        options: n,
        codeToHast: (t, n) => nt(e, t, n),
        codeToTokens: (t, n) => t7(e, t, n),
      }
    ) {
      let i = t;
        ...
        ? (a = a.map((e) => {
            ...
            return (
              e.forEach((i, a) => {
                let o = !(
                  i.fontStyle &&
                  (i.fontStyle & S.Underline || i.fontStyle & S.Strikethrough)
                );
                o && i.content.match(/^\s+$/) && e[a + 1]
                  ? (void 0 === t && (t = i.offset), (r += i.content))
                  : r
                    ? (o
                        ? n.push({ ...i, offset: t, content: r + i.content })
                        : n.push({ content: r, offset: t }, i),
                      (t = void 0),
                      (r = ''))
                    : n.push(i);
              }),
        ...
        p &&
          (a = a.map((e) => {
            ...
            for (let n of e) {
              ...
              let e = t[t.length - 1],
                r = tV(e.htmlStyle || tz(e)),
                i = tV(n.htmlStyle || tz(n)),
                a =
                  e.fontStyle &&
                  (e.fontStyle & S.Underline || e.fontStyle & S.Strikethrough),
                o =
                  n.fontStyle &&
                  (n.fontStyle & S.Underline || n.fontStyle & S.Strikethrough);
      ...
      for (let e of tZ(n)) a = e.tokens?.call(d, a) || a;
      return (function (e, t, n, r = tY(e)) {
        let i = tZ(t),
          a = [],
          o = { type: 'root', children: [] },
          { structure: s = 'classic', tabindex: l = '0' } = t,
          u = { class: `shiki ${t.themeName || ''}` };
        for (let [e, n] of (!1 !== t.rootStyle &&
          (null != t.rootStyle
            ? (u.style = t.rootStyle)
            : (u.style = `background-color:${t.bg};color:${t.fg}`)),
        !1 !== l && null != l && (u.tabindex = l.toString()),
        Object.entries(t.meta || {})))
          e.startsWith('_') || (u[e] = n);
        let c = {
            type: 'element',
            tagName: 'pre',
            properties: u,
        ...
        if (
          (e.forEach((e, t) => {
            ...
            for (let a of e) {
              let e = {
                ...
                l = tV(a.htmlStyle || tz(a));
              for (let o of (l && (e.properties.style = l), i))
                e = o?.span?.call(d, e, t + 1, r, n, a) || e;
              ('inline' === s
                ? o.children.push(e)
            ...
            if ('classic' === s) {
              ...
              (p.push(n), a.push(n));
            } else 'inline' === s && p.push(n);
          }),
          'classic' === s)
        ) {
          for (let e of i) h = e?.code?.call(d, h) || h;
          for (let e of (c.children.push(h), i)) c = e?.pre?.call(d, c) || c;
          o.children.push(c);
        } else if ('inline' === s) {
          let e = [],
            t = {
          ...
          for (let e of i) n = e?.code?.call(d, n) || n;
          o.children = [];
        ...
        let m = o;
        for (let e of i) m = e?.root?.call(d, m) || m;
        return (r && tX(m, r), m);
      })(
        a,
        {
          ...
          bg: s,
          themeName: l,
          rootStyle: !1 !== n.rootStyle && (n.rootStyle ?? u),
        },
        d,
        c
      );
    ...
    function ni(e) {
      ...
      if (!n || !r) {
        ...
        (e?.settings?.foreground && (r = e.settings.foreground),
          ...
          r || (r = 'light' === t.type ? '#333333' : '#bbbbbb'),
          n || (n = 'light' === t.type ? '#fffffe' : '#1e1e1e'),
          (t.fg = r),
          (t.bg = n));
      }
          ...
          (
            await Promise.all(
              e
                ...
                .map(
                  async (e) =>
                    await tU(e).then((e) => (Array.isArray(e) ? e : [e]))
                )
            )
          ).flat()
        )
    ...
    async function no(e) {
      return (
        await Promise.all(e.map(async (e) => (t$(e) ? null : ni(await tU(e)))))
      ).filter((e) => !!e);
    }
    ...
    class nu extends ek {
      ...
      setTheme(e) {
        ...
        (t ||
          ((t = _.createFromRawTheme(e)), this._textmateThemeCache.set(e, t)),
          this._syncRegistry.setTheme(t));
      }
      getGrammar(e) {
        return ((e = nl(e, this._alias)), this._resolvedGrammars.get(e));
      }
      loadLanguage(e) {
      ...
      loadLanguages(e) {
        ...
        if (n.length) {
          let e = t
            .filter(([e, t]) => {
              if (!t) return !1;
              let r = t.embeddedLanguages || t.embeddedLangs;
              return r?.some((e) => n.map(([e]) => e).includes(e));
            })
      ...
      return (function (e) {
        ...
        ((nh += 1),
          !1 !== e.warnings &&
            ...
            nh % 10 == 0 &&
            console.warn(
              `[Shiki] ${nh} instances have been created. Shiki is supposed to be used as a singleton, consider refactoring your code to cache your highlighter instance; Or call \`highlighter.dispose()\` to release unused instances.`
            ));
        let n = !1;
        if (!e.engine)
          throw new ns('`engine` option is required for synchronous mode');
        let r = (e.langs || []).flat(1),
          i = (e.themes || []).flat(1).map(ni),
          a = new nu(new nc(e.engine, r), i, r, e.langAlias);
        function o(e) {
          if ('none' === e)
        ...
        function u() {
          if (n) throw new ns('Shiki instance has been disposed');
        }
        function c() {
          n || ((n = !0), a.dispose(), (nh -= 1));
        }
        return {
          setTheme: function (e) {
            u();
            let n = o(e);
            return (
              t !== e && (a.setTheme(n), (t = e)),
              { theme: n, colorMap: a.getColorMap() }
            );
          },
          getTheme: o,
    ...
    async function nd(e) {
      ...
      return {
        getLastGrammarState: (...e) =>
          (function (...e) {
            if (2 === e.length) return tY(e[1]);
            let [t, n, r = {}] = e,
              { lang: i = 'text', theme: a = t.getLoadedThemes()[0] } = r;
            if (tG(i) || t$(a))
              throw new h('Plain language does not have grammar state');
            if ('ansi' === i)
              throw new h('ANSI language does not have grammar state');
            let { theme: o, colorMap: s } = t.setTheme(a),
              l = t.getLanguage(i);
            return new tJ(t3(n, l, o, s, r).stateStack, l.name, o.name);
          })(t, ...e),
        codeToTokensBase: (e, n) => t6(t, e, n),
        codeToTokensWithThemes: (e, n) => t9(t, e, n),
        codeToTokens: (e, n) => t7(t, e, n),
        codeToHast: (e, n) => nt(t, e, n),
        codeToHtml: (e, n) =>
          (function (e, t, n) {
            let r = {
                meta: {},
    ...
    let nm = [
        { id: 'abap', name: 'ABAP', import: () => e.A(63563) },
        {
          id: 'actionscript-3',
          name: 'ActionScript',
          import: () => e.A(84775),
        },
        { id: 'ada', name: 'Ada', import: () => e.A(25866) },
        { id: 'angular-html', name: 'Angular HTML', import: () => e.A(55496) },
        {
          id: 'angular-ts',
          name: 'Angular TypeScript',
          import: () => e.A(43144),
        },
        { id: 'apache', name: 'Apache Conf', import: () => e.A(84991) },
        { id: 'apex', name: 'Apex', import: () => e.A(8319) },
        { id: 'apl', name: 'APL', import: () => e.A(5839) },
        { id: 'applescript', name: 'AppleScript', import: () => e.A(99058) },
        { id: 'ara', name: 'Ara', import: () => e.A(41436) },
        {
          id: 'asciidoc',
          name: 'AsciiDoc',
          aliases: ['adoc'],
        ...
        { id: 'asm', name: 'Assembly', import: () => e.A(35967) },
        { id: 'astro', name: 'Astro', import: () => e.A(9162) },
        { id: 'awk', name: 'AWK', import: () => e.A(15453) },
        { id: 'ballerina', name: 'Ballerina', import: () => e.A(77317) },
        {
          id: 'bat',
          name: 'Batch File',
          aliases: ['batch'],
        ...
        { id: 'beancount', name: 'Beancount', import: () => e.A(25290) },
        {
          id: 'berry',
          name: 'Berry',
          aliases: ['be'],
        ...
        { id: 'bibtex', name: 'BibTeX', import: () => e.A(61145) },
        { id: 'bicep', name: 'Bicep', import: () => e.A(45290) },
        { id: 'blade', name: 'Blade', import: () => e.A(54301) },
        {
          id: 'bsl',
          name: '1C (Enterprise)',
          aliases: ['1c'],
        ...
        { id: 'c', name: 'C', import: () => e.A(24251) },
        { id: 'c3', name: 'C3', import: () => e.A(36760) },
        {
          id: 'cadence',
          name: 'Cadence',
          aliases: ['cdc'],
        ...
        { id: 'cairo', name: 'Cairo', import: () => e.A(92123) },
        { id: 'clarity', name: 'Clarity', import: () => e.A(41345) },
        {
          id: 'clojure',
          name: 'Clojure',
          aliases: ['clj'],
        ...
        { id: 'cmake', name: 'CMake', import: () => e.A(71436) },
        { id: 'cobol', name: 'COBOL', import: () => e.A(51375) },
        { id: 'codeowners', name: 'CODEOWNERS', import: () => e.A(34554) },
        {
          id: 'codeql',
          name: 'CodeQL',
          aliases: ['ql'],
        ...
        { id: 'coq', name: 'Coq', import: () => e.A(54392) },
        { id: 'cpp', name: 'C++', aliases: ['c++'], import: () => e.A(11747) },
        { id: 'crystal', name: 'Crystal', import: () => e.A(3701) },
        {
          id: 'csharp',
          name: 'C#',
          aliases: ['c#', 'cs'],
        ...
        { id: 'css', name: 'CSS', import: () => e.A(95138) },
        { id: 'csv', name: 'CSV', import: () => e.A(25297) },
        { id: 'cue', name: 'CUE', import: () => e.A(36140) },
        {
          id: 'cypher',
          name: 'Cypher',
          aliases: ['cql'],
        ...
        { id: 'd', name: 'D', import: () => e.A(61380) },
        { id: 'dart', name: 'Dart', import: () => e.A(11628) },
        { id: 'dax', name: 'DAX', import: () => e.A(24832) },
        { id: 'desktop', name: 'Desktop', import: () => e.A(9799) },
        { id: 'diff', name: 'Diff', import: () => e.A(23324) },
        {
          id: 'docker',
          name: 'Dockerfile',
          aliases: ['dockerfile'],
        ...
        { id: 'dotenv', name: 'dotEnv', import: () => e.A(81214) },
        { id: 'dream-maker', name: 'Dream Maker', import: () => e.A(76204) },
        { id: 'edge', name: 'Edge', import: () => e.A(73122) },
        { id: 'elixir', name: 'Elixir', import: () => e.A(44025) },
        { id: 'elm', name: 'Elm', import: () => e.A(58972) },
        {
          id: 'emacs-lisp',
          name: 'Emacs Lisp',
          aliases: ['elisp'],
        ...
        { id: 'erb', name: 'ERB', import: () => e.A(75455) },
        {
          id: 'erlang',
          name: 'Erlang',
          aliases: ['erl'],
        ...
        { id: 'fennel', name: 'Fennel', import: () => e.A(45983) },
        { id: 'fish', name: 'Fish', import: () => e.A(1211) },
        {
          id: 'fluent',
          name: 'Fluent',
          aliases: ['ftl'],
        ...
        { id: 'gdresource', name: 'GDResource', import: () => e.A(28779) },
        { id: 'gdscript', name: 'GDScript', import: () => e.A(47789) },
        { id: 'gdshader', name: 'GDShader', import: () => e.A(11256) },
        { id: 'genie', name: 'Genie', import: () => e.A(33267) },
        { id: 'gherkin', name: 'Gherkin', import: () => e.A(20181) },
        {
          id: 'git-commit',
        ...
        { id: 'gleam', name: 'Gleam', import: () => e.A(91443) },
        {
          id: 'glimmer-js',
          name: 'Glimmer JS',
          aliases: ['gjs'],
        ...
        { id: 'glsl', name: 'GLSL', import: () => e.A(15044) },
        { id: 'gn', name: 'GN', import: () => e.A(19872) },
        { id: 'gnuplot', name: 'Gnuplot', import: () => e.A(12336) },
        { id: 'go', name: 'Go', import: () => e.A(63581) },
        {
          id: 'graphql',
          name: 'GraphQL',
          aliases: ['gql'],
        ...
        { id: 'groovy', name: 'Groovy', import: () => e.A(97045) },
        { id: 'hack', name: 'Hack', import: () => e.A(55947) },
        { id: 'haml', name: 'Ruby Haml', import: () => e.A(69228) },
        {
          id: 'handlebars',
          name: 'Handlebars',
          aliases: ['hbs'],
        ...
        { id: 'haxe', name: 'Haxe', import: () => e.A(28401) },
        { id: 'hcl', name: 'HashiCorp HCL', import: () => e.A(26807) },
        { id: 'hjson', name: 'Hjson', import: () => e.A(73879) },
        { id: 'hlsl', name: 'HLSL', import: () => e.A(89292) },
        { id: 'html', name: 'HTML', import: () => e.A(78731) },
        {
          id: 'html-derivative',
          name: 'HTML (Derivative)',
          import: () => e.A(59359),
        },
        { id: 'http', name: 'HTTP', import: () => e.A(54348) },
        { id: 'hurl', name: 'Hurl', import: () => e.A(76293) },
        { id: 'hxml', name: 'HXML', import: () => e.A(49517) },
        { id: 'hy', name: 'Hy', import: () => e.A(4997) },
        { id: 'imba', name: 'Imba', import: () => e.A(57146) },
        {
          id: 'ini',
          name: 'INI',
          aliases: ['properties'],
        ...
        { id: 'java', name: 'Java', import: () => e.A(8494) },
        {
          id: 'javascript',
          name: 'JavaScript',
          aliases: ['js', 'cjs', 'mjs'],
        ...
        { id: 'jinja', name: 'Jinja', import: () => e.A(90484) },
        { id: 'jison', name: 'Jison', import: () => e.A(91715) },
        { id: 'json', name: 'JSON', import: () => e.A(96344) },
        { id: 'json5', name: 'JSON5', import: () => e.A(34970) },
        { id: 'jsonc', name: 'JSON with Comments', import: () => e.A(38377) },
        { id: 'jsonl', name: 'JSON Lines', import: () => e.A(64255) },
        { id: 'jsonnet', name: 'Jsonnet', import: () => e.A(68983) },
        { id: 'jssm', name: 'JSSM', aliases: ['fsl'], import: () => e.A(6359) },
        { id: 'jsx', name: 'JSX', import: () => e.A(74200) },
        {
          id: 'julia',
          name: 'Julia',
          aliases: ['jl'],
        ...
        { id: 'kdl', name: 'KDL', import: () => e.A(21205) },
        {
          id: 'kotlin',
          name: 'Kotlin',
          aliases: ['kt', 'kts'],
        ...
        { id: 'latex', name: 'LaTeX', import: () => e.A(88306) },
        {
          id: 'lean',
          name: 'Lean 4',
          aliases: ['lean4'],
        ...
        { id: 'less', name: 'Less', import: () => e.A(67682) },
        { id: 'liquid', name: 'Liquid', import: () => e.A(58128) },
        { id: 'llvm', name: 'LLVM IR', import: () => e.A(64509) },
        { id: 'log', name: 'Log file', import: () => e.A(67737) },
        { id: 'logo', name: 'Logo', import: () => e.A(35594) },
        { id: 'lua', name: 'Lua', import: () => e.A(47799) },
        { id: 'luau', name: 'Luau', import: () => e.A(3615) },
        {
          id: 'make',
          name: 'Makefile',
          aliases: ['makefile'],
        ...
        { id: 'marko', name: 'Marko', import: () => e.A(15014) },
        { id: 'matlab', name: 'MATLAB', import: () => e.A(89658) },
        { id: 'mdc', name: 'MDC', import: () => e.A(68608) },
        { id: 'mdx', name: 'MDX', import: () => e.A(689) },
        {
          id: 'mermaid',
          name: 'Mermaid',
          aliases: ['mmd'],
        ...
        { id: 'mojo', name: 'Mojo', import: () => e.A(89467) },
        {
          id: 'moonbit',
          name: 'MoonBit',
          aliases: ['mbt', 'mbti'],
        ...
        { id: 'move', name: 'Move', import: () => e.A(49888) },
        {
          id: 'narrat',
        ...
        { id: 'nginx', name: 'Nginx', import: () => e.A(36721) },
        { id: 'nim', name: 'Nim', import: () => e.A(98209) },
        { id: 'nix', name: 'Nix', import: () => e.A(841) },
        {
          id: 'nushell',
          name: 'nushell',
          aliases: ['nu'],
        ...
        { id: 'ocaml', name: 'OCaml', import: () => e.A(11793) },
        {
          id: 'openscad',
          name: 'OpenSCAD',
          aliases: ['scad'],
        ...
        { id: 'pascal', name: 'Pascal', import: () => e.A(34897) },
        { id: 'perl', name: 'Perl', import: () => e.A(15604) },
        { id: 'php', name: 'PHP', import: () => e.A(80495) },
        { id: 'pkl', name: 'Pkl', import: () => e.A(27710) },
        { id: 'plsql', name: 'PL/SQL', import: () => e.A(11340) },
        {
          id: 'po',
          name: 'Gettext PO',
          aliases: ['pot', 'potx'],
        ...
        { id: 'polar', name: 'Polar', import: () => e.A(13903) },
        { id: 'postcss', name: 'PostCSS', import: () => e.A(59203) },
        { id: 'powerquery', name: 'PowerQuery', import: () => e.A(32848) },
        {
          id: 'powershell',
          name: 'PowerShell',
          aliases: ['ps', 'ps1'],
        ...
        { id: 'prisma', name: 'Prisma', import: () => e.A(43363) },
        { id: 'prolog', name: 'Prolog', import: () => e.A(34581) },
        {
          id: 'proto',
        ...
        { id: 'pug', name: 'Pug', aliases: ['jade'], import: () => e.A(61499) },
        { id: 'puppet', name: 'Puppet', import: () => e.A(8506) },
        { id: 'purescript', name: 'PureScript', import: () => e.A(18090) },
        {
          id: 'python',
          name: 'Python',
          aliases: ['py'],
        ...
        { id: 'qml', name: 'QML', import: () => e.A(91124) },
        { id: 'qmldir', name: 'QML Directory', import: () => e.A(35846) },
        { id: 'qss', name: 'Qt Style Sheets', import: () => e.A(46995) },
        { id: 'r', name: 'R', import: () => e.A(30051) },
        { id: 'racket', name: 'Racket', import: () => e.A(28646) },
        {
          id: 'raku',
          name: 'Raku',
          aliases: ['perl6'],
        ...
        { id: 'razor', name: 'ASP.NET Razor', import: () => e.A(57658) },
        {
          id: 'reg',
        ...
        { id: 'rel', name: 'Rel', import: () => e.A(20612) },
        { id: 'riscv', name: 'RISC-V', import: () => e.A(29251) },
        { id: 'rosmsg', name: 'ROS Interface', import: () => e.A(55931) },
        { id: 'rst', name: 'reStructuredText', import: () => e.A(44713) },
        { id: 'ruby', name: 'Ruby', aliases: ['rb'], import: () => e.A(58437) },
        { id: 'rust', name: 'Rust', aliases: ['rs'], import: () => e.A(85140) },
        { id: 'sas', name: 'SAS', import: () => e.A(86530) },
        { id: 'sass', name: 'Sass', import: () => e.A(94498) },
        { id: 'scala', name: 'Scala', import: () => e.A(79496) },
        { id: 'scheme', name: 'Scheme', import: () => e.A(27709) },
        { id: 'scss', name: 'SCSS', import: () => e.A(86499) },
        {
          id: 'sdbl',
          name: '1C (Query)',
          aliases: ['1c-query'],
        ...
        { id: 'smalltalk', name: 'Smalltalk', import: () => e.A(56302) },
        { id: 'solidity', name: 'Solidity', import: () => e.A(27077) },
        {
          id: 'soy',
        ...
        { id: 'sparql', name: 'SPARQL', import: () => e.A(74165) },
        {
          id: 'splunk',
        ...
        { id: 'sql', name: 'SQL', import: () => e.A(57862) },
        { id: 'ssh-config', name: 'SSH Config', import: () => e.A(54442) },
        { id: 'stata', name: 'Stata', import: () => e.A(68601) },
        {
          id: 'stylus',
          name: 'Stylus',
          aliases: ['styl'],
        ...
        { id: 'svelte', name: 'Svelte', import: () => e.A(42335) },
        { id: 'swift', name: 'Swift', import: () => e.A(71119) },
        {
          id: 'system-verilog',
          name: 'SystemVerilog',
          import: () => e.A(36800),
        },
        { id: 'systemd', name: 'Systemd Units', import: () => e.A(54358) },
        {
          id: 'talonscript',
          name: 'TalonScript',
          aliases: ['talon'],
        ...
        { id: 'tasl', name: 'Tasl', import: () => e.A(81025) },
        { id: 'tcl', name: 'Tcl', import: () => e.A(309) },
        { id: 'templ', name: 'Templ', import: () => e.A(18978) },
        {
          id: 'terraform',
          name: 'Terraform',
          aliases: ['tf', 'tfvars'],
        ...
        { id: 'tex', name: 'TeX', import: () => e.A(8130) },
        { id: 'toml', name: 'TOML', import: () => e.A(8019) },
        {
          id: 'ts-tags',
        ...
        { id: 'tsv', name: 'TSV', import: () => e.A(34111) },
        { id: 'tsx', name: 'TSX', import: () => e.A(83529) },
        { id: 'turtle', name: 'Turtle', import: () => e.A(67160) },
        { id: 'twig', name: 'Twig', import: () => e.A(18228) },
        {
          id: 'typescript',
          name: 'TypeScript',
          aliases: ['ts', 'cts', 'mts'],
        ...
        { id: 'v', name: 'V', import: () => e.A(57912) },
        { id: 'vala', name: 'Vala', import: () => e.A(25517) },
        {
          id: 'vb',
          name: 'Visual Basic',
          aliases: ['cmd'],
        ...
        { id: 'verilog', name: 'Verilog', import: () => e.A(37013) },
        { id: 'vhdl', name: 'VHDL', import: () => e.A(27676) },
        {
          id: 'viml',
          name: 'Vim Script',
        ...
        { id: 'vue', name: 'Vue', import: () => e.A(8282) },
        { id: 'vue-html', name: 'Vue HTML', import: () => e.A(63808) },
        { id: 'vue-vine', name: 'Vue Vine', import: () => e.A(33570) },
        {
          id: 'vyper',
          name: 'Vyper',
          aliases: ['vy'],
        ...
        { id: 'wasm', name: 'WebAssembly', import: () => e.A(91195) },
        {
          id: 'wenyan',
          name: 'Wenyan',
          aliases: ['文言'],
        ...
        { id: 'wgsl', name: 'WGSL', import: () => e.A(24559) },
        {
          id: 'wikitext',
          name: 'Wikitext',
        ...
        { id: 'xml', name: 'XML', import: () => e.A(68577) },
        { id: 'xsl', name: 'XSL', import: () => e.A(85479) },
        {
          id: 'yaml',
          name: 'YAML',
          aliases: ['yml'],
        ...
        { id: 'zenscript', name: 'ZenScript', import: () => e.A(50746) },
        { id: 'zig', name: 'Zig', import: () => e.A(39991) },
      ],
      nf = Object.fromEntries(nm.map((e) => [e.id, e.import])),
      ng = Object.fromEntries(
        nm.flatMap((e) => e.aliases?.map((t) => [t, e.import]) || [])
      ),
      ny = { ...nf, ...ng },
        ...
        emscripten_resize_heap: function (e) {
          ...
          for (let r = 1; r <= 4; r *= 2) {
            ...
            if (
              ...
              })(Math.min(0x80000000, nk(Math.max(e, o), 65536))))
            )
              return !0;
          }
          return !1;
    ...
    class nx {
      constructor(e) {
        (nC(this, 'utf16Length'),
          ...
          nC(this, 'utf16Value'),
          nC(this, 'utf8Value'),
          nC(this, 'utf16OffsetToUtf8'),
          nC(this, 'utf8OffsetToUtf16'));
        const t = e.length,
          n = nx._utf8ByteLength(e),
          r = n !== t,
          i = r ? new Uint32Array(t + 1) : null;
        r && (i[t] = n);
        const a = r ? new Uint32Array(n + 1) : null;
        r && (a[n] = t);
    ...
    let nL = class e {
      constructor(t) {
        if (
          (nC(this, 'id', ++e.LAST_ID),
          nC(this, '_onigBinding'),
          nC(this, 'content'),
          nC(this, 'utf16Length'),
          nC(this, 'utf8Length'),
          nC(this, 'utf16OffsetToUtf8'),
          ...
          throw new n_('Must invoke loadWasm first.');
        ((this._onigBinding = nN), (this.content = t));
        const n = new nx(t);
        ((this.utf16Length = n.utf16Length),
          ...
          this.utf8Length < 1e4 && !e._sharedPtrInUse
            ? (e._sharedPtr || (e._sharedPtr = nN.omalloc(1e4)),
              (e._sharedPtrInUse = !0),
              nN.HEAPU8.set(n.utf8Value, e._sharedPtr),
              (this.ptr = e._sharedPtr))
            : (this.ptr = n.createString(nN)));
      }
    ...
    (nC(nL, 'LAST_ID', 0),
      nC(nL, '_sharedPtr', 0),
      nC(nL, '_sharedPtrInUse', !1));
    class nT {
      constructor(e) {
        if ((nC(this, '_onigBinding'), nC(this, '_ptr'), !nN))
          throw new n_('Must invoke loadWasm first.');
        const t = [],
          n = [];
        for (let r = 0, i = e.length; r < i; r++) {
          const i = new nx(e[r]);
          ((t[r] = i.createString(nN)), (n[r] = i.utf8Length));
        }
        const r = nN.omalloc(4 * e.length);
        nN.HEAPU32.set(t, r / 4);
        const i = nN.omalloc(4 * e.length);
        nN.HEAPU32.set(n, i / 4);
        const a = nN.createOnigScanner(r, i, e.length);
        for (let n = 0, r = e.length; n < r; n++) nN.ofree(t[n]);
        (nN.ofree(i),
          nN.ofree(r),
          0 === a &&
            (function (e) {
              throw new n_(e.UTF8ToString(e.getLastOnigError()));
            })(nN),
          (this._onigBinding = nN),
          (this._ptr = a));
      }
      dispose() {
    ...
    async function nE(e) {
      return (
                  ...
                  if (
                    ...
                    n =
                      'function' == typeof WebAssembly.instantiateStreaming
                        ? await ((a = n),
                          (e) => WebAssembly.instantiateStreaming(a, e))(t)
                        : await ((o = n),
                          async (e) => {
                    ...
                    ('undefined' != typeof ArrayBuffer &&
                      ...
                      (void 0 !== nA.Buffer && nA.Buffer.isBuffer?.(i)) ||
                      ('undefined' != typeof SharedArrayBuffer &&
        ...
        {
          createScanner: (e) =>
            new nT(e.map((e) => ('string' == typeof e ? e : e.source))),
          createString: (e) => new nL(e),
        }
      );
    }
    let { codeToHtml: nR } = (function (e, t) {
      let n,
        r = async function (t = {}) {
          if (n) {
            let e = await n;
          ...
          }
          {
            ...
            return (
              await Promise.all([
                r.loadTheme(...(t.themes || [])),
                r.loadLanguage(...(t.langs || [])),
              ]),
              r
            );
          }
      ...
      return {
        ...
        getLastGrammarState: async (e, t) =>
          (await r({ langs: [t.lang], themes: [t.theme] })).getLastGrammarState(
            e,
            t
          ),
      };
    })(
      ((r = (l = { langs: ny, themes: nb, engine: () => nE(e.A(32557)) })
        .langs),
      (i = l.themes),
      (a = l.engine),
      async function (e) {
        function t(t) {
          if ('string' == typeof t) {
            if (tj((t = e.langAlias?.[t] || t))) return [];
            let n = r[t];
            if (!n)
              throw new h(
                `Language \`${t}\` is not included in this bundle. You may want to load it from external source.`
              );
            return n;
          }
          return t;
        ...
        let o = (e.themes ?? []).map((e) => n(e)),
          s = (e.langs ?? []).map((e) => t(e)),
          l = await nd({ engine: e.engine ?? a(), ...e, themes: o, langs: s });
        return {
          ...l,
          loadLanguage: (...e) => l.loadLanguage(...e.map(t)),
          loadTheme: (...e) => l.loadTheme(...e.map(n)),
          getBundledLanguages: () => r,
          getBundledThemes: () => i,
        };
      }),
      {
        guessEmbeddedLanguages: function (e, t, n) {
          ...
          for (let t of e.matchAll(
            /<script\s+(?:type|lang)=["']([^"']+)["']/gi
          )) {
            let e = t[1].toLowerCase().trim(),
    ...
    e.s(
      [
        ...
        0,
        ({ code: e, lang: t }) => {
          let [n, r] = (0, c.useState)('');
          return (
            (0, c.useEffect)(() => {
              (async () => {
                r(await nR(e, { lang: t, theme: 'github-dark' }));
              })();
            }),
            (0, u.jsx)('div', {
              className:
