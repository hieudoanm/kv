(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    var Q = (function e() {
            ...
            if (
              ...
              (e7 =
                ...
                (e8 =
                  ...
                  ? T
                  : g),
              (eE = b(e, 'ALLOWED_TAGS') ? v({}, e.ALLOWED_TAGS, e7) : eA),
              (eb = b(e, 'ALLOWED_ATTR') ? v({}, e.ALLOWED_ATTR, e7) : eN),
              (e2 = b(e, 'ALLOWED_NAMESPACES')
                ? v({}, e.ALLOWED_NAMESPACES, T)
                : e9),
              (e$ = b(e, 'ADD_URI_SAFE_ATTR')
                ? v(x(eV), e.ADD_URI_SAFE_ATTR, e7)
                : eV),
              (eq = b(e, 'ADD_DATA_URI_TAGS')
                ? v(x(eK), e.ADD_DATA_URI_TAGS, e7)
                : eK),
              (eY = b(e, 'FORBID_CONTENTS')
                ? v({}, e.FORBID_CONTENTS, e7)
                : eX),
              (ew = b(e, 'FORBID_TAGS') ? v({}, e.FORBID_TAGS, e7) : x({})),
              (ev = b(e, 'FORBID_ATTR') ? v({}, e.FORBID_ATTR, e7) : x({})),
              (eB = !!b(e, 'USE_PROFILES') && e.USE_PROFILES),
              (eC = !1 !== e.ALLOW_ARIA_ATTR),
              (ek = !1 !== e.ALLOW_DATA_ATTR),
              (eR = e.ALLOW_UNKNOWN_PROTOCOLS || !1),
              (eD = !1 !== e.ALLOW_SELF_CLOSE_IN_ATTR),
              ...
              eB &&
                ((eE = v({}, M)),
                (eb = []),
                !0 === eB.html && (v(eE, k), v(eb, U)),
                !0 === eB.svg && (v(eE, R), v(eb, P), v(eb, H)),
                !0 === eB.svgFilters && (v(eE, D), v(eb, P), v(eb, H)),
                !0 === eB.mathMl && (v(eE, O), v(eb, z), v(eb, H))),
              e.ADD_TAGS &&
                ('function' == typeof e.ADD_TAGS
                  ? (ex.tagCheck = e.ADD_TAGS)
                  : (eE === eA && (eE = x(eE)), v(eE, e.ADD_TAGS, e7))),
              e.ADD_ATTR &&
                ('function' == typeof e.ADD_ATTR
                  ? (ex.attributeCheck = e.ADD_ATTR)
                  : (eb === eN && (eb = x(eb)), v(eb, e.ADD_ATTR, e7))),
              e.ADD_URI_SAFE_ATTR && v(e$, e.ADD_URI_SAFE_ATTR, e7),
              e.FORBID_CONTENTS &&
                (eY === eX && (eY = x(eY)), v(eY, e.FORBID_CONTENTS, e7)),
              eG && (eE['#text'] = !0),
      ...
      let tf = function (e) {
          let t = null;
          if ((td(eu.beforeSanitizeElements, e, null), tm(e)))
            return (tl(e), !0);
          let n = e7(e.nodeName);
          if (
            (td(eu.uponSanitizeElement, e, { tagName: n, allowedTags: eE }),
            (eO &&
              e.hasChildNodes() &&
              ...
              N(/<[/\w!]/g, e.textContent)) ||
              7 === e.nodeType ||
              (eO && 8 === e.nodeType && N(/<[/\w]/g, e.data)))
          )
            return (tl(e), !0);
          if (
            !(ex.tagCheck instanceof Function && ex.tagCheck(n)) &&
            (!eE[n] || ew[n])
          ) {
            if (
              !ew[n] &&
              tg(n) &&
              ((eS.tagNameCheck instanceof RegExp && N(eS.tagNameCheck, n)) ||
        ...
        th = function (e, t, n) {
          ...
          if (ek && !ev[t] && N(ef, t));
            ...
            ex.attributeCheck instanceof Function &&
            ex.attributeCheck(t, e)
          );
          else if (!eb[t] || ev[t]) {
            if (
              !(
                (tg(e) &&
                  ...
                  ((eS.attributeNameCheck instanceof RegExp &&
                    N(eS.attributeNameCheck, t)) ||
                    (eS.attributeNameCheck instanceof Function &&
                      eS.attributeNameCheck(t, e)))) ||
                ('is' === t &&
                  eS.allowCustomizedBuiltInElements &&
                  ((eS.tagNameCheck instanceof RegExp &&
                    N(eS.tagNameCheck, n)) ||
        ...
        tT = function (e) {
          ...
          for (; i--; ) {
            ...
            if (
              ...
              td(eu.uponSanitizeAttribute, e, o),
              (u = o.attrValue),
              ej &&
                ('id' === s || 'name' === s) &&
                (tc(a, e), (u = 'user-content-' + u)),
              (eO && N(/((--!?|])>)|<\/(style|title|textarea)/i, u)) ||
        ...
        ty = function e(t) {
          let n = null,
            o = tu(t);
          for (td(eu.beforeSanitizeShadowDOM, t, null); (n = o.nextNode()); )
      ...
      return (
        (r.sanitize = function (e) {
          ...
          let s = tu(eW ? e : o);
          for (; (a = s.nextNode()); )
            (tf(a), tT(a), a.content instanceof u && ty(a.content));
          if (eW) return e;
          if (eP) {
            if (ez)
          ...
          return (
            eI &&
              ...
              N(K, o.ownerDocument.doctype.name) &&
  ...
  (e) => {
    ...
    e.s([
      ...
      0,
      () => {
        let [{ code: e, html: i }, a] = (0, o.useState)({ code: '', html: '' });
        return (
          (0, o.useEffect)(() => {
            let t = (0, r.default)(window);
            a((n) => ({ ...n, html: t.sanitize(e) }));
          }, [e]),
          (0, t.jsx)(n.PageTemplate, {
            query: '',
            setState: () => {},
            id: 'preview-html',
            emoji: '🧪',
                      ...
                      children: (0, t.jsx)('textarea', {
                        ...
                        onChange: (t) => {
                          let n = t.target.value,
                            o = (0, r.default)(window).sanitize(e);
                          a((e) => ({ ...e, code: n, html: o }));
                        },
                      }),
                    }),
  ...
  (e, t, n) => {
    let o = '/preview/html';
    ((window.__NEXT_P = window.__NEXT_P || []).push([o, () => e.r(52599)]),
      t.hot &&
  ...
  (e) => {
    e.v((t) =>
      Promise.all(
        ['static/chunks/e98cee40c789db56.js'].map((t) => e.l(t))
      ).then(() => t(33674))
    );
  },
  1664,
  (e) => {
    e.v((t) =>
      Promise.all(
        ['static/chunks/98a2ca3ed104a94f.js'].map((t) => e.l(t))
      ).then(() => t(79939))
    );
  },
]);
